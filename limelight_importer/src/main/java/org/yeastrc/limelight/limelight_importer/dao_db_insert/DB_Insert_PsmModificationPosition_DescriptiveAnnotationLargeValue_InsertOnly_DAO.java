 ...
 *
 */
public class DB_Insert_PsmModificationPosition_DescriptiveAnnotationLargeValue_InsertOnly_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmModificationPosition_DescriptiveAnnotationLargeValue_InsertOnly_DAO.class );

	private DB_Insert_PsmModificationPosition_DescriptiveAnnotationLargeValue_InsertOnly_DAO() { }
	public static DB_Insert_PsmModificationPosition_DescriptiveAnnotationLargeValue_InsertOnly_DAO getInstance() { return new DB_Insert_PsmModificationPosition_DescriptiveAnnotationLargeValue_InsertOnly_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmModificationPositionDescriptiveAnnotation_LargeValue_DTO> itemList ) throws Exception {
	...
	private final static String INSERT_SQL = 
			"INSERT INTO psm_modification_position_descriptive_annotation_large_value_tbl "
			
			+ "(psm_modification_position_descriptive_annotation_id, value_string ) "
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmModificationPositionDescriptiveAnnotation_LargeValue_DTO> itemList, Connection dbConnection ) throws Exception {
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( PsmModificationPositionDescriptiveAnnotation_LargeValue_DTO item : itemList ) {

				counter++;
				pstmt.setLong( counter, item.getPsmModificationPositionDescriptiveAnnotationDTO() );
				counter++;
