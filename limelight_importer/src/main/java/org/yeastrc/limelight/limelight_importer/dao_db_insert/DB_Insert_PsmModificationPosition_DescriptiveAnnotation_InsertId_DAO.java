 ...
 *
 */
public class DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO.class );

	private DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO() { }
	public static DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO getSingletonInstance() { 
		return singletonInstance;
	}

	private static DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO singletonInstance = new DB_Insert_PsmModificationPosition_DescriptiveAnnotation_InsertId_DAO();
	 ...
	 * 
	 */
	public DB_Insert_PsmModificationPosition_DescriptiveAnnotation__BatchIds_Start_End getNextBatch_IDs( int batchSize ) throws Exception {
		...
		while ( true ) {
			...
			if ( updateId_InsertId_Table( id_New, id_Existing ) ) {
				...
				DB_Insert_PsmModificationPosition_DescriptiveAnnotation__BatchIds_Start_End result = new DB_Insert_PsmModificationPosition_DescriptiveAnnotation__BatchIds_Start_End();
	 ...
	 *
	 */
	public static class DB_Insert_PsmModificationPosition_DescriptiveAnnotation__BatchIds_Start_End {
