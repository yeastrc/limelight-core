...
public class DB_Insert_Search_ReportedPeptide_OpenMod_PsmUniquePositions_DAO {
	 ...
	 * @throws Exception
	 */
	public void insert( List<Search_ReportedPeptide_OpenMod_PsmUniquePositions_DTO> itemList ) throws Exception {
		...
		try ( Connection dbConnection = ImportRunImporterDBConnectionFactory.getMainSingletonInstance().getConnection() ) {
			try ( PreparedStatement pstmt = dbConnection.prepareStatement( sql ) ) {
				...
				for ( Search_ReportedPeptide_OpenMod_PsmUniquePositions_DTO item : itemList ) {
