 ...
 *
 */
public class DB_Insert_PsmOpenModification_InsertOnly_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmOpenModification_InsertOnly_DAO.class );

	private DB_Insert_PsmOpenModification_InsertOnly_DAO() { }
	public static DB_Insert_PsmOpenModification_InsertOnly_DAO getInstance() { return new DB_Insert_PsmOpenModification_InsertOnly_DAO(); }
	 ...
	 * @throws Throwable
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmOpenModificationDTO> itemList ) throws Exception {
	...
	private static final String INSERT_SQL =
			...
			"INSERT INTO psm_open_modification_tbl "
			+ " ( id, psm_id, mass )"
			+ " VALUES ";
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmOpenModificationDTO> itemList, Connection dbConnection ) throws Exception {
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( PsmOpenModificationDTO item : itemList ) {
