 ...
 *
 */
public class DB_Insert_PsmOpenModificationPosition_InsertId_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmOpenModificationPosition_InsertId_DAO.class );

	private DB_Insert_PsmOpenModificationPosition_InsertId_DAO() { }
	public static DB_Insert_PsmOpenModificationPosition_InsertId_DAO getSingletonInstance() { 
		return singletonInstance;
	}

	private static DB_Insert_PsmOpenModificationPosition_InsertId_DAO singletonInstance = new DB_Insert_PsmOpenModificationPosition_InsertId_DAO();
	 ...
	 * 
	 */
	public DB_Insert_PsmOpenModificationPosition__BatchIds_Start_End getNextBatch_IDs( int batchSize ) throws Exception {
		...
		while ( true ) {
			...
			// get psm_open_modification_position__insert_id_tbl and then 'advance' psm_open_modification_position__insert_id_tbl by adding DEFAULT_INSERT_ENTRIES_ARRAY_SIZE to it.
			...
			if ( updateId_InsertId_Table( id_New, id_Existing ) ) {
				...
				DB_Insert_PsmOpenModificationPosition__BatchIds_Start_End result = new DB_Insert_PsmOpenModificationPosition__BatchIds_Start_End();
	...
	private Long get_LastId_InsertId_Table() throws Exception {
		...
		final String sql = "SELECT id FROM psm_open_modification_position__insert_id_tbl ORDER BY id DESC LIMIT 1";
	...
	private boolean updateId_InsertId_Table( long id_New, long id_Existing ) throws Exception {
		...
		final String sql = "UPDATE psm_open_modification_position__insert_id_tbl SET id = ? WHERE id = ?";
	...
	private void insertId_Value_InsertId_Table(long id) throws Exception {
		...
		final String INSERT_GET_ID_SQL = "INSERT INTO psm_open_modification_position__insert_id_tbl ( id ) VALUES ( ? )";
	...
	private void deleteId_InsertId_Table( long id ) throws Exception {
		...
		final String DELETE_SQL = "DELETE FROM psm_open_modification_position__insert_id_tbl WHERE id = ?";
	 ...
	 *
	 */
	public static class DB_Insert_PsmOpenModificationPosition__BatchIds_Start_End {
