 ...
 *
 */
public class DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_InsertOnly_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_InsertOnly_DAO.class );

	private DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_InsertOnly_DAO() { }
	public static DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_InsertOnly_DAO getInstance() { return new DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_InsertOnly_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO> itemList ) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO> itemList, Connection dbConnection ) throws Exception {
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO item : itemList ) {

				counter++;
				pstmt.setLong( counter, item.getSrchReportedPeptideDescriptiveAnnotationId() );
				counter++;
