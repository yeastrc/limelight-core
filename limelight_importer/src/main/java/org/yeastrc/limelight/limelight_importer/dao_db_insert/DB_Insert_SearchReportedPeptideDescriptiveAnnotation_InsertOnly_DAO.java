 ...
 *
 */
public class DB_Insert_SearchReportedPeptideDescriptiveAnnotation_InsertOnly_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_SearchReportedPeptideDescriptiveAnnotation_InsertOnly_DAO.class );

	private DB_Insert_SearchReportedPeptideDescriptiveAnnotation_InsertOnly_DAO() { }
	public static DB_Insert_SearchReportedPeptideDescriptiveAnnotation_InsertOnly_DAO getInstance() { return new DB_Insert_SearchReportedPeptideDescriptiveAnnotation_InsertOnly_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<SearchReportedPeptideDescriptiveAnnotationDTO> itemList ) throws Exception {
	...
	private final static String INSERT_SQL = 
			...
			+ "( id, search_id, reported_peptide_id, "
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<SearchReportedPeptideDescriptiveAnnotationDTO> itemList, Connection dbConnection ) throws Exception {

		if ( itemList.isEmpty() ) {
			throw new IllegalArgumentException( "( itemList.isEmpty() )" );
		}
		
		List<SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO> searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO_List = new ArrayList<>();
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( SearchReportedPeptideDescriptiveAnnotationDTO item : itemList ) {
				...
				if ( annotationValueLocation == AnnotationValueLocation.LARGE_VALUE_TABLE ) {
					...
					SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO = new SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO();
					searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO.setSrchReportedPeptideDescriptiveAnnotationId( item.getId() );
					searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO.setValueString( item.getValueString() );
		...
		for ( SearchReportedPeptideDescriptiveAnnotation_LargeValue_DTO searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO : searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO_List ) {
			
			DB_Insert_SearchReportedPeptideDescriptiveAnnotationLargeValue_BatchInserter_DAO.getSingletonInstance().insert_Batching_Object(searchReportedPeptideDescriptiveAnnotation_LargeValue_DTO);
		}
	}
