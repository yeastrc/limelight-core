 ...
 *
 */
public class DB_Insert_PsmOpenModificationPosition_FilterableAnnotationDAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmOpenModificationPosition_FilterableAnnotationDAO.class );

	private DB_Insert_PsmOpenModificationPosition_FilterableAnnotationDAO() { }
	public static DB_Insert_PsmOpenModificationPosition_FilterableAnnotationDAO getInstance() { return new DB_Insert_PsmOpenModificationPosition_FilterableAnnotationDAO(); }
...
//			log.warn( "Total Elapsed Time (includes commit): Save to psm_open_modification_position_filtrbl_annttn_tbl: "
...
//			importer_Stats_PerTable_DTO.setTable_names( "psm_open_modification_position_filtrbl_annttn_tbl" );
...
//		}
	 ...
	 * 
	 * 
	 * This will INSERT the given PsmOpenModificationPosition_FilterableAnnotationDTO into the database.
	 * @param item
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmOpenModificationPosition_FilterableAnnotationDTO> psmOpenModificationPosition_FilterableAnnotationDTO_List ) throws Exception {

		if ( psmOpenModificationPosition_FilterableAnnotationDTO_List.isEmpty() ) {
			throw new IllegalArgumentException( "psmOpenModificationPosition_FilterableAnnotationDTO_List is empty" );
		}
		...
		try {
			...
			insert_NOT_Update_ID_Property_InDTOParams( psmOpenModificationPosition_FilterableAnnotationDTO_List, dbConnection );
...
//			insert_NOT_Update_ID_Property_InDTOParams( psmOpenModificationPosition_FilterableAnnotationDTO_List, dbConnection );
//		} catch ( Exception e ) {
//			log.error( "ERROR: insert_NOT_Update_ID_Property_InDTOParams( psmOpenModificationPosition_FilterableAnnotationDTO_List ) psmOpenModificationPosition_FilterableAnnotationDTO_List: " + StringUtils.join(psmOpenModificationPosition_FilterableAnnotationDTO_List, ","), e );
//			throw e;
//		}
//
...
//		totalRecordsSavedCount_saveToDatabase += psmOpenModificationPosition_FilterableAnnotationDTO_List.size();
	}

	private final static String INSERT_SQL = 
			"INSERT INTO psm_open_modification_position_filtrbl_annttn_tbl "
			
			+ "(psm_open_modification_position_id, "
	 ...
	 * @throws Exception
	 */
	private void insert_NOT_Update_ID_Property_InDTOParams( List<PsmOpenModificationPosition_FilterableAnnotationDTO> psmOpenModificationPosition_FilterableAnnotationDTO_List, Connection dbConnection ) throws Exception {

		for ( PsmOpenModificationPosition_FilterableAnnotationDTO item : psmOpenModificationPosition_FilterableAnnotationDTO_List ) {
		...
		if ( psmOpenModificationPosition_FilterableAnnotationDTO_List.isEmpty() ) {
			throw new IllegalArgumentException( "( psmOpenModificationPosition_FilterableAnnotationDTO_List.isEmpty() )" );
		}
		
		final String insertSQL = this.create_insert_SQL( psmOpenModificationPosition_FilterableAnnotationDTO_List.size() );
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( PsmOpenModificationPosition_FilterableAnnotationDTO item : psmOpenModificationPosition_FilterableAnnotationDTO_List ) {
				...
				counter++;
				pstmt.setLong( counter, item.getPsmOpenModificationPositionId() );
				counter++;
			...
			log.error( "ERROR: saveToDatabase(...) insertSQL: " + insertSQL + "\nData to save: " + StringUtils.join( psmOpenModificationPosition_FilterableAnnotationDTO_List, "," ), e );
			throw e;
		}
