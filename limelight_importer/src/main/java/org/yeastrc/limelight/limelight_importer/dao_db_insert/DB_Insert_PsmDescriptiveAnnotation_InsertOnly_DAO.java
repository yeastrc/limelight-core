 ...
 *
 */
public class DB_Insert_PsmDescriptiveAnnotation_InsertOnly_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmDescriptiveAnnotation_InsertOnly_DAO.class );

	private DB_Insert_PsmDescriptiveAnnotation_InsertOnly_DAO() { }
	public static DB_Insert_PsmDescriptiveAnnotation_InsertOnly_DAO getInstance() { return new DB_Insert_PsmDescriptiveAnnotation_InsertOnly_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmDescriptiveAnnotationDTO> itemList ) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmDescriptiveAnnotationDTO> itemList, Connection dbConnection ) throws Exception {
		...
		List<PsmDescriptiveAnnotation_LargeValue_DTO> psmDescriptiveAnnotation_LargeValue_DTO_List = new ArrayList<>();
		...
		try {
			try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
				...
				for ( PsmDescriptiveAnnotationDTO item : itemList ) {
					...
					if ( annotationValueLocation == AnnotationValueLocation.LARGE_VALUE_TABLE ) {
						...
						PsmDescriptiveAnnotation_LargeValue_DTO psmDescriptiveAnnotation_LargeValue_DTO = new PsmDescriptiveAnnotation_LargeValue_DTO();
						psmDescriptiveAnnotation_LargeValue_DTO.setPsmDescriptiveAnnotationId( item.getId() );
				...
				for ( PsmDescriptiveAnnotation_LargeValue_DTO psmDescriptiveAnnotation_LargeValue_DTO : psmDescriptiveAnnotation_LargeValue_DTO_List ) {
					
					DB_Insert_PsmDescriptiveAnnotationLargeValue_BatchInserter_DAO.getSingletonInstance().insert_Batching_Object(psmDescriptiveAnnotation_LargeValue_DTO);
				}
			}
