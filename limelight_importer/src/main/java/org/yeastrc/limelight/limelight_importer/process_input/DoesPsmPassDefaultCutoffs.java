 ...
 *
 */
public class DoesPsmPassDefaultCutoffs {
	
	private static final Logger log = LoggerFactory.getLogger( DoesPsmPassDefaultCutoffs.class );
	
	//  private constructor 
	private DoesPsmPassDefaultCutoffs() {}
	public static DoesPsmPassDefaultCutoffs getInstance() { return new DoesPsmPassDefaultCutoffs(); }
	 ...
	 */
	public boolean doesPsmPassDefaultCutoffs( 
		...
		for ( PsmFilterableAnnotationDTO currentPsm_psmAnnotationDTO_Filterable : currentPsm_psmAnnotationDTO_Filterable_List ) {
			...
			if ( currentPsm_AnnotationTypeFilterableDTO.isDefaultFilter() ) {
				...
				if ( currentPsm_AnnotationTypeFilterableDTO.getDefaultFilterValueAtDatabaseLoad() == null ) {
					...
					doesPsmPassDefaultCutoffs = true;  // TODO  Is this RIGHT?????  !!!!!!!!!!!!!
