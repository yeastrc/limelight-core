 ...
 *
 */
public class DB_Insert_PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DAO.class );

	private DB_Insert_PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DAO() { }
	public static DB_Insert_PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DAO getInstance() { return new DB_Insert_PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DAO(); }
...
//			log.warn( "Total Elapsed Time (includes commit): Save to psm_peptide_position_worst_filterable_annotation_lookup_tbl: "
...
//			importer_Stats_PerTable_DTO.setTable_names( "psm_peptide_position_worst_filterable_annotation_lookup_tbl" );
...
//		}
	 ...
	 * 
	 * 
	 * This will INSERT the given PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO into the database.
	 * @param item
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO> psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List ) throws Exception {

		if ( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List.isEmpty() ) {
			throw new IllegalArgumentException( "psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List is empty" );
		}
		...
		try {
			...
			insert_NOT_Update_ID_Property_InDTOParams( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List, dbConnection );
...
//			insert_NOT_Update_ID_Property_InDTOParams( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List, dbConnection );
//		} catch ( Exception e ) {
//			log.error( "ERROR: insert_NOT_Update_ID_Property_InDTOParams( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List ) psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List: " + StringUtils.join(psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List, ","), e );
//			throw e;
//		}
//
...
//		totalRecordsSavedCount_saveToDatabase += psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List.size();
	}

	private final static String INSERT_SQL = 
			"INSERT INTO psm_peptide_position_worst_filterable_annotation_lookup_tbl "
			
			+ "(psm_id,  "
			+ 	" annotation_type_id, worst_value_double ) "
	 ...
	 * @throws Exception
	 */
	private void insert_NOT_Update_ID_Property_InDTOParams( List<PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO> psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List, Connection dbConnection ) throws Exception {

		for ( PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO item : psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List ) {
		...
		if ( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List.isEmpty() ) {
			throw new IllegalArgumentException( "( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List.isEmpty() )" );
		}
		
		final String insertSQL = this.create_insert_SQL( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List.size() );
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( PsmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO item : psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List ) {
				...
				counter++;
				pstmt.setDouble( counter, item.getWorstValueDouble() );
			}
			
			pstmt.executeUpdate();
			
		} catch ( Exception e ) {
			log.error( "ERROR: saveToDatabase(...) insertSQL: " + insertSQL + "\nData to save: " + StringUtils.join( psmPeptidePosition_Worst_FilterableAnnotation_Lookup_DTO_List, "," ), e );
			throw e;
		}
