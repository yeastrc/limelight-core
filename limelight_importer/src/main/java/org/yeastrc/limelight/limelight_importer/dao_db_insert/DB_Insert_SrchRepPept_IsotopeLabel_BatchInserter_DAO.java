...
/**
 * Insert Batches into table srch_rep_pept__isotope_label_tbl 
 * 
 * DB_Insert_SrchRepPept_IsotopeLabel_DAO  
 *
 */
public class DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO implements DB_BatchInsert_ValidateCall_InsertLastBatch_ToDB_RegistryEntry_IF {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO.class );
	

	private static final int INSERT_BATCH_SIZE = 4000;

	
	private DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO() { 
	 ...
	 */
	public static DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO getSingletonInstance() { 
		return singletonInstance;
	}

	private static DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO singletonInstance = new DB_Insert_SrchRepPept_IsotopeLabel_BatchInserter_DAO();
	
	private List<SrchRepPept_IsotopeLabel_DTO> srchRepPept_IsotopeLabel_DTOList = new ArrayList<>( INSERT_BATCH_SIZE );
	...
	public void insert_LAST_Batch_ToDB() throws Exception {
		...
		if ( ! srchRepPept_IsotopeLabel_DTOList.isEmpty() ) {
	 ...
	 * @param srchRepPept_IsotopeLabel_DTOList
	 * @throws Exception 
	 */
	public void insert_Batching_Object(

			SrchRepPept_IsotopeLabel_DTO srchRepPept_IsotopeLabel_DTO
...

		{
			...
			srchRepPept_IsotopeLabel_DTOList.add(srchRepPept_IsotopeLabel_DTO);
		}

		if ( srchRepPept_IsotopeLabel_DTOList.size() >= INSERT_BATCH_SIZE ) {
	...
	private void _saveBatch() throws Exception {
		...
		{  //  Save  psmOpenModificationDTO objects
			...
			DB_Insert_SrchRepPept_IsotopeLabel_DAO.getInstance().insert_NOT_Update_ID_Property_InDTOParams(srchRepPept_IsotopeLabel_DTOList);
		}

		//  Clear Batch List since All Saved

		srchRepPept_IsotopeLabel_DTOList.clear();
	}
