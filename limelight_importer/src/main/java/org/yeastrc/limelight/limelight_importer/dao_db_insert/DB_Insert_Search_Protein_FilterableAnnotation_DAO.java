 ...
 *
 */
public class DB_Insert_Search_Protein_FilterableAnnotation_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_Search_Protein_FilterableAnnotation_DAO.class );

	private DB_Insert_Search_Protein_FilterableAnnotation_DAO() { }
	public static DB_Insert_Search_Protein_FilterableAnnotation_DAO getInstance() { return new DB_Insert_Search_Protein_FilterableAnnotation_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<Search_Protein_FilterableAnnotation_DTO> itemList ) throws Exception {
	...
	private final static String INSERT_SQL = 
			"INSERT INTO srch__protein_filterable_annotation_tbl "
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<Search_Protein_FilterableAnnotation_DTO> itemList, Connection dbConnection ) throws Exception {
