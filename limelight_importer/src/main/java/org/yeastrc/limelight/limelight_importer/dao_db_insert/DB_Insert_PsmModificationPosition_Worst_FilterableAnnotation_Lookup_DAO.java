 ...
 *
 */
public class DB_Insert_PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DAO {

	private static final Logger log = LoggerFactory.getLogger( DB_Insert_PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DAO.class );

	private DB_Insert_PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DAO() { }
	public static DB_Insert_PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DAO getInstance() { return new DB_Insert_PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DAO(); }
...
//			log.warn( "Total Elapsed Time (includes commit): Save to psm_mod_pos_worst_filterable_annotation_lookup_tbl: "
...
//			importer_Stats_PerTable_DTO.setTable_names( "psm_mod_pos_worst_filterable_annotation_lookup_tbl" );
...
//		}
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DTO> psmModificationPosition_FilterableAnnotationDTO_List ) throws Exception {
...
//		totalRecordsSavedCount_saveToDatabase += psmModificationPosition_FilterableAnnotationDTO_List.size();
	...
	private final static String INSERT_SQL = 
			"INSERT INTO psm_mod_pos_worst_filterable_annotation_lookup_tbl "
	 ...
	 * @throws Exception
	 */
	private void insert_NOT_Update_ID_Property_InDTOParams( List<PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DTO> psmModificationPosition_FilterableAnnotationDTO_List, Connection dbConnection ) throws Exception {

		for ( PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DTO item : psmModificationPosition_FilterableAnnotationDTO_List ) {
