 ...
 *
 */
public class FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_InsertONLY_DAO {
	
	private static final Logger log = LoggerFactory.getLogger( FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_InsertONLY_DAO.class );
	
	private FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_InsertONLY_DAO() { }
	public static FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_InsertONLY_DAO getInstance() { return new FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_InsertONLY_DAO(); }
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_DTO> itemList ) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void insert_NOT_Update_ID_Property_InDTOParams( List<FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_DTO> itemList, Connection dbConnection ) throws Exception {
		...
		try ( PreparedStatement pstmt = dbConnection.prepareStatement( insertSQL ) ) {
			...
			for ( FeatureDetectionPersistentFeatureEntry_MS_2_ScanNumbers_JSON_DTO item : itemList ) {
