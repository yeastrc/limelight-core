...
/**
 * Root object for JSON request to Psm_Count_For_Residues_ForSearchCriteria_Single_ProjSearchID_RestWebserviceController
 * 
 * This is the representation that the Javascript code uses
 *
 */
public class PSM_Count_For_Residues_SearchCriteria_Single_ProjSearchID_RequestRoot {
