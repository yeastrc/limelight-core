 ...
 * 
 * Thrown for Unauthorized (No Session) to access this webservice
 * 
...
@ResponseStatus( 
		...
		reason = WebServiceErrorMessageConstants.NO_SESSION_TEXT )

public class Limelight_WS_AuthError_Unauthorized_Exception extends Limelight_WS_ErrorResponse_Base_Exception {
