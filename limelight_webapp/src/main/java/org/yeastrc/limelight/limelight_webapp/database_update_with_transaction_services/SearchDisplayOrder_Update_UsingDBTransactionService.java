...
/**
 * Update The Display order on project_search_tbl records
 * 
 * !!!!  Important.  This cannot throw checked exceptions.  Otherwise Spring will not roll back the transaction
 *
 */
@Service
public class SearchDisplayOrder_Update_UsingDBTransactionService implements SearchDisplayOrder_Update_UsingDBTransactionServiceIF {

	private static final Logger log = LoggerFactory.getLogger( SearchDisplayOrder_Update_UsingDBTransactionService.class );
