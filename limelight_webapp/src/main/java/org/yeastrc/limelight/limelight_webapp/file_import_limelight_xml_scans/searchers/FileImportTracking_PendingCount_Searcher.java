 ...
 */
@Component
public class FileImportTracking_PendingCount_Searcher extends Limelight_JDBC_Base implements FileImportTracking_PendingCount_SearcherIF {
	
	private static final Logger log = LoggerFactory.getLogger( FileImportTracking_PendingCount_Searcher.class );
	
	private static final String SQL = 
			"SELECT COUNT(*) AS count FROM file_import_tracking_tbl"
					+ " WHERE "
