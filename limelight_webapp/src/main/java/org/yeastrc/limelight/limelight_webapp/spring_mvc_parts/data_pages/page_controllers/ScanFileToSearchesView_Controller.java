...
@Controller
//@RequestMapping("/")
public class ScanFileToSearchesView_Controller {

	private static final Logger log = LoggerFactory.getLogger( ScanFileToSearchesView_Controller.class );
	 ...
	 * 
	 */
	public ScanFileToSearchesView_Controller() {
		super();
		
		log.info( "ScanFileToSearchesView_Controller() constructor" );
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.SCAN_FILE_TO_SEARCHES_VIEW_PAGE_CONTROLLER;
...
//				+ ", queryData: " + queryData );
	...
	private String controllerEntryInternal( String otherPageState, HttpServletRequest httpServletRequest ) {
        ...
        return "data_pages/project_search_ids_driven_pages/scanFileToSearchesView.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
