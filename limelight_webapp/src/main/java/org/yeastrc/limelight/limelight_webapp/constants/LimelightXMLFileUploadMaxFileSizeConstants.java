 ...
 *
 */
public class LimelightXMLFileUploadMaxFileSizeConstants {


	public static final long MAX_LIMELIGHT_XML_FILE_UPLOAD_SIZE = ( 700 * ( (long) ( 1000 * 1000 ) ) ); // 700MB max
...
//	public static final int MAX_SCAN_FILE_UPLOAD_SIZE = ( 2 * 10 * 1000  ); // temp smaller max of 20KB
	...
	public static final String MAX_LIMELIGHT_XML_FILE_UPLOAD_SIZE_FORMATTED = "700MB";
