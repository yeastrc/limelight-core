 ...
 * 
 * 
 * Retrieve PSM Variable/Dynamic Modification Masses Per Reported Peptide Id for Reported Peptide Ids, Project Search ID, and Search Criteria
 *
 */
@RestController
public class Psm_Variable_Dynamic_ModificationMasses_PerReportedPeptide_For_ReportedPeptideIds_SearchCriteria_Single_ProjSearchID_RestWebserviceController 

implements
InitializingBean // InitializingBean is Spring Interface for triggering running method afterPropertiesSet() 
{
  
	private static final Logger log = LoggerFactory.getLogger( Psm_Variable_Dynamic_ModificationMasses_PerReportedPeptide_For_ReportedPeptideIds_SearchCriteria_Single_ProjSearchID_RestWebserviceController.class );
	 ...
	 */
	private static final String CONTROLLER_PATH = AA_RestWSControllerPaths_Constants.PSM_VARIABLE_DYNAMIC_MODIFICATION_MASSES_PER_REPORTED_PEPTIDE_ID_FOR_REP_PEPT_IDS_SEARCHCRITERIA_SINGLE_PROJECT_SEARCH_ID_REST_WEBSERVICE_CONTROLLER_VERSION_0001;
	 ...
	 * 
	 */
	public Psm_Variable_Dynamic_ModificationMasses_PerReportedPeptide_For_ReportedPeptideIds_SearchCriteria_Single_ProjSearchID_RestWebserviceController() {
		super();
...
//    		ValidateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result validateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result =
    		...
    		List<WebserviceResult_Per_ReportedPeptideId_Entry> reportedPeptideId_psmModificationMassesList_List_InProgress =
...
//        		for ( Integer reportedPeptideId : webserviceRequest.reportedPeptideIds ) {
	    		...
	    		if ( this.parallelStream_DefaultThreadPool_Java_Processing_Enabled_True ) {
	    			...
	    			webserviceRequest.reportedPeptideIds.parallelStream().forEach( reportedPeptideId -> { 
        				...
        				try {
        					...
        					synchronized(reportedPeptideId_psmModificationMassesList_List_InProgress){
        						reportedPeptideId_psmModificationMassesList_List_InProgress.add( entry );
        					}
    		...
    		List<WebserviceResult_Per_ReportedPeptideId_Entry> reportedPeptideId_psmModificationMassesList_List_Final =
    				new ArrayList<>( webserviceRequest.reportedPeptideIds.size() );
    		
			synchronized(reportedPeptideId_psmModificationMassesList_List_InProgress){
				
				for ( WebserviceResult_Per_ReportedPeptideId_Entry entry : reportedPeptideId_psmModificationMassesList_List_InProgress ) {
					reportedPeptideId_psmModificationMassesList_List_Final.add( entry );
				}
			}
        	
    		WebserviceResult result = new WebserviceResult();
    		result.reportedPeptideId_psmModificationMassesList_List = reportedPeptideId_psmModificationMassesList_List_Final;
    ...
    private WebserviceResult_Per_ReportedPeptideId_Entry get_WebserviceResult_Per_ReportedPeptideId_Entry_For_ONE_ReportedPeptideId( 
		...
		for ( PsmDynamicModificationMassesFor_PsmIds_Searcher_ResultEntry dbResultEntry :  psmModificationMassesList ) {
			...
			webserviceResult_Per_PsmId_ModMass_Entry.modificationMass = dbResultEntry.getDynamicModificationMass();
			webserviceResult_Per_PsmId_ModMass_Entry.modificationPosition = dbResultEntry.getPosition();
			webserviceResult_Per_PsmId_ModMass_Entry.is_N_Terminal = dbResultEntry.isIs_N_Terminal();
			webserviceResult_Per_PsmId_ModMass_Entry.is_C_Terminal = dbResultEntry.isIs_C_Terminal();
			
			psmId_ModMass_EntriesList.add(webserviceResult_Per_PsmId_ModMass_Entry);
		}
		...
		entry.psmId_ModMass_EntriesList = psmId_ModMass_EntriesList;
...
//		}
    ...
    public static class WebserviceResult {
    	...
    	List<WebserviceResult_Per_ReportedPeptideId_Entry> reportedPeptideId_psmModificationMassesList_List;

		public List<WebserviceResult_Per_ReportedPeptideId_Entry> getReportedPeptideId_psmModificationMassesList_List() {
			return reportedPeptideId_psmModificationMassesList_List;
		}
    ...
    public static class WebserviceResult_Per_ReportedPeptideId_Entry {
    	...
    	volatile List<WebserviceResult_Per_PsmId_ModMass_Entry>  psmId_ModMass_EntriesList;
    	
		public int getReportedPeptideId() {
			return reportedPeptideId;
		}
		public List<WebserviceResult_Per_PsmId_ModMass_Entry> getPsmId_ModMass_EntriesList() {
			return psmId_ModMass_EntriesList;
		}
    }
     ...
     * !!!  WARNING:  Update VERSION NUMBER in URL (And JS code that calls it) WHEN Change Webservice Request or Response  (Format or Contents) !!!!!!!!
     */
    public static class WebserviceResult_Per_PsmId_ModMass_Entry {
