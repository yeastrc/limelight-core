 ...
 *
 */
public class PeptideItemForPeptideList_SingleProjectSearchId {

	private int searchId;
	private int reportedPeptideId;
	private String reportedPeptideSequence;
...
//	private Integer numUniquePsms;
	...
	private List<PeptideItem_ModMassEntry> modMassList;
	private List<PeptideItem_ProteinNameEntry> proteinNameList;
	...
	public String getReportedPeptideSequence() {
		return reportedPeptideSequence;
	}
	public void setReportedPeptideSequence(String reportedPeptideSequence) {
		this.reportedPeptideSequence = reportedPeptideSequence;
	}
	...
	public List<PeptideItem_ModMassEntry> getModMassList() {
		return modMassList;
	}
	public void setModMassList(List<PeptideItem_ModMassEntry> modMassList) {
		this.modMassList = modMassList;
	}
	public List<PeptideItem_ProteinNameEntry> getProteinNameList() {
		return proteinNameList;
	}
	public void setProteinNameList(List<PeptideItem_ProteinNameEntry> proteinNameList) {
