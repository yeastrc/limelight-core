 ...
 *
 */
public interface SendEmailOnServerOrJsError_ToConfiguredEmail_ReadConfig_IF {

	/**
	 * @return
	 */
	SendEmailOnServerOrJsError_ToConfiguredEmail_ReadConfig_Response sendEmailOnServerOrJsError_ToConfiguredEmail_ReadConfig()
			throws Exception;
