 ...
 *
 */
public interface FileImportTrackingRun_LatestForParent_SearcherIF {
	 ...
	 * @throws Exception
	 */
	FileImportTrackingRunDTO getLatestRunForFileImportTrackingDTO(int fileImportTrackingId) throws Exception;
