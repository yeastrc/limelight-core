 ...
 *
 */
public interface DataPageDefaultViewProjectSearchPagesDAO_IF {
	...
	void save(DataPageDefaultViewProjectSearchPagesDTO item);
	...
	void update_UrlStartPath_And_SrchDataLkpParams(DataPageDefaultViewProjectSearchPagesDTO item);
