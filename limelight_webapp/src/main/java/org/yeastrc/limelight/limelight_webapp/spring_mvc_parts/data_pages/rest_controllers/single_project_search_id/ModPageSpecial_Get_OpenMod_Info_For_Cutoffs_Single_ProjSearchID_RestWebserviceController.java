...
InitializingBean // InitializingBean is Spring Interface for triggering running method afterPropertiesSet() 
{
	 ...
	 */
	private static final String CONTROLLER_PATH = AA_RestWSControllerPaths_Constants.MOD_PAGE_SPECIAL__GET_OPEN_MOD_INFO_FOR_CUTOFFS_SINGLE_PROJECT_SEARCH_ID__REST_WEBSERVICE_CONTROLLER_VERSION_0002;
...
//    		ValidateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result validateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result =
    		...
    		if ( searchFlags_anyPsmHas_OpenModifications ) {
    			...
    			for ( ReportedPeptide_MinimalData_List_FromSearcher_Entry peptideMinimalObjects_Entry : peptideMinimalObjectsList ) {
    				...
    				for ( PsmOpenModification_Masses_Positions_For_PsmIds_Searcher_ResultEntry entry : psmOpenModificationMassesList ) {
