...
InitializingBean // InitializingBean is Spring Interface for triggering running method afterPropertiesSet() 
{
	 ...
	 */
	private static final String CONTROLLER_PATH = AA_RestWSControllerPaths_Constants.MOD_PAGE_SPECIAL__GET_OPEN_MOD_INFO_FOR_CUTOFFS_SINGLE_PROJECT_SEARCH_ID__REST_WEBSERVICE_CONTROLLER;
...
//    			log.warn("Commented out call to cached_WebserviceResponse_Management.putCachedResponse(...");
