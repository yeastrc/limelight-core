...
@Controller
//@RequestMapping("/")
public class Experiment__ProteinView_Controller {

	private static final Logger log = LoggerFactory.getLogger( Experiment__ProteinView_Controller.class );
...
//	private Page_UserDefault_SetForJSP_IF page_UserDefault_SetForJSP;
	 ...
	 * 
	 */
	public Experiment__ProteinView_Controller() {
		super();
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.EXPERIMENT___PROTEIN_VIEW_PAGE_CONTROLLER;
...
//		}
        ...
        return "data_pages/experiment_pages/protein_Experiment.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
