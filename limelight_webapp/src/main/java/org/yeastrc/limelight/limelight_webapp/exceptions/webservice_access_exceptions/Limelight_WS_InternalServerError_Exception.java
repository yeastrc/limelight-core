...
@ResponseStatus( 
		...
		reason = WebServiceErrorMessageConstants.INTERNAL_SERVER_ERROR_TEXT )

public class Limelight_WS_InternalServerError_Exception extends Limelight_WS_ErrorResponse_Base_Exception {
