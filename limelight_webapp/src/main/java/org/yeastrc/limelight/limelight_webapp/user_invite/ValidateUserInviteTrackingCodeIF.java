 ...
 *
 */
public interface ValidateUserInviteTrackingCodeIF {
	 ...
	 * @throws Exception 
	 */
	ValidateUserInviteTrackingCodeResult validateUserInviteTrackingCode(String inviteTrackingCode) throws Exception;
