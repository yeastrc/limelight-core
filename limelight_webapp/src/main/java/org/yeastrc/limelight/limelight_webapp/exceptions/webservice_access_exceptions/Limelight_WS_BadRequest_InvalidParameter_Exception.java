 ...
 * 
 * Thrown for Invalid Parameter passed to this webservice
 * 
...
@ResponseStatus( 
		...
		reason = WebServiceErrorMessageConstants.INVALID_PARAMETER_TEXT )

public class Limelight_WS_BadRequest_InvalidParameter_Exception extends Limelight_WS_ErrorResponse_Base_Exception {
