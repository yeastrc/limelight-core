 ...
 */
@Component
public class FileImportTrackingFileIdCreatorDAO extends Limelight_JDBC_Base implements FileImportTrackingFileIdCreatorDAO_IF {

	private static final Logger log = LoggerFactory.getLogger( FileImportTrackingFileIdCreatorDAO.class );
	...
	private int insertIntoTable() {
		...
		final String INSERT_SQL = "INSERT INTO file_import_tracking_id_creator_tbl () VALUES ( )";
	...
	private void deleteRecordsWhereIdLessThanParamId( int id ) {
		...
		final String DELETE_SQL = "DELETE FROM file_import_tracking_id_creator_tbl WHERE id < ?";
