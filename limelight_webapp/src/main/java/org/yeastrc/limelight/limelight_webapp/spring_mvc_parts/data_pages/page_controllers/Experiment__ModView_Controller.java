...
@Controller
//@RequestMapping("/")
public class Experiment__ModView_Controller {

	private static final Logger log = LoggerFactory.getLogger( Experiment__ModView_Controller.class );
...
//	private Page_UserDefault_SetForJSP_IF page_UserDefault_SetForJSP;
	 ...
	 * 
	 */
	public Experiment__ModView_Controller() {
		super();
		
		log.info( "ModView_Controller() constructor" );
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.EXPERIMENT___MOD_VIEW_PAGE_CONTROLLER;
...
//		}
        ...
        return "data_pages/experiment_pages/mod_Experiment.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
