...
import org.yeastrc.limelight.limelight_webapp.searchers.GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher.GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_Result_Item;
import org.yeastrc.limelight.limelight_webapp.searchers.GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_IF;
...
/**
 * Gold Standard Root/Main entries for Project Search ID
 * 
 * Found through the search scan file entries for search
 *
 */
@RestController
public class GoldStandard_Root_Entries_For_Single_ProjSearchID_RestWebserviceController {
  
	private static final Logger log = LoggerFactory.getLogger( GoldStandard_Root_Entries_For_Single_ProjSearchID_RestWebserviceController.class );
	...
	@Autowired
	private GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_IF goldStandard_Root_Entries_For_SearchId_Searcher;
	 ...
	 * 
	 */
	public GoldStandard_Root_Entries_For_Single_ProjSearchID_RestWebserviceController() {
		super();
//		log.warn( "constructor no params called" );
	...
	@PostMapping( 
			path = {
					...
					+ AA_RestWSControllerPaths_Constants.SCAN_FILE_GOLD_STANDARD_ROOT_ENTRIES_ROOT_SINGLE_PROJECT_SEARCH_ID
			},
...
//    		ValidateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result validateWebSessionAccess_ToWebservice_ForAccessLevelAndProjectSearchIds_Result =
			...
			GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_Result searcher_Result =
					goldStandard_Root_Entries_For_SearchId_Searcher.getForProjectSearchId(projectSearchId);
					
			List<GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_Result_Item> dbEntries = searcher_Result.getEntries();
			...
			for ( GoldStandard_Root_Mapping_Entries_For_ProjectSearchId_Searcher_Result_Item dbEntry : dbEntries ) {
				
				WebserviceResult_Entry webserviceResult_Entry = new WebserviceResult_Entry();
				
				webserviceResult_Entry.gold_standard_for_scan_file_root__project_scnfl_mapping_tbl__id = dbEntry.getGold_standard_for_scan_file_root__project_scnfl_mapping_tbl__id();
    ...
    public static class WebserviceResult_Entry {
		...
		private int gold_standard_for_scan_file_root__project_scnfl_mapping_tbl__id;
		...
		public int getGold_standard_for_scan_file_root__project_scnfl_mapping_tbl__id() {
			return gold_standard_for_scan_file_root__project_scnfl_mapping_tbl__id;
		}
