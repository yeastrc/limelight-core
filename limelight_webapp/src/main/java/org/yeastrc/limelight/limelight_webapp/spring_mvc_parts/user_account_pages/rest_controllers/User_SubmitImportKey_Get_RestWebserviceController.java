 ...
 */
@RestController
public class User_SubmitImportKey_Get_RestWebserviceController {

	private static final Logger log = LoggerFactory.getLogger( User_SubmitImportKey_Get_RestWebserviceController.class );
	 ...
	 * 
	 */
	public User_SubmitImportKey_Get_RestWebserviceController() {
		super();
	...
	private WebserviceResult webserviceMethodInternal( WebserviceRequest webserviceRequest, String remoteIP, HttpServletRequest httpServletRequest ) throws Exception {
		...
		String submitImportProgramKey = 
				fileImportSubmitImportProgramKeyPerUserDAO.getSubmitImportProgramKeyFromUserId( userSession.getUserId() );

		webserviceResult.setStatus(true);
		webserviceResult.existingKey = submitImportProgramKey;

		log.info( "Get Submit Import Key SUCCESSFUL!!! user id: " + userSession.getUserId() );
