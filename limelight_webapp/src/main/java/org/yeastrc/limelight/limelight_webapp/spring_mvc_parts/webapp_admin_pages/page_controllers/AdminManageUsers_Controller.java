...
/**
 * Admin Manage users Page - Page Controller
 *
 */
@Controller
public class AdminManageUsers_Controller {

	private static final Logger log = LoggerFactory.getLogger( AdminManageUsers_Controller.class );

	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_WebappAdmin_PageControllerPaths_Constants.ADMIN_MANAGE_USERS_PAGE_CONTROLLER;
...
//		log.warn( "controllerMethod(...) called" );
		try {
			...
			return "webapp_administration_pages_and_parts/pages/webappAdminManageUsers.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
