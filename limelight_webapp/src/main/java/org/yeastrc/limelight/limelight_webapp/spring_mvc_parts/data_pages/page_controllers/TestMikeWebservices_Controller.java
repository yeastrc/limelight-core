...
@Controller
//@RequestMapping("/")
public class TestMikeWebservices_Controller {

	private static final Logger log = LoggerFactory.getLogger( TestMikeWebservices_Controller.class );
	
    /**
	 * 
	 */
	public TestMikeWebservices_Controller() {
		super();
//		log.warn( "constructor no params called" );
	}

	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.TEST_MIKE_WEBSERVICES_PAGE_CONTROLLER;
...
//				+ ", queryData: " + queryData );
	...
	private String controllerEntryInternal( String otherPageState, HttpServletRequest httpServletRequest ) {
        ...
        return "data_pages/project_search_ids_driven_pages/testMikeWebservices.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
