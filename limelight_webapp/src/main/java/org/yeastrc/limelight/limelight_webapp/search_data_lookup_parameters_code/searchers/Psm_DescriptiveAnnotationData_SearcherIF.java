 ...
 *
 */
public interface Psm_DescriptiveAnnotationData_SearcherIF {
	 ...
	 * @throws Exception
	 */
	List<PsmDescriptiveAnnotationDTO> getPsmDescriptiveAnnotationDTOList(long psmId, Collection<Integer> annotationTypeIds) throws Exception;
