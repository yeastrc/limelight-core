...
/**
 * Search Tags for Project Id
 *
 */
@Component
public class SearchTags_InProject_ForProjectIdSearcher extends Limelight_JDBC_Base implements SearchTags_InProject_ForProjectIdSearcher_IF  {

	private static final Logger log = LoggerFactory.getLogger( SearchTags_InProject_ForProjectIdSearcher.class );
	
	/**
	 * 
	 *
	 */
	public static class SearchTags_InProject_ForProjectIdSearcher_ResultItem {
	...
	private static final String MAIN_QUERY_SQL = 
			" SELECT "
			+ " id, tag_category_id, tag_string, tag_color_font, tag_color_background, tag_color_border "
			+ " FROM "
	 ...
	 */
	@Override
	public List<SearchTags_InProject_ForProjectIdSearcher_ResultItem>  get_SearchTags_InProject_ForProjectId( int projectId ) throws SQLException {

		List<SearchTags_InProject_ForProjectIdSearcher_ResultItem> results = new ArrayList<>();
		...
		try ( Connection connection = super.getDBConnection();
			...
			try ( ResultSet rs = preparedStatement.executeQuery() ) {
				while ( rs.next() ) {
					SearchTags_InProject_ForProjectIdSearcher_ResultItem result = new SearchTags_InProject_ForProjectIdSearcher_ResultItem();
