...
public class SearchScanFile_For_SearchIds_Searcher extends Limelight_JDBC_Base implements SearchScanFile_For_SearchIds_Searcher_IF  {
	...
	/* (non-Javadoc)
	 * @see org.yeastrc.limelight.limelight_webapp.searchers.SearchScanFile_For_SearchIds_Searcher_IF#getSearchScanFile_For_SearchIds(java.util.Collection)
	 */
	@Override
	public List<SearchScanFileDTO> getSearchScanFile_For_SearchIds( Collection<Integer> searchIds ) throws SQLException {
		...
		querySQL_SB.append( "SELECT * FROM search_scan_file_tbl WHERE search_id IN ( " );
