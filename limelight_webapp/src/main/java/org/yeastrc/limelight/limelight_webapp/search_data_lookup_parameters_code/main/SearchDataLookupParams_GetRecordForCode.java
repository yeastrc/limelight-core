 ...
 */
@Component
public class SearchDataLookupParams_GetRecordForCode implements SearchDataLookupParams_GetRecordForCodeIF {

	private static final Logger log = LoggerFactory.getLogger( SearchDataLookupParams_GetRecordForCode.class );
