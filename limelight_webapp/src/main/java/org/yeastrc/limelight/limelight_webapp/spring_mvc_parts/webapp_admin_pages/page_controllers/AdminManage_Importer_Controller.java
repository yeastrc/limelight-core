...
/**
 * Admin Manage Importer / Pipeline Execution Page - Page Controller
 * 
 * 
 ...
 */
@Controller
public class AdminManage_Importer_Controller {

	private static final Logger log = LoggerFactory.getLogger( AdminManage_Importer_Controller.class );

	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_WebappAdmin_PageControllerPaths_Constants.ADMIN_MANAGE_IMPORTER_PIPELINE_EXECUTION_PAGE_CONTROLLER;
...
//		log.warn( "controllerMethod(...) called" );
		try {
			...
			return "webapp_administration_pages_and_parts/pages/webappAdminManage_Importer_PipelineExecution.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
