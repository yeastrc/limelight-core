...
/**
 * Get Current Webapp Terms Of Service
 *
 */
@RestController
public class WebappConfig_TermsOfService_GetCurrent_RestWebserviceController {

	private static final Logger log = LoggerFactory.getLogger( WebappConfig_TermsOfService_GetCurrent_RestWebserviceController.class );
	...
	@PostMapping( 
			path = { 
					...
					+ AA_WebappAdmin_RestWSControllerPaths_Constants.WEBAPP_ADMIN_TERMS_OF_SERVICE_GET_CURRENT_REST_WEBSERVICE_CONTROLLER
			},
	...
	private WebserviceResult webserviceMethodInternal( WebserviceRequest webserviceRequest, String remoteIP, HttpServletRequest httpServletRequest ) throws Exception {
		...
		webserviceResult.termsOfServiceEnabled = isTermsOfServiceEnabled.isTermsOfServiceEnabled();
		webserviceResult.termsOfServiceText = null;
		
		if ( termsOfServiceTextVersionsDTO != null ) {
		
			webserviceResult.termsOfServiceText = termsOfServiceTextVersionsDTO.getTermsOfServiceText();
		}
