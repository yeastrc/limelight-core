...
/**
 * Root object for JSON request to PeptideView_PeptideList_RestWebserviceController
 * 
 * This is the representation that the Javascript code uses
 *
 */
public class PeptideView_PeptideList_Single_ProjectSearchId_RequestRoot {
