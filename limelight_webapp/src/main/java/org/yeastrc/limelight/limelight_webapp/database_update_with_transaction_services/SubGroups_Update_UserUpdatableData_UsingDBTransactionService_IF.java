 ...
 *
 */
public interface SubGroups_Update_UserUpdatableData_UsingDBTransactionService_IF {

	//  Spring DB Transactions
	/**
	 * @param projectSearchSubGroupDTOList
	 */
	void subGroups_Update_UserUpdatableData(List<ProjectSearchSubGroupDTO> projectSearchSubGroupDTOList);
