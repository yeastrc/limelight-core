...
/**
 * Cached Data Management - Write Cached Data Size to Log File
 *
 */
@RestController
public class WebappConfig_ManageCachedData_WriteCachedDataSizeToLogFile_RestWebserviceController {

	private static final Logger log = LoggerFactory.getLogger( WebappConfig_ManageCachedData_WriteCachedDataSizeToLogFile_RestWebserviceController.class );
	...
	@PostMapping( 
			path = { 
					...
					+ AA_WebappAdmin_RestWSControllerPaths_Constants.WEBAPP_ADMIN_MANAGE_CACHED_DATA_WRITE_CACHED_DATA_SIZE_TO_LOG_FILE_REST_WEBSERVICE_CONTROLLER
			},
	...
	private WebserviceResult webserviceMethodInternal( WebserviceRequest webserviceRequest, String remoteIP, HttpServletRequest httpServletRequest ) throws Exception {
		...
		cachedData_InMemory_CentralRegistry.writeToLogAllCacheSizes();
