...
/**
 * Get User Id if Actual User Logged In
 *
 * For Rest Controller since DOES throw exception when no session or not actual user
 */
@Component
public class GetUserIdActualUserLoggedIn_ForRestController {
	 ...
	 * @return
	 * @throws if no session or not actual user
	 */
	public int userIdOfActualUserLoggedIn( HttpServletRequest httpServletRequest ) {
