...
@Controller
//@RequestMapping("/")
public class QCView_Controller {

	private static final Logger log = LoggerFactory.getLogger( QCView_Controller.class );
	 ...
	 * 
	 */
	public QCView_Controller() {
		super();
		
		log.info( "QCView_Controller() constructor" );
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.QC_VIEW_PAGE_CONTROLLER;
...
//				+ ", queryData: " + queryData );
	...
	private String controllerEntryInternal( String otherPageState, HttpServletRequest httpServletRequest ) {
        ...
        return "data_pages/project_search_ids_driven_pages/qcView.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
