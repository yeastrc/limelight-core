...
@Controller
//@RequestMapping("/")
public class PeptideView_Controller {

	private static final Logger log = LoggerFactory.getLogger( PeptideView_Controller.class );
	 ...
	 * 
	 */
	public PeptideView_Controller() {
		super();
		
		log.info( "PeptideView_Controller() constructor" );
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.PEPTIDE_VIEW_PAGE_CONTROLLER;
