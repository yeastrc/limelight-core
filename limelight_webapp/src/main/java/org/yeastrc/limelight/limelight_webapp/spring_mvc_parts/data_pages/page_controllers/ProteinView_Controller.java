...
@Controller
//@RequestMapping("/")
public class ProteinView_Controller {

	private static final Logger log = LoggerFactory.getLogger( ProteinView_Controller.class );
	...
	private static final String PRIMARY_CONTROLLER_PATH = 
			AA_PageControllerPaths_Constants.PROTEIN_VIEW_PAGE_CONTROLLER;
...
//				+ ", queryData: " + queryData );
	...
	private String controllerEntryInternal( String otherPageState, HttpServletRequest httpServletRequest ) {
        ...
        return "data_pages/project_search_ids_driven_pages/proteinView.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
