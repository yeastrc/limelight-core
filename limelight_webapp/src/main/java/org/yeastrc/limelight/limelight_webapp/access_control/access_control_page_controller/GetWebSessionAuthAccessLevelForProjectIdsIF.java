 ...
 *
 */
public interface GetWebSessionAuthAccessLevelForProjectIdsIF {

	/**
	 * @param projectIds
	 * @return 
	 * @throws SQLException 
	 * @throws LimelightErrorDataInWebRequestException - if project id not in DB
	 */
	GetWebSessionAuthAccessLevelForProjectIds_Result getAuthAccessLevelForProjectIds(List<Integer> projectIds,
