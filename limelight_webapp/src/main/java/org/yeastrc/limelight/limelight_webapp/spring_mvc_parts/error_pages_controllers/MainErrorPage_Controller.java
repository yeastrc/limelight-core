 ...
 */
@Controller
public class MainErrorPage_Controller {

	private static final Logger log = LoggerFactory.getLogger( MainErrorPage_Controller.class );

	private static final String PRIMARY_CONTROLLER_PATH = AA_ErrorPageControllerPaths_Constants.MAIN_ERROR_PAGE_CONTROLLER;
...
//		httpServletResponse.setStatus( 404 );
        ...
        return "generalError.jsp";  // forward to JSP. Path to JSP specified in application.properties:spring.mvc.view.prefix
