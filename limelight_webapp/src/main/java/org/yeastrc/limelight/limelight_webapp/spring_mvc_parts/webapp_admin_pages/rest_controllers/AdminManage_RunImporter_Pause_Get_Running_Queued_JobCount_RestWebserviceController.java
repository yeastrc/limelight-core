...
import org.yeastrc.limelight.limelight_webapp.searchers.FileImport_Pause_RunImporter_Get_CurrentStatus_Searcher_IF;
 ...
 * 
 * Get Job Counts for Running and Queued
 * 
 * Manage Importer and Pipeline Execution Page - Manages the "Run Importer" process and its spawned processes
 *
 */
@RestController
public class AdminManage_RunImporter_Pause_Get_Running_Queued_JobCount_RestWebserviceController {

	private static final Logger log = LoggerFactory.getLogger( AdminManage_RunImporter_Pause_Get_Running_Queued_JobCount_RestWebserviceController.class );
	...
	@Autowired
	private FileImport_Pause_RunImporter_Get_CurrentStatus_Searcher_IF fileImport_Pause_RunImporter_Get_CurrentStatus_Searcher;
	...
	@PostMapping( 
			path = { 
					...
					+ AA_WebappAdmin_RestWSControllerPaths_Constants.WEBAPP_ADMIN_MANAGE_RUN_IMPORTER_PAUSE_GET_RUNNING_QUEUED_JOB_COUNT__REST_WEBSERVICE_CONTROLLER
			},
	...
	private WebserviceResult webserviceMethodInternal( WebserviceRequest webserviceRequest, String remoteIP, HttpServletRequest httpServletRequest ) throws Exception {
		...
		webserviceResult.importer_Queued_OR_Requeued_JobCount = FileImportTracking_Searcher_Shared.getInstance().getItemCount_Status_QUEUED__RE_QUEUED();	
		webserviceResult.importer_Running_JobCount = FileImportTracking_Searcher_Shared.getInstance().getItemCount_Status_STARTED();
		
		webserviceResult.importAndPipelineRun_Queued_OR_Requeued_JobCount = FileImportAndPipelineRunTracking_Searcher_Shared.getInstance().getItemCount_Status_QUEUED__RE_QUEUED();
		webserviceResult.importAndPipelineRun_Running_JobCount = FileImportAndPipelineRunTracking_Searcher_Shared.getInstance().getItemCount_Status_STARTED();
	...
	public static class WebserviceResult {
		...
		private int importer_Running_JobCount;
		private int importAndPipelineRun_Running_JobCount;

		private int importer_Queued_OR_Requeued_JobCount;
		private int importAndPipelineRun_Queued_OR_Requeued_JobCount;
		
		public int getImporter_Running_JobCount() {
			return importer_Running_JobCount;
		}
		public int getImportAndPipelineRun_Running_JobCount() {
			return importAndPipelineRun_Running_JobCount;
		}
		public int getImporter_Queued_OR_Requeued_JobCount() {
			return importer_Queued_OR_Requeued_JobCount;
		}
		public int getImportAndPipelineRun_Queued_OR_Requeued_JobCount() {
			return importAndPipelineRun_Queued_OR_Requeued_JobCount;
		}
	}
