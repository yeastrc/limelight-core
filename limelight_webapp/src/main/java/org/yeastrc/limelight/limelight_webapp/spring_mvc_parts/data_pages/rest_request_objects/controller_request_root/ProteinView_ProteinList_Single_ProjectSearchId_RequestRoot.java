...
/**
 * Root object for JSON request to ProteinView_ProteinList_RestWebserviceController
 * 
 * This is the representation that the Javascript code uses
 *
 */
public class ProteinView_ProteinList_Single_ProjectSearchId_RequestRoot {
