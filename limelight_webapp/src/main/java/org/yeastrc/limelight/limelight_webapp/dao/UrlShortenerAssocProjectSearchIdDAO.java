 ...
 */
@Component
public class UrlShortenerAssocProjectSearchIdDAO extends Limelight_JDBC_Base implements UrlShortenerAssocProjectSearchIdDAO_IF {

	private static final Logger log = LoggerFactory.getLogger( UrlShortenerAssocProjectSearchIdDAO.class );

	private static final String INSERT_SQL = 
			"INSERT INTO url_shortener_associated_project_search_id_tbl "
	...
	public void save( UrlShortenerAssocProjectSearchIdDTO item ) {
