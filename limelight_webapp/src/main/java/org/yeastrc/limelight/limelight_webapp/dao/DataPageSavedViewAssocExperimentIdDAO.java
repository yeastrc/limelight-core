 ...
 */
@Component
public class DataPageSavedViewAssocExperimentIdDAO extends Limelight_JDBC_Base implements DataPageSavedViewAssocExperimentIdDAO_IF  {

	private static final Logger log = LoggerFactory.getLogger( DataPageSavedViewAssocExperimentIdDAO.class );

	private static final String INSERT_SQL = 
			"INSERT INTO data_page_saved_view_assoc_experiment_id_tbl "
			+ "( assoc_main_id, experiment_id ) "
			+ "VALUES ( ?, ? )";
	...
	public void save( DataPageSavedViewAssocExperimentIdDTO item ) {
