...
<%--  spectrumViewer_PSM_NotFound.jsp --%>
<%
...
<html>
<head>
	<title>Limelight - PSM not found</title>
  ...
  <div class="page-content" >	
	...
	<div id="main_container_below_logo">
  	...
  	<div  style="position: relative; margin-left: 10px; margin-right: 10px; text-align: center;" class="page-label">
	  	...
	  	<div >
		  There is no PSM with the id you are accessing: <c:out value="${ psmId_From_LorikeetSpectrumViewer_PageController }"></c:out>
		</div>
