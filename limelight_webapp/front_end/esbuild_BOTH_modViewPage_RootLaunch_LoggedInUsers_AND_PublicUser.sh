...
# esbuild_BOTH_modViewPage_RootLaunch_LoggedInUsers_AND_PublicUser.sh
...
./src/js/page_js/data_pages/project_search_ids_driven_pages/mod_view_page/modViewPage_RootLaunch_LoggedInUsers.ts  \
 ...
 --outfile=./webpack_build_output/js_generated_bundles/data_pages/modViewPage_RootLaunch_LoggedInUsers-bundle.js


#  Build Mod Page - Public user

./node_modules/.bin/esbuild \
./src/js/page_js/data_pages/project_search_ids_driven_pages/mod_view_page/modViewPage_RootLaunch_PublicUser.ts  \
 --bundle --sourcemap --target=es2023  \
  '--define:process.env.NODE_ENV="production"' \
 --outfile=./webpack_build_output/js_generated_bundles/data_pages/modViewPage_RootLaunch_PublicUser-bundle.js
