...
//		$modal_overlay_container.css("height", "100vh"); //  Makes size 100% of viewport height
		...
		for ( let projectSearchId of projectSearchIds ) {
			...
			let searchNameObject = searchNamesKeyProjectSearchId[ projectSearchId ];
			if ( ! searchNameObject ) {
			...
			let searchProgramsPerSearchDataForProjectSearchId = searchProgramsPerSearchData[ projectSearchId ];
...
//			}
	...
	_addCutoffsForEntryForType( {
		...
		if ( filterableAnnotationTypes_AnnotationTypeIds.length === 0 ) {
			// No filterableAnnotationTypes for type
			return;  //  EARLY EXIT
		}
		...
		for ( const filterableAnnotationTypes_AnnotationTypeIds_Item of filterableAnnotationTypes_AnnotationTypeIds ) {
			...
			let filterableAnnotation_Item_AnnotationTypeId = filterableAnnotation_Item.annotationTypeId;
			...
			let searchProgramsPerSearchForId = searchProgramsPerSearchDataForProjectSearchId[ filterableAnnotation_Item.searchProgramsPerSearchId ];
			if ( ! searchProgramsPerSearchForId ) {
				throw Error("No searchProgramsPerSearchForId for filterableAnnotation_Item.searchProgramsPerSearchId: " +
						...
						", filterableAnnotation_Item.id: " + filterableAnnotation_Item.id );
			}
