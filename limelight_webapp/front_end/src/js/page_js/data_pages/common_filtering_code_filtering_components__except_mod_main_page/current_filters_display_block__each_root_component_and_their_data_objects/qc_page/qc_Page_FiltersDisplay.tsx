/**
 * qc_Page_FiltersDisplay.tsx
 * 
 * Display currently applied Filters on QC Page
 * 
 ...
 * 
 */
export type QC_Page_FiltersDisplay_clearAllFiltersClickHandler = () => void;

/**
 * 
 */
export interface QC_Page_FiltersDisplay_Props {
    ...
    clearAllFiltersClickHandler : QC_Page_FiltersDisplay_clearAllFiltersClickHandler;
}

/**
 * 
 */
interface QC_Page_FiltersDisplay_State {

    prev_qc_Page_FiltersDisplay_ComponentData : QC_Page_FiltersDisplay_ComponentData;
}

/**
 * 
 */
export class QC_Page_FiltersDisplay extends React.Component< QC_Page_FiltersDisplay_Props, QC_Page_FiltersDisplay_State > {
     ...
     * 
     */    
    constructor(props : QC_Page_FiltersDisplay_Props) {
        super(props);

        this.state = { prev_qc_Page_FiltersDisplay_ComponentData : props.qc_Page_FiltersDisplay_ComponentData };
    }

    /**
     * 
     */   
    shouldComponentUpdate( nextProps: Readonly<QC_Page_FiltersDisplay_Props>, nextState: Readonly<QC_Page_FiltersDisplay_State>, nextContext: any) : boolean {

        if ( nextProps.qc_Page_FiltersDisplay_ComponentData !== this.props.qc_Page_FiltersDisplay_ComponentData ) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            { // SearchSubGroups - NOT on Experiment Page
                ...
                const currentFilter = currentFiltersDisplayBlock__PSB__SearchSubGroups({
                    searchSubGroup_Are_All_SearchSubGroupIds_Selected: this.props.qc_Page_FiltersDisplay_ComponentData.searchSubGroup_Are_All_SearchSubGroupIds_Selected,
                    searchSubGroup_PropValue: this.props.qc_Page_FiltersDisplay_ComponentData.searchSubGroup_PropValue
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Modifications and Reporter Ions
                ...
                const currentFilter = currentFiltersDisplayBlock__Modifications_and_ReporterIons({
                    modificationMass_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.modificationMass_UserSelections_StateObject,
                    reporterIonMass_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.reporterIonMass_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Scan_RetentionTime_MZ_UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Scan_RetentionTime_MZ_UserSelections({
                    scan_RetentionTime_MZ_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.scan_RetentionTime_MZ_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  PSM Hide Independent Decoy PSMs Filter
                ...
                const currentFilter = currentFiltersDisplayBlock__PSM_Exclude_IndependentDecoy_PSMs_UserSelections({
                    psm_Exclude_IndependentDecoy_PSMs_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Peptide Unique UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Peptide_QC__PeptideUnique_UserSelection({
                    peptideUnique_UserSelection_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.peptideUnique_UserSelection_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Peptide Tryptic UserSelections
                const currentFilter = currentFiltersDisplayBlock__PeptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections({
                    peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject
                })
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Protein Position Filter UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Peptide_QC__ProteinPositionFilter_UserSelections_Container_GetsDataForDisplay({
                    proteinPositionFilter_UserSelections_StateObject: this.props.qc_Page_FiltersDisplay_ComponentData.proteinPositionFilter_UserSelections_StateObject,
                    proteinPositionFilter_UserSelections_StateObject_Changed_ForceRebuildRender_Object: this.props.qc_Page_FiltersDisplay_ComponentData,
                    projectSearchIds: this.props.qc_Page_FiltersDisplay_ComponentData.projectSearchIds,
                    commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root: this.props.qc_Page_FiltersDisplay_ComponentData.commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root,
                });
