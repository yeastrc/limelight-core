/**
 * scanFileToSearches_Page_FiltersDisplay.tsx
 * 
 * Display currently applied Scan File to Searches Page Filters.
 * 
 ...
 * 
 */
export type ScanFileToSearches_Page_FiltersDisplay_clearAllFiltersClickHandler = () => void;

/**
 * 
 */
export interface ScanFileToSearches_Page_FiltersDisplay_Props {
    ...
    clearAllFiltersClickHandler : ScanFileToSearches_Page_FiltersDisplay_clearAllFiltersClickHandler;
}

/**
 * 
 */
interface ScanFileToSearches_Page_FiltersDisplay_State {

    prev_scanFileToSearches_Page_FiltersDisplay_ComponentData : ScanFileToSearches_Page_FiltersDisplay_ComponentData;
}

/**
 * 
 */
export class ScanFileToSearches_Page_FiltersDisplay extends React.Component< ScanFileToSearches_Page_FiltersDisplay_Props, ScanFileToSearches_Page_FiltersDisplay_State > {
     ...
     * 
     */    
    constructor(props : ScanFileToSearches_Page_FiltersDisplay_Props) {
        super(props);

        this.state = { prev_scanFileToSearches_Page_FiltersDisplay_ComponentData : props.scanFileToSearches_Page_FiltersDisplay_ComponentData };
    }

    /**
     * 
     */   
    shouldComponentUpdate( nextProps: Readonly<ScanFileToSearches_Page_FiltersDisplay_Props>, nextState: Readonly<ScanFileToSearches_Page_FiltersDisplay_State>, nextContext: any) : boolean {

        if ( nextProps.scanFileToSearches_Page_FiltersDisplay_ComponentData !== this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData ) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            {  //  scanFilenameId_On_PSM_Filter_UserSelection
                ...
                const currentFilter = currentFiltersDisplayBlock__ScanFilenameId_On_PSM_Filter_UserSelection({
                    scanFilenameId_On_PSM_Filter_UserSelection_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.scanFilenameId_On_PSM_Filter_UserSelection_StateObject,
                    commonData_LoadedFromServer_MultipleSearches__ScanFile_SearchScanFileId_ScanFilename_ScanFileId_Holder: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.commonData_LoadedFromServer_MultipleSearches__ScanFile_SearchScanFileId_ScanFilename_ScanFileId_Holder
                });
                if ( currentFilter ) {
            ...
            { // SearchSubGroups - NOT on Experiment Page
                ...
                const currentFilter = currentFiltersDisplayBlock__PSB__SearchSubGroups({
                    searchSubGroup_Are_All_SearchSubGroupIds_Selected: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.searchSubGroup_Are_All_SearchSubGroupIds_Selected,
                    searchSubGroup_PropValue: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.searchSubGroup_PropValue
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Modifications and Reporter Ions
                ...
                const currentFilter = currentFiltersDisplayBlock__Modifications_and_ReporterIons({
                    modificationMass_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.modificationMass_UserSelections_StateObject,
                    reporterIonMass_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.reporterIonMass_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Scan_RetentionTime_MZ_UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Scan_RetentionTime_MZ_UserSelections({
                    scan_RetentionTime_MZ_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.scan_RetentionTime_MZ_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  PSM Charge Filter
                ...
                const currentFilter = currentFiltersDisplayBlock__Charge_On_PSM_Filter_UserSelection({
                    psm_Charge_Filter_UserSelection_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.psm_Charge_Filter_UserSelection_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Scan Peak Filter
                ...
                const currentFilter = currentFiltersDisplayBlock__ScanPeak_M_Over_Z__Intensity_Filter_UserSelection({
                    scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject
                })
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  PSM Hide Independent Decoy PSMs Filter
                ...
                const currentFilter = currentFiltersDisplayBlock__PSM_Exclude_IndependentDecoy_PSMs_UserSelections({
                    psm_Exclude_IndependentDecoy_PSMs_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            //         peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject
            //     });
            //     if ( currentFilter ) {
            //         currentFiltersArray.push( currentFilter );
            //     }
            ...
            {  //  Scan Number Filter
                const currentFilter = currentFiltersDisplayBlock__ScanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection({
                    scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject,
                    projectSearchIds: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.projectSearchIds,
                    dataPageStateManager: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.dataPageStateManager,
                    commonData_LoadedFromServer_MultipleSearches__ScanFile_SearchScanFileId_ScanFilename_ScanFileId_Holder: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.commonData_LoadedFromServer_MultipleSearches__ScanFile_SearchScanFileId_ScanFilename_ScanFileId_Holder
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
            ...
            {  //  Peptide Unique UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Peptide_QC__PeptideUnique_UserSelection({
                    peptideUnique_UserSelection_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.peptideUnique_UserSelection_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Peptide Sequence UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Peptide_QC__PeptideSequence_UserSelections({
                    peptideSequence_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.peptideSequence_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Peptide Sequence Missed Cleavage Count UserSelections
                const currentFilter = currentFiltersDisplayBlock__PeptideSequence_MissedCleavageCount_UserSelections({
                    peptideSequence_MissedCleavageCount_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.peptideSequence_MissedCleavageCount_UserSelections_StateObject
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Peptide Tryptic UserSelections
                const currentFilter = currentFiltersDisplayBlock__PeptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections({
                    peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject
                })
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
            ...
            {  //  Protein Position Filter UserSelections
                ...
                const currentFilter = currentFiltersDisplayBlock__Peptide_QC__ProteinPositionFilter_UserSelections_Container_GetsDataForDisplay({
                    proteinPositionFilter_UserSelections_StateObject: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.proteinPositionFilter_UserSelections_StateObject,
                    proteinPositionFilter_UserSelections_StateObject_Changed_ForceRebuildRender_Object: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData,
                    projectSearchIds: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.projectSearchIds,
                    commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root: this.props.scanFileToSearches_Page_FiltersDisplay_ComponentData.commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root,
                });
                if ( currentFilter ) {
                    currentFiltersArray.push( currentFilter );
                }
