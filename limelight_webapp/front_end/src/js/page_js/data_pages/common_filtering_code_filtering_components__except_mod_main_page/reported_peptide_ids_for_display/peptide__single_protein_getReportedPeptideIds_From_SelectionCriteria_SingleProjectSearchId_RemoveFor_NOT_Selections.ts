...
export const peptide__single_protein_getReportedPeptideIds_From_SelectionCriteria_SingleProjectSearchId_RemoveFor_NOT_Selections = function (
    {
        ...
        reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId__NOT_Selection: Peptide__single_protein_ReportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId
    ...
    for (const reportedPeptideId of reportedPeptideIds_Copy) {
        ...
        const entry_NOT_Selection_For_reportedPeptideId: Peptide__single_protein_ReportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId__ForSingleReportedPeptideId =
