/**
 * currentFiltersDisplayBlock__Peptide_QC__ProteinPosition_Of_Modification_Filter_UserSelections_Container_GetsDataForDisplay.tsx
 *
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/current_filters_display_block__common_and_page_specific/current_filters_display_block__peptide_qc__display_elements/currentFiltersDisplayBlock__Peptide_QC__ProteinPosition_Of_Modification_Filter_UserSelections";
 ...
 * @param proteinPosition_Of_Modification_Filter_UserSelections_Proteins_Names_Lengths_Data
 */
export const currentFiltersDisplayBlock__Peptide_QC__ProteinPosition_Of_Modification_Filter_UserSelections_Container_GetsDataForDisplay = function (
    {
        projectSearchIds,
        proteinPosition_Of_Modification_Filter_UserSelections_StateObject,
        proteinPosition_Of_Modification_Filter_UserSelections_StateObject_Changed_ForceRebuildRender_Object,
        commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root,
    } : {
    ...
    const currentFiltersDisplayBlock__Peptide_QC__ProteinPosition_Of_Modification_Filter_UserSelections_GetData_Callback = function () {
    ...
    return currentFiltersDisplayBlock__Peptide_QC__ProteinPosition_Of_Modification_Filter_UserSelections({
        proteinPosition_Of_Modification_Filter_UserSelections_StateObject,
