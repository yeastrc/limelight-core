/**
 * searchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add_Overlay.tsx
 *
 * React Component
 *
...
export interface SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__Component_Change_Callback_Params {
    new_CommentText: string
}

export type SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__Component_Change_Callback =
    (params: SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__Component_Change_Callback_Params) => void

export class SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__OpenOverlay__FunctionParams {
 ...
 * @param params
 */
export const searchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__OpenOverlay = function(
    params: SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__OpenOverlay__FunctionParams
) : void {
    ...
    const change_Callback_Local = ( params_To_change_Callback_Local : SearchDetailsAndFilterBlock_MainPage_SearchDetails_LoggedInUsers__Comment__Add__Component_Change_Callback_Params ) => {
...
class SearchName_and_SearchShortName_Change_Component extends React.Component< SearchName_and_SearchShortName_Change_Component_Props, SearchName_and_SearchShortName_Change_Component_State > {
    ...
    render() {
        ...
        let addButton_Disabled = false;
        if (this._commentText_InvalidValue ) {
            addButton_Disabled = true;
        }
