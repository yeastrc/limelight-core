...
export const get_SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Layout = function({
    ...
    searchList : Array<SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Search_or_Folder_DisplayListItem>
 ...
 */
export class SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Search_or_Folder_DisplayListItem {
    ...
    folderId : number
    folderName : string
    searchesInFolder : Array<SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Search_or_Folder_DisplayListItem>
...
interface SearchDetailsAndFilterBlock_ChangeSearches_Overlay_OuterContainer_Component_State {
    searchesAndFoldersList? : Array<SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Search_or_Folder_DisplayListItem>
}
...
interface SearchEntry_Props {
    searchDisplayListItem : SearchDetailsAndFilterBlock_ChangeSearches_Overlay_Search_or_Folder_DisplayListItem
    selected : boolean
