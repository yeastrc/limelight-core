/**
 * searchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout.tsx
 *
 * Re-Order Searches Selections Update In Progress Overlay - For selecting which searches to display
 *
 *
 */
 ...
 *
 */
export const get_SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_Layout = function(
    {
 ...
 *
 */
interface SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component_Props {
    // callbackOnClicked_Background : () => void;
}
 ...
 *
 */
interface SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component_State {
 ...
 *
 */
class SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component extends React.Component< SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component_Props, SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component_State > {
     ...
     *
     */
    constructor(props: SearchDetailsAndFilterBlock_Re_Order_Searches_UpdateInProgress_OverlayLayout_OuterContainer_Component_Props) {
        super(props);
            ...
            <ModalOverlay_No_Titlebar_Limelight_Component_v001
                ...
                >
                    ...
                    <div style={ { marginTop: 20, textAlign: "center" }}>
                        Updating Page for Search Re-Order
                    </div>
