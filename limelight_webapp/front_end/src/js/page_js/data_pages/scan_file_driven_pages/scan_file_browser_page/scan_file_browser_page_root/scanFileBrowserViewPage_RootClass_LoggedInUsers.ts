/**
 * scanFileBrowserViewPage_RootClass_LoggedInUsers.ts
 * 
 * For qcView.jsp page
 * 
 ...
 * in file scanFileBrowserViewPage_RootClass_Common.ts
 * 
 */
...
export class ProteinViewPage_RootClass_LoggedInUsers {
	...
	initialize() {
		...
		//  Main Root Class for scanFileBrowserViewPage
        const scanFileBrowserViewPage_RootClass_Common = new ScanFileBrowserViewPage_RootClass_Common({ dataPages_LoggedInUser_CommonObjectsFactory });
