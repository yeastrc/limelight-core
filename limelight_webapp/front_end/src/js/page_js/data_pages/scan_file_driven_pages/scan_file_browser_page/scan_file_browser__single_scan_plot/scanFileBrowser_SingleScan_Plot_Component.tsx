 ...
 *
 */
export interface ScanFileBrowser_SingleScan_Plot_Component_Props {
 ...
 *
 */
interface ScanFileBrowser_SingleScan_Plot_Component_State {
 ...
 *
 */
export class ScanFileBrowser_SingleScan_Plot_Component extends React.Component< ScanFileBrowser_SingleScan_Plot_Component_Props, ScanFileBrowser_SingleScan_Plot_Component_State > {
     ...
     *
     */
    constructor(props: ScanFileBrowser_SingleScan_Plot_Component_Props) {
        super(props);
        try {
     ...
     */
    // static getDerivedStateFromProps( props : ScanFileBrowser_SingleScan_Plot_Component_Props, state : ScanFileBrowser_SingleScan_Plot_Component_State ) {
    //
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<ScanFileBrowser_SingleScan_Plot_Component_Props>, prevState: Readonly<ScanFileBrowser_SingleScan_Plot_Component_State>, snapshot?: any) {
        try {
    ...
    private _documentBody_MouseMove_Event__UpdateMainChartSelection(event: React.MouseEvent<SVGRectElement, MouseEvent>) {
        ...
        console.warn("ScanFileBrowser_SingleScan_Plot_Component: _window_MouseMove_Event__UpdateMainChartSelection: window Mouse Move. event: ", event)
        ...
        if ( ! this._main_Rect_overlay_MouseDown_PositionRelativeTo_Rect ) {
            //  No "Mouse Down" stored data
            console.warn("ScanFileBrowser_SingleScan_Plot_Component: _documentBody_MouseMove_Event__UpdateMainChartSelection: document <body> Mouse Move. Nothing in this._main_Rect_overlay_MouseDown_PositionRelativeTo_Rect")
    ...
    render() {
        ...
        let y_Value_Min = 0;
        let y_Value_Max = this._min_Max_X_Y_Values.y_value_MAX;
        ...
        try {
...

            {
                {  //  Tick Marks on Vertical Axis
                    ...
                    if ( y_Value_Max === this._min_Max_X_Y_Values.y_value_MAX ) {
                        ...
                        tickMark_Points_WithNumbers_from_d3_Array = [0, this._min_Max_X_Y_Values.y_value_MAX / 2, this._min_Max_X_Y_Values.y_value_MAX]
            ...
            if ( this.state.binned_Entries ) {
                ...
                const y_Value_Max_FractionOf_Default  = y_Value_Max / this._min_Max_X_Y_Values.y_value_MAX
            ...
            return (
                <div >
                    ...
                    && this.props.scanFileBrowser__Get_SingleScanData_SpectralStorage_YES_Peaks_Data_ForSingleScanNumber.ionInjectionTime_InMilliseconds !== null ? (
                        <div>
                            Ion Injection Time (Milliseconds): { this.props.scanFileBrowser__Get_SingleScanData_SpectralStorage_YES_Peaks_Data_ForSingleScanNumber.ionInjectionTime_InMilliseconds }
                        </div>
                    ) : null }
                    ...
                    >
                        <svg width={ _CHART_WIDTH_OVERALL } height={ _CHART_HEIGHT_OVERALL } style={ { margin: 0, padding: 0 } }>
                            ...
                            <g
                                transform={ "translate(" + 6 + ", " + ( _CHART_HEIGHT_TOP_MARGIN + Math.round( _CHART_HEIGHT_MAIN_CONTENTS / 2 ) ) + ")" }
                            >
                                <text
 ...
 * @param props
 */
const _compute_Min_Max_X_Y_Values = function (props : ScanFileBrowser_SingleScan_Plot_Component_Props) : Min_Max_X_Y_Values {
...
const _bin_Entries_On_X_value = function (
    {
        ...
        props: ScanFileBrowser_SingleScan_Plot_Component_Props
    ...
    for ( const binned_Entry of binned_Entries_On_X_Value ) {
        ...
        binned_Entry.y_value_FractionOfMax = singleEntryForPlot_EntryToUse.intensity / min_Max_X_Y_Values.y_value_MAX;
    }
