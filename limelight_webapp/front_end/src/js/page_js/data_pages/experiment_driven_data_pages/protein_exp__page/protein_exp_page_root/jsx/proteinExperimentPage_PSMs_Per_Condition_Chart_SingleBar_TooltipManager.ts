/**
 * proteinExperimentPage_PSMs_Per_Condition_Chart_SingleBar_TooltipManager.ts
 *
 * PSM Count Chart - Tooltip Manager for Tooltip on Chart Bars
 *
 *
 */
 ...
 */
export class ProteinExperimentPage_PSMs_Per_Condition_Chart_SingleBar_TooltipManager {
