/**
 * projectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component.tsx
 *
 * Javascript for projectView.jsp page
 *
 * Upload Data - Submit Import Program Information Display Overlay - Feature Detection Import - Select Scan File
 *
 *
 */
 ...
 *
 */
class ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component_Props {
 ...
 *
 */
class ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component_State {
 ...
 *
 */
export class ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component extends React.Component< ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component_Props, ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component_State > {
     ...
     *
     */
    constructor(props: ProjectPage_UploadData_UploadFiles_Overlay__FeatureDetectionImport_SelectScanFile_Component_Props) {
        super(props);
