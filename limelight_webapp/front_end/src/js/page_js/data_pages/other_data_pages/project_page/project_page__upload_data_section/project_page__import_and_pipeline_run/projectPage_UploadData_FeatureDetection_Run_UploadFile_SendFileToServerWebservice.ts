/**
 * projectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice.ts
 *
 * Javascript for projectView.jsp page
 *
 * Upload Data - Submit Import Program Information Display Overlay - Feature Detection Run - Upload File
 *
 *
 */
...
const BULLSEYE_FILE_UPLOAD_SERVICE_URL = "d/rws/for-page/project-feature-detection-run-and-import-upload-file";
 ...
 *
 */
export class ProjectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice_SendDataObject {

    uploadKey: string;
    hardklorConfFile: boolean;
    bullseyeConfFile: boolean;
}

/**
 *
 */
export class ProjectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice_Result {
 ...
 * @param fileToSend
 */
export const projectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice = function (
    {
        fileToSend, sendDataObject
    } : {
        fileToSend: File
        sendDataObject: ProjectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice_SendDataObject
    }
) : Promise<ProjectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice_Result> {

    return new Promise<ProjectPage_UploadData_FeatureDetection_Run_UploadFile_SendFileToServerWebservice_Result>( (resolve, reject) =>  { try {
...
//			alert("Upload aborted");
        ...
        let uploadFileHeaderParams = {
            ...
            bullseyeConfFile: sendDataObject.bullseyeConfFile,
