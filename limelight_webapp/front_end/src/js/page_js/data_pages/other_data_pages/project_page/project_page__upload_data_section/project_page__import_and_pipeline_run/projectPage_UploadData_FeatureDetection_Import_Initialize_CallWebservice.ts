/**
 * projectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice.ts
 *
 * Javascript for projectView.jsp page
 *
 * Upload Data - Submit Import Program Information Display Overlay - Feature Detection Import - Initialize
 *
 *
 */
 ...
 */
export class ProjectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice_Response {
 ...
 */
export const projectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice = function(
    {
        projectIdentifier
    } : {
        projectIdentifier: string
    }
) : Promise<ProjectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice_Response> {
    ...
    return new Promise<ProjectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice_Response>( (resolve, reject) => { try {

        const requestObject = {
            projectIdentifier
        };

        const url = "d/rws/for-page/project-feature-detection-import-initialize";
        ...
        promise_webserviceCallStandardPost.then( ({ responseData }: { responseData: ProjectPage_UploadData_FeatureDetection_Import_Initialize_CallWebservice_Response }) => { try {
