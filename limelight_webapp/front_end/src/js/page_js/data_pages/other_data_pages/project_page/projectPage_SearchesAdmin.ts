...
export class ProjectPage_SearchesAdmin {
	...
	private _projectPage_SearchesAdmin_CopyMove_Searches;

	private _projectPage_SearchesAdmin_OrganizeSearchesAndFolders;
	...
	constructor({ projectIdentifierFromURL }) {
		...
		this._projectPage_SearchesAdmin_OrganizeSearchesAndFolders = new ProjectPage_SearchesAdmin_OrganizeSearchesAndFolders({
