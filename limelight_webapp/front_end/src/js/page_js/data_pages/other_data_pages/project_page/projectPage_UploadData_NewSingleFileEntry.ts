/**
 * projectPage_UploadData_NewSingleFileEntry.ts
 * 
...
export class ProjectPage_UploadData_NewSingleFileEntry {
	...
	static factory( params ) {
		...
		if ( constructorParam.fileType === undefined ) {
			...
			if ( isNaN( constructorParam.fileType ) ) {
				...
				throw Error( "fileTypeString failed to parse: " + constructorParam.fileTypeString );
			}
		}
	...
	private file;
	private fileType;
	private fileTypeString;
	private fileIndex;
	private isLimelightXMLFile;

	private uploadedToServer = undefined;
