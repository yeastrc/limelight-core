/**
 * projectPage__ResearchersSection__Researcher_Interaction_Root_Component.tsx
 *
 * Javascript React Components for projectView.jsp page
 *
 * Researchers Section - Provide interaction for Researcher
 *
 * Root Component
 *
 */
 ...
 *
 */
export interface ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component_Props {
 ...
 *
 */
interface ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component_State {
 ...
 *
 */
export class ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component extends React.Component< ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component_Props, ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component_State > {
     ...
     *
     */
    constructor(props: ProjectPage__ResearchersSection__Researcher_Interaction_ROOT_Component_Props) {
        super(props)
    ...
    render() {
        ...
        return (
            ...
            <div className="top-level-container share-data-root ">
                ...
                <ProjectPage__ResearchersSection__CommonInteraction_TopLevelLabel_Component
                    userIsProjectOwner_ProjectNotLocked={ false }
