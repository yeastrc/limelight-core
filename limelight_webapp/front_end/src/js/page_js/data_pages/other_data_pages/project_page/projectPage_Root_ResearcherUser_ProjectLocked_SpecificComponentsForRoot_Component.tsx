 ...
 * @param props
 */
export const getComponent_ProjectPage_Root_ResearcherUser_ProjectLocked_SpecificComponentsForRoot_Component = function( props: ProjectPage_SearchesSection_MainBlock_Component_Props ) : React.JSX.Element {
