/**
 * projectPage__ResearchersSection__CommonInteraction_TopLevelLabel_Component.tsx
 *
 * Javascript React Components for projectView.jsp page
 *
 * Researchers Section - Provide Top Level Label and Expand Collapse icons
 *
 ...
 *
 */
export class ProjectPage__ResearchersSection__CommonInteraction_TopLevelLabel_Component extends React.Component< ProjectPage__ResearchersSection__CommonInteraction_Common_TopLevelLabel_Component_Props, ProjectPage__ResearchersSection__CommonInteraction_Common_TopLevelLabel_Component_State > {
