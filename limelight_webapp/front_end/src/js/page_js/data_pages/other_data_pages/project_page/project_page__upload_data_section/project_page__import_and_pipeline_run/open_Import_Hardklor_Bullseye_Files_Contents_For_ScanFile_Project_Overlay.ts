/**
 * open_Import_Hardklor_Bullseye_Files_Contents_For_ScanFile_Project_Overlay.ts
 *
...
// Import_Hardklor_and_Bullseye_Files

export class Open_Import_Hardklor_and_Bullseye_Files_Contents_For_ScanFile_Project_Overlay__FunctionParams {
...
export type Open_Import_Hardklor_and_Bullseye_Files_Contents_For_ScanFile_Project_Overlay__FunctionType =
    ( params: Open_Import_Hardklor_and_Bullseye_Files_Contents_For_ScanFile_Project_Overlay__FunctionParams ) => void;

/**
 *
 */
export const open_Import_Hardklor_Bullseye_Files_Contents_For_ScanFile_Project_Overlay : Open_Import_Hardklor_and_Bullseye_Files_Contents_For_ScanFile_Project_Overlay__FunctionType = function (

    functionParams: Open_Import_Hardklor_and_Bullseye_Files_Contents_For_ScanFile_Project_Overlay__FunctionParams) : void {
    ...
    const projectPage_UploadData_UploadFiles__Params: ProjectPage_UploadData_UploadFiles__Params = {
        ...
        scanFileSelection_For_FeatureDetectionImport,
