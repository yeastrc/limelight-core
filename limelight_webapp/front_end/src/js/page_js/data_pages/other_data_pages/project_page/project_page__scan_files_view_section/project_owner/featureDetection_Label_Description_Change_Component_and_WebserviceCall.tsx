/**
 * featureDetection_Label_Description_Change_Component_and_WebserviceCall.tsx
 *
...
export interface FeatureDetection_Label_Description_Change_Component_Change_Callback_Params {
    newLabel: string
    newDescription: string
}

type FeatureDetection_Label_Description_Change_Component_Change_Callback =
    (params: FeatureDetection_Label_Description_Change_Component_Change_Callback_Params) => void

export interface FeatureDetection_Label_Description_Change_Component__openOverlay__FunctionParams {
    featureDetectionRoot_MappingTblId: number
    existingLabel: string
    existingDescription: string
    position_top: number
    position_left: number
    change_Callback: FeatureDetection_Label_Description_Change_Component_Change_Callback
    cancel_Callback: () => void
}

export type FeatureDetection_Label_Description_Change_Component__openOverlay__FunctionType =
    ( params : FeatureDetection_Label_Description_Change_Component__openOverlay__FunctionParams ) => void

/**
 *
 */
export const featureDetection_Label_Description_Change_Component__openOverlay: FeatureDetection_Label_Description_Change_Component__openOverlay__FunctionType = function (
    params: FeatureDetection_Label_Description_Change_Component__openOverlay__FunctionParams
) : void {
    ...
    const change_Callback_Local = ( params_To_change_Callback_Local : FeatureDetection_Label_Description_Change_Component_Change_Callback_Params ) => {
    ...
    const componentToAdd = (
        <FeatureDetection_Label_Description_Change_Component
            featureDetectionRoot_MappingTblId={ params.featureDetectionRoot_MappingTblId }
 ...
 *
 */
interface FeatureDetection_Label_Description_Change_Component_Props {
 ...
 *
 */
interface FeatureDetection_Label_Description_Change_Component_State {
 ...
 *
 */
class FeatureDetection_Label_Description_Change_Component extends React.Component< FeatureDetection_Label_Description_Change_Component_Props, FeatureDetection_Label_Description_Change_Component_State > {
     ...
     *
     */
    constructor(props: FeatureDetection_Label_Description_Change_Component_Props) {
        super(props)
    ...
    private _formSubmit(event: React.FormEvent<HTMLFormElement>) : void {
        try {
            ...
            var requestData = {
                ...
                featureDetectionRoot_MappingTblId: this.props.featureDetectionRoot_MappingTblId
            };
                                ...
                                <div style={ { position: "relative", display: "inline-block" } }>
                                    ...
                                    { ( saveButton_Disabled ) ? (
                                        <Limelight_Tooltip_React_Extend_Material_UI_Library__Main_Tooltip_Component
                                            title={
                                                <span>
                                                    Enter a label and description<br/>to enable 'Save'
                                                </span>
                                            }
                                            { ...limelight_Tooltip_React_Extend_Material_UI_Library__Main__Common_Properties__For_FollowMousePointer() }
                                        >
