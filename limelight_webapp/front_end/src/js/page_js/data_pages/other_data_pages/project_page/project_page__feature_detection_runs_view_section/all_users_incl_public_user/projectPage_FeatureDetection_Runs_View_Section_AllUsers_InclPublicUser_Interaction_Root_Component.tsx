/**
 * projectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_Root_Component.tsx
 *
...
import {
    ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_Common_TopLevelLabel_Component,
 ...
 *
 */
export interface ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component_Props {
 ...
 *
 */
interface ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component_State {
 ...
 *
 */
export class ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component extends React.Component< ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component_Props, ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component_State > {
     ...
     *
     */
    constructor(props: ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_ROOT_Component_Props) {
        super(props)

        const bodyEverShown = ProjectPage_FeatureDetection_Runs_View_Section_AllUsers_InclPublicUser_Interaction_Common_TopLevelLabel_Component_Expanded_Default;
                ...
                >
                    <div style={ { marginLeft: 26 } }>
                        { (this.state.bodyEverShown) ? (
                            ...
                            <ProjectPage_Section_AllUsers_InclPublicUser_Interaction_FeatureDetection_Run_List_Component
