/**
 * upload_Bullseye_File_Contents_For_ScanFile_Project_SendFileToServerWebservice.ts
 *
 * Javascript for projectView.jsp page
 *
 * Scan Files View Section - Provide interaction for Project Owner to Upload Bullseye file for a scan file for Feature Detection
 *
 * Send File To Server Webservice
 *
 */
...
const BULLSEYE_FILE_UPLOAD_SERVICE_URL = "d/rws/for-page/project-upload-feature-detection-upload-bullseye-data-file";
 ...
 *
 */
export class Upload_Bullseye_File_Contents_For_ScanFile_Project_SendFileToServerWebservice_Result {
 ...
 * @param fileToSend
 */
export const upload_Bullseye_File_Contents_For_ScanFile_Project_SendFileToServerWebservice = function (
    {
        fileToSend, featureDetectionRootId
    } : {
        fileToSend: File
        featureDetectionRootId: number
    }
) : Promise<Upload_Bullseye_File_Contents_For_ScanFile_Project_SendFileToServerWebservice_Result> {

    return new Promise<Upload_Bullseye_File_Contents_For_ScanFile_Project_SendFileToServerWebservice_Result>( (resolve, reject) =>  { try {

        const promise_send = _actual_WebserviceCall__Return_XHR_Response_Via_Promise({ featureDetectionRootId, fileToSend });
...
const _actual_WebserviceCall__Return_XHR_Response_Via_Promise = function (
    {
        featureDetectionRootId, fileToSend
    } : {
        featureDetectionRootId: number
        fileToSend: File
    }
