/**
 * commonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues.ts
 *
 * For Single Project Search  -  Protein_Descriptive_AnnotationValues
 *
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_AnnotationTypeId {
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_ProteinId {

    readonly proteinSequenceVersionId : number

    //  	Protein Level Descriptive Annotation Data Per Annotation Type Id
    // 					- <annTypeId,{ valueString }>
    private _protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId :
        Map<number, CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_AnnotationTypeId> = new Map();
     ...
     */
    get_Protein_Descriptive_AnnotationValues_For_AnnotationTypeId(annotationTypeId: number) {
        return this._protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.get(annotationTypeId)
    }

    /**
     * @param proteinSequenceVersionId
     */
    get_Protein_Descriptive_AnnotationValues_All() {
        return this._protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.values()
    }
     ...
     * @param entry
     */
    InternalUse__InsertEntry( entry: CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_AnnotationTypeId ) {

        this._protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.set( entry.annotationTypeId, entry )
    }
}
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder {

    //  	Protein Level Descriptive Annotation Data Per Protein Sequence Version Id
    // 					- proteinSequenceVersionId,<<annTypeId,{valueString }>>
    private _protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_ProteinId :
        Map<number, CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_ProteinId> = new Map()
     ...
     * @param proteinSequenceVersionId
     */
    get_Protein_Descriptive_AnnotationValues_For_ProteinId(proteinSequenceVersionId: number) {
        return this._protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_ProteinId.get(proteinSequenceVersionId)
    }
     ...
     * @param entry
     */
    InternalUse__InsertEntry( entry: CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_ProteinId ) {

        this._protein_Descriptive_AnnotationValues_Key_AnnTypeId_Key_ProteinId.set( entry.proteinSequenceVersionId, entry )
    }
}
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder__FunctionResult {
 ...
 *  MAIN CLASS
 */
export class CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues {

    //  !! If these values change, then create a new instance of this class

    private _projectSearchId: number

    private _protein_Descriptive_AnnotationValues_Holder: CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder = new CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder()
    ...
    static getNewInstance(
        ...
        return new CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues({
            projectSearchId
        });
    }
     ...
     *
     */
    get_Protein_Descriptive_AnnotationValues_ReturnPromise(
        {
    ...
    ): Promise<CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder__FunctionResult> {

        const result = this.get_Protein_Descriptive_AnnotationValues({ proteinSequenceVersionIds, annotationTypeIds });
     ...
     *
     */
    get_Protein_Descriptive_AnnotationValues(
        {
            proteinSequenceVersionIds, annotationTypeIds
        } : {
            proteinSequenceVersionIds: Set<number>
        ...
        {
            data: CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder__FunctionResult
            promise: Promise<CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder__FunctionResult>
        } {
...

        {
            ...
            if ( foundAll_proteinSequenceVersionIds && foundAll_annotationTypeIds ) {
                ...
                //  EARLY RETURN
                return { promise: undefined, data: { protein_Descriptive_AnnotationValues_Holder: this._protein_Descriptive_AnnotationValues_Holder } }
            }
        }
        ...
        if ( this._annotationTypeIds_Loaded_DataFor.size > 0 || this._annotationTypeIds_LoadingInProgress.size > 0 ) {
            ...
            if ( ! foundAll_annotationTypeIds ) {
                ...
                //  EARLY RETURN
                return { data: undefined, promise: new Promise<CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_Holder__FunctionResult>(
                        (resolve, reject) => { try {
                            promise.catch(reason => reject(reason))
                            promise.then(noValue => { try {
                                resolve({
                                    protein_Descriptive_AnnotationValues_Holder: this._protein_Descriptive_AnnotationValues_Holder
                                })
    ...
    private _remove_Promise_From__loadingInProgress_Promises( promise: Promise<void> ) : {
        ...
        console.log("CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues: _remove_Promise_From__loadingInProgress_Promises: returned found_Promise: " + found_Promise )
    ...
    private _load_Annotation_Data(
        ...
        try {
            ...
            const promise = new Promise<void>( ( resolve, reject ) => { try {
                ...
                const url = "d/rws/for-page/psb/protein-descriptive-ann-data-list-protein-seq-v-ids-ann-type-ids-single-project-search-id";
    ...
    private _process_WebserviceResponse({ responseData, remove_From_Loading_InProgress }: { responseData: any, remove_From_Loading_InProgress: boolean }) : void {
        ...
        //  JS Object.   <Protein Sequence Version Id, <Ann Type Id, SearchProteinDescriptiveAnnotationDTO>> annData_KeyAnnTypeId_Key_ProteinSequenceVersionId;
        ...
        for ( const proteinSequenceVersionIdString of proteinSequenceVersionIdsFromServer_Keys ) {
            ...
            let protein_Descriptive_AnnotationValues_For_ProteinId =
                this._protein_Descriptive_AnnotationValues_Holder.get_Protein_Descriptive_AnnotationValues_For_ProteinId(proteinSequenceVersionIdInt)

            if ( ! protein_Descriptive_AnnotationValues_For_ProteinId ) {
                protein_Descriptive_AnnotationValues_For_ProteinId =
                    new CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_ProteinId({ proteinSequenceVersionId: proteinSequenceVersionIdInt });
                this._protein_Descriptive_AnnotationValues_Holder.InternalUse__InsertEntry(protein_Descriptive_AnnotationValues_For_ProteinId)
            }
            ...
            for ( const annTypeIdString of annTypeIdsFromServer_Keys ) {
                ...
                const protein_Descriptive_AnnotationValues_For_AnnotationTypeId: CommonData_LoadedFromServer_SingleSearch__Protein_Descriptive_AnnotationValues_For_AnnotationTypeId = {
                    annotationTypeId: annTypeIdInt, valueString : annData_FromServer.valueString
                }
                protein_Descriptive_AnnotationValues_For_ProteinId.InternalUse__InsertEntry(protein_Descriptive_AnnotationValues_For_AnnotationTypeId);
            }
        }
    }
