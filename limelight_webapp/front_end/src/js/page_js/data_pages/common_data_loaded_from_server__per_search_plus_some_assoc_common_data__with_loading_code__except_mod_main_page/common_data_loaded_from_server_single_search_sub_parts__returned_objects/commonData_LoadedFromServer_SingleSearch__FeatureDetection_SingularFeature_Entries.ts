        ...
        try {
            const promise = new Promise<void>(
                ( resolve, reject ) => { try {
                    ...
                    const url = "d/rws/for-page/scan-file-feature-detection-singular-feature-entries-single-project-search-id-feature-detection-root-prj-scnfl-mapping-tbl-id-version-0002";
