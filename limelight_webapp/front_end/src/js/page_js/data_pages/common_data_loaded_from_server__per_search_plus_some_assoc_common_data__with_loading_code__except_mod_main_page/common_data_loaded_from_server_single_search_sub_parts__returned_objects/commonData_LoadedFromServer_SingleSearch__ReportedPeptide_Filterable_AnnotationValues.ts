/**
 * commonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues.ts
 *
 * For Single Project Search  -  ReportedPeptide_Filterable_AnnotationValues
 *
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId {
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId {

    readonly reportedPeptideId : number

    //  	Reported Peptide Level Filterable Annotation Data Per Annotation Type Id
    // 					- <annTypeId,{ valueDouble, valueString }>
    private _reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId :
        Map<number, CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId> = new Map();
     ...
     */
    get_ReportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId(annotationTypeId: number) {
        return this._reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.get(annotationTypeId)
    }

    /**
     * @param reportedPeptideId
     */
    get_ReportedPeptide_Filterable_AnnotationValues_All() {
        return this._reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.values()
    }
     ...
     * @param entry
     */
    InternalUse__InsertEntry( entry: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId ) {

        this._reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_AnnotationTypeId.set( entry.annotationTypeId, entry )
    }
}
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder {

    //  	Reported Peptide Level Filterable Annotation Data Per Reported Peptide Id
    // 					- reportedPeptideId,<<annTypeId,{ valueDouble, valueString }>>
    private _reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_ReportedPeptideId :
        Map<number, CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId> = new Map()
     ...
     * @param reportedPeptideId
     */
    get_ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId(reportedPeptideId: number) {
        return this._reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_ReportedPeptideId.get(reportedPeptideId)
    }
     ...
     * @param entry
     */
    InternalUse__InsertEntry( entry: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId ) {

        this._reportedPeptide_Filterable_AnnotationValues_Key_AnnTypeId_Key_ReportedPeptideId.set( entry.reportedPeptideId, entry )
    }
}
 ...
 *
 */
export class CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder__FunctionResult {

    reportedPeptide_Filterable_AnnotationValues_Holder: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder
}

/**
 *  MAIN CLASS
 */
export class CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues {

    //  !! If these values change, then create a new instance of this class

    private _projectSearchId: number

    private _reportedPeptide_Filterable_AnnotationValues_Holder: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder = new CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder()
    ...
    static getNewInstance(
        ...
        return new CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues({
            projectSearchId
        });
    }
    ...
    ): Promise<CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder__FunctionResult> {

        const result = this.get_ReportedPeptide_Filterable_AnnotationValues({ reportedPeptideIds, annotationTypeIds });
     ...
     *
     */
    get_ReportedPeptide_Filterable_AnnotationValues(
        {
            reportedPeptideIds, annotationTypeIds
        } : {
            reportedPeptideIds: Set<number>
        ...
        {
            data: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder__FunctionResult
            promise: Promise<CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder__FunctionResult>
        } {
...

        {
            ...
            if ( foundAll_reportedPeptideIds && foundAll_annotationTypeIds ) {
                ...
                //  EARLY RETURN
                return { promise: undefined, data: { reportedPeptide_Filterable_AnnotationValues_Holder: this._reportedPeptide_Filterable_AnnotationValues_Holder } }
            }
        }
        ...
        if ( this._annotationTypeIds_Loaded_DataFor.size > 0 || this._annotationTypeIds_LoadingInProgress.size > 0 ) {
            ...
            if ( ! foundAll_annotationTypeIds ) {
                ...
                //  EARLY RETURN
                return { data: undefined, promise: new Promise<CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_Holder__FunctionResult>(
                        (resolve, reject) => { try {
                            promise.catch(reason => reject(reason))
                            promise.then(noValue => { try {
                                resolve({
                                    reportedPeptide_Filterable_AnnotationValues_Holder: this._reportedPeptide_Filterable_AnnotationValues_Holder
                                })
    ...
    private _process_WebserviceResponse({ responseData, remove_From_Loading_InProgress }: { responseData: any, remove_From_Loading_InProgress: boolean }) : void {
        ...
        for ( const reportedPeptideIdString of reportedPeptideIdsFromServer_Keys ) {
            ...
            let reportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId =
                this._reportedPeptide_Filterable_AnnotationValues_Holder.get_ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId(reportedPeptideIdInt)

            if ( ! reportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId ) {
                reportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId =
                    new CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId({ reportedPeptideId: reportedPeptideIdInt });
                this._reportedPeptide_Filterable_AnnotationValues_Holder.InternalUse__InsertEntry(reportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId)
            }
            ...
            for ( const annTypeIdString of annTypeIdsFromServer_Keys ) {
                ...
                const reportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId: CommonData_LoadedFromServer_SingleSearch__ReportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId = {
                    annotationTypeId: annTypeIdInt, valueDouble : annData_FromServer.valueDouble, valueString : annData_FromServer.valueString
                }
                reportedPeptide_Filterable_AnnotationValues_For_ReportedPeptideId.InternalUse__InsertEntry(reportedPeptide_Filterable_AnnotationValues_For_AnnotationTypeId);
            }
        }
    }
