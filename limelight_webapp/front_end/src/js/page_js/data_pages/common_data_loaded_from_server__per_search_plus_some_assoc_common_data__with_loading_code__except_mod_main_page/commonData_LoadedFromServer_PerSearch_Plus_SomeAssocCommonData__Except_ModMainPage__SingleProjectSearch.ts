...
import { CommonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data } from "page_js/data_pages/common_data_loaded_from_server__per_search_plus_some_assoc_common_data__with_loading_code__except_mod_main_page/common_data_loaded_from_server_single_search_sub_parts__returned_objects/commonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data";
...
export class CommonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Single_ProjectSearchId {
    ...
    private _commonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data: CommonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data
    ...
    private constructor(
        ...
        this._commonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data =
            CommonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data.getNewInstance(({ projectSearchId }))
    ...
    get_commonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data() {
        return this._commonData_LoadedFromServer_SingleSearch__SpectralStorage_Summary_Data
    }
