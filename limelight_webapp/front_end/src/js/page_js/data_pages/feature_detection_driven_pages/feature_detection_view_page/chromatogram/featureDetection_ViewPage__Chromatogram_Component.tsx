    ...
    private async _load_Chromatogram_For_Selected_ProjectScanFileId__AfterGet_ScanNumbers__NowGet_ScansWithPeaks(
        ...
        try {
...

            {
                ...
                const isotope_M_Over_Z_Addition = chromatogram_Common_Helpers__compute_Isotope_M_Over_Z_Addition_For_Isotope_Number({
                    isotope_Number: chromatogram_Common_Helpers__ISOTOPE_MAX__FOR_CHART_TRACES,
                    charge: this.props.featureDetection_ViewPage__SingularFeature_GetData_ForDataTable_Parameter.featureDetection_PersistentFeature_Entry.charge
                });
    ...
    private async _createOnMount_And_OnUpdate__SpecificChart(
        ...
        ////////
        {
...

            {
                ...
                for ( let isotope_Number = 1; isotope_Number <= chromatogram_Common_Helpers__ISOTOPE_MAX__FOR_CHART_TRACES; isotope_Number++ ) {
...
//  chromatogram_Common_Helpers__compute_Isotope_M_Over_Z_Addition_For_Isotope_Number moved to chromatogram_common/chromatogram_Common_Helpers


//  chromatogram_Common_Helpers__compute_PPM_Mass_For_Precursor_M_Over_Z_PlusMinus moved to chromatogram_common/chromatogram_Common_Helpers


//  chromatogram_Common_Helpers__areaUnderCurve_Display_FormattingFunction moved to chromatogram_common/chromatogram_Common_Helpers
