...
import {getSequenceCoverageBooleanArray_ForReportedPeptideIds} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__single_protein/protein_sequence_display_widget__ForProtExp_SingleProtein/proteinSequenceWidgetDisplay_GetSequenceCoverage_FilteredOnReportedPeptideIds';
import {getSequenceCoverageBooleanArray_NotFiltered} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__single_protein/protein_sequence_display_widget__ForProtExp_SingleProtein/proteinSequenceWidgetDisplay_GetSequenceCoverage_NotFiltered';
...
}>
{
    try {
        ...
        const linksToExternalResources = await _createProteinPage_Display__SingleProtein_MainContent_Component_nonClass_Functions__LinksToExternalResources_Class({
            proteinSequenceVersionId, proteinSequenceString, projectSearchIds, commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root
        });
        ...
        const psmCountForUnfiltered = await _computePsmCountForUnfiltered({ proteinSequenceVersionId, projectSearchIds, commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root });
 ...
 */
const _createProteinPage_Display__SingleProtein_MainContent_Component_nonClass_Functions__LinksToExternalResources_Class = async function({
...
}) : Promise<ProteinPage_Display__SingleProtein_MainContent_Component_nonClass_Functions__LinksToExternalResources_Class> {
    try {
...
const create_ProteinSequenceWidgetDisplay_Component_Data = async function({
    ...
    try {
        ...
        const staticModificationMassesForProteinPositions : ProteinSequenceWidgetDisplay_Component_Data__Build__staticModificationMassesForProteinPositions_PARAM =
            await _get_staticModificationMasses_All_OnProteinByPosition({
                proteinSequenceVersionId : proteinSequenceVersionId,
                projectSearchIds : projectSearchIds,
                commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root
            });
