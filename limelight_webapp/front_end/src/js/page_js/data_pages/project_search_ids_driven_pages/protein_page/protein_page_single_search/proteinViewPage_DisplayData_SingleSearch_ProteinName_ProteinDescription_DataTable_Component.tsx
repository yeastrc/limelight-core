 ...
 * 
 */
interface SingleSearch_ProteinList_ProteinName_ExternalReactComponent_Props {
 ...
 * 
 */
class SingleSearch_ProteinList_ProteinName_ExternalReactComponent extends React.Component< SingleSearch_ProteinList_ProteinName_ExternalReactComponent_Props, SingleSearch_ProteinList_ProteinName_ExternalReactComponent_State > {
 ...
 *
 */
const _getTooltipText = function( proteinNameDescriptionForToolip : Array<ProteinNameDescriptionCacheEntry_SingleSearch> ) : JSX.Element {
