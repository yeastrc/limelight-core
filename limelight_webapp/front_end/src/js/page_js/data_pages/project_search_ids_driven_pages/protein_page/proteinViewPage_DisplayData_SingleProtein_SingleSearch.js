...
import { ProteinViewPage_DisplayData_SingleProtein_ReportedPeptideList } from 'page_js/data_pages/project_search_ids_driven_pages/protein_page/proteinViewPage_DisplayData_SingleProtein_ReportedPeptideList.js';
...
export class ProteinViewPage_Display_SingleProtein_SingleSearch {
	...
	constructor(
		...
		this._proteinViewPage_DisplayData_SingleProtein_ReportedPeptideList = new ProteinViewPage_DisplayData_SingleProtein_ReportedPeptideList(
			{
	...
	_openOverlayAfterLoadData( { proteinSequenceVersionId, projectSearchId, proteinNameDescription, proteinSummaryStatistics } ) {
		...
		const $contentDiv = this._createModalOverlayContentDiv( { proteinNameDescription, proteinSummaryStatistics, linksToExternalResources, searchNameObject } );
...
//				const taxonomy = annotation.taxonomy;
	 ...
	 * 
	 */
	_createModalOverlayContentDiv( { proteinNameDescription, proteinSummaryStatistics, linksToExternalResources, searchNameObject } ) {
	...
	/**
	 * called by contained object of class ProteinViewPage_DisplayData_SingleProtein_ReportedPeptideList
	 */
