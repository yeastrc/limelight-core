/**
 * proteinViewPage_DisplayData_MultipleSearches_CreateProteinDisplayData.ts
 *
 * Create Display Data for Protein List for Multiple  Searches
 */
 ...
 */
export class ProteinDisplayData_From_createProteinDisplayData_MultipleSearches{
    ...
    summaryMap_Key_ProjectSearchId : Map<number, ProteinDataDisplay_MultipleSearches_Summary_PerSearch>
}

/**
 * Entry in proteinList
 */
export class ProteinDataDisplay_ProteinListItem_MultipleSearches {
 ...
 */
export class ProteinNameDescriptionCacheEntry_MultipleSearches {
    name : string
    description: string
}
 ...
 * Entry in incoming Map
 */
export class CountsFor_proteinSequenceVersionIdEntry_MultipleSearches {
    numReportedPeptides : number
    numReportedPeptidesUnique : number
    numPsms : number
}
 ...
 */
export class ProteinDataDisplay_MultipleSearches_Summary_PerSearch {
 ...
 */
export const proteinViewPage_DisplayData_MultipleSearches_CreateProteinDisplayData = function(
    {
        projectSearchIds,
        ...
        proteinNameDescription_Key_ProteinSequenceVersionId : Map<number, ProteinNameDescriptionCacheEntry_MultipleSearches>
    ...
    const summaryMap_Key_ProjectSearchId : Map<number, ProteinDataDisplay_MultipleSearches_Summary_PerSearch> = new Map();
    ...
    for (const projectSearchId of projectSearchIds) {
        ...
        const summary_ForSearch = new ProteinDataDisplay_MultipleSearches_Summary_PerSearch();
    ...
    if ( ! proteinGrouping_CentralStateManagerObjectClass.isGroupProteins_No_Grouping()) {
        ...
        if ( proteinGrouping_CentralStateManagerObjectClass.isGroupProteins_All_Groups()) {
            ...
            const msg = "proteinViewPage_DisplayData_SingleSearch_Create_ProteinList_DataTable_RootTableDataObject.ts:_group_proteinList_Entries_Get_PerProteinIdMap: _proteinGrouping_CentralStateManagerObjectClass.isGroupProteins... not === expected values.  _proteinGrouping_CentralStateManagerObjectClass (Only in Log): " + proteinGrouping_CentralStateManagerObjectClass;
            console.warn(msg);
            throw Error(msg);
        }
    ...
    let proteinResultListResult: Array<ProteinDataDisplay_ProteinListItem_MultipleSearches> = [];
    ...
    for (const outputRecordsMap_Per_proteinSequenceVersionId_Entry of proteinItemRecordsMap_Key_projectSearchId_Key_proteinSequenceVersionId.entries()) {
        ...
        const proteinResultEntry: ProteinDataDisplay_ProteinListItem_MultipleSearches = {
