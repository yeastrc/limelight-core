...
//
//  reportedPeptideIdsForDisplay_ForPeptideList? : Array<number>;  //  For displaying the peptide list in sub component
//
...
//
//  updating_Next_reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId_Map_KeyProjectSearchId_ForPeptideList? : boolean;
//
...
//   });
//
//   const reportedPeptideIdsForDisplay : Array<number> = Array.from( reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId.get_reportedPeptideIds() )
//
...
//   }
//
//   const entriesMap_KeyProjectSearchId : Map<number, ProteinExpmntPage_ReportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId> = new Map();
//   entriesMap_KeyProjectSearchId.set( this.props.propsValue.projectSearchId, reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId )
//
...
//    );
//
//    const reportedPeptideIdsForDisplay : Array<number> = Array.from(
//        getReportedPeptideIdsForDisplay_SingleProjectSearchId_Result.reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId.get_reportedPeptideIds()
//    )
//
...
//     const reportedPeptideIdsAndTheirPsmIds = [];
//
//     for ( const entryFor_reportedPeptideId of reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId.get_Entries_IterableIterator() ) {
//
...
//        );
//
//        const reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId : ProteinExpmntPage_ReportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId = getReportedPeptideIdsForDisplay_SingleProjectSearchId_Result.reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId;
//
//        const reportedPeptideIdsForDisplay : ReadonlySet<number> = reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId.get_reportedPeptideIds();
//
//        //  Data for Reported Peptide List Table
//
//        let reportedPeptideList_RootTableObject : DataTable_RootTableObject = null;
...
//
//           this.setState( (state : ProteinPage_Display_SingleSearch_SingleProtein_MainContent_Component_State, props : ProteinPage_Display_SingleSearch_SingleProtein_MainContent_Component_Props ) : ProteinPage_Display_SingleSearch_SingleProtein_MainContent_Component_State => {
//            return { updating_Next_reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId_Map_KeyProjectSearchId_ForPeptideList : true }
//           });
//
//           window.setTimeout( () => {
//            try {
...
//              updating_Next_reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId_Map_KeyProjectSearchId_ForPeptideList : false,
//              reportedPeptideIdsForDisplay_ForPeptideList: Array.from( reportedPeptideIdsForDisplay ),
//              reportedPeptideList_RootTableObject,
//              reportedPeptideList_numberOfReportedPeptides,
//              reportedPeptideList_numberOfReportedPeptides_Display,
//              reportedPeptideList_numberOfPsmsForReportedPeptides,
...
//                                                       updating_Next_reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId_Map_KeyProjectSearchId_ForPeptideList,
...
//
//   if ( this.state.updating_Next_reportedPeptideIds_AndTheir_PSM_IDs__SingleProjectSearchId_Map_KeyProjectSearchId_ForPeptideList ) {
//
//    updatingMessage = (
