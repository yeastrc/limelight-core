/**
 * proteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component.tsx
 *
...
import {ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_nonClass_Functions} from "page_js/data_pages/project_search_ids_driven_pages/protein_page/protein_page_single_search/protein_page_single_search__search_sub_group/js/proteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_nonClass_Functions";
import {
 ...
 *
 */
export class ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props_Prop {
 ...
 *
 */
export interface ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props {

    propsValue : ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props_Prop
}
 ...
 *
 */
interface ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_State {
 ...
 *
 */
export class ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component extends React.Component< ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props, ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_State > {
    ...
    private _proteinNameDescription_Key_ProteinSequenceVersionId : Map<number, ProteinNameDescriptionCacheEntry_SingleSearch_SearchSubGroup> = new Map();

    //   Cached: Protein Name(s) and Description(s) for Tooltip in a Map, Key ProteinSequenceVersionId
    private _proteinNameDescriptionForToolip_Key_ProteinSequenceVersionId : Map<number, Array<ProteinNameDescriptionCacheEntry_SingleSearch_SearchSubGroup>> = new Map();

    //   Cached: Counts per Protein of peptide, unique peptide, and PSM in a Map, Key ProteinSequenceVersionId
    private _peptideUniquePeptidePSM_Counts_Key_ProteinSequenceVersionId : Map<number, CountsFor_proteinSequenceVersionIdEntry_SingleSearch_SearchSubGroup> = new Map();
     ...
     *
     */
    constructor(props: ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props) {
        super(props);

        const searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue = this._compute_SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue({ props });
     ...
     *
     */
    private _compute_SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue(
        {
            props
        } : {
            props: ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_Props
        ...
        {
            const searchSubGroups_Root = props.propsValue.dataPageStateManager.get_SearchSubGroups_Root()
            if ( searchSubGroups_Root ) {
                const projectSearchIds = props.propsValue.dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay.get_projectSearchIds()
        ...
        const searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue : SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue =
            ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup__Main_Component_nonClass_Functions.compute_searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue({
                propsValue : props.propsValue
            });

        searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue.searchSubGroup_PropValue = searchSubGroup_PropValue;
        ...
        if (this.props.propsValue.singleProtein_CentralStateManagerObject) {
            ...
            if (proteinSequenceVersionId_FromURL !== undefined && proteinSequenceVersionId_FromURL !== null) {
                ...
                if (!this._proteinViewPage_Display_MultipleSearches_SingleProtein) {
                    this._instantiateObject_Class__ProteinPage_Display_SingleSearch__SearchSubGroup_SingleProtein({currentWindowScrollY: undefined});
                }
    ...
    private _searchSubGroup_CentralStateManagerObjectClass_Changed_UpdateState() {
        ...
        const searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue = this._compute_SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue({ props: this.props });

        this.setState({ searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue });
    }
    ...
    private _recompute_FullPage_Except_SearchDetails({ initialPageLoad } : { initialPageLoad : boolean }) {
        ...
        {
            const searchName_Entry = this.props.propsValue.dataPageStateManager.get_searchNames_AsMap().get(projectSearchId)
            if (!searchName_Entry) {
        ...
        const promise_proteinViewPage_DisplayData_SingleSearch__SearchSubGroup_LoadProcessDataFromServer = (
        ...
        promise_proteinViewPage_DisplayData_SingleSearch__SearchSubGroup_LoadProcessDataFromServer.catch( (reason) => {} );
        promise_proteinViewPage_DisplayData_SingleSearch__SearchSubGroup_LoadProcessDataFromServer.then( (value) => {
            try {
    ...
    private _re_renderPage_Actual() {
        ...
        {
            const searchSubGroup_Ids_Selected_Set = _compute_searchSubGroup_Ids_Selected({
                projectSearchId,
            ...
            if ( searchSubGroup_Ids_Selected_Set ) {
                ...
                if ( ! this.props.propsValue.dataPageStateManager.get_SearchSubGroups_Root() ) {
                    const msg = "( ! this.props.propsValue.dataPageStateManager.get_SearchSubGroups_Root() ) when this._compute_searchSubGroup_Ids_Selected(); returns a value. this.props.propsValue.projectSearchId: " + this.props.propsValue.projectSearchId;
                    console.warn( msg );
                    throw Error( msg );
                }

                const searchSubGroups_ForProjectSearchId = this.props.propsValue.dataPageStateManager.get_SearchSubGroups_Root().get_searchSubGroups_ForProjectSearchId( this.props.propsValue.projectSearchId );
                if ( ! searchSubGroups_ForProjectSearchId ) {
                    const msg = "( ! searchSubGroups_ForProjectSearchId ) when _compute_searchSubGroup_Ids_Selected(); returns a value. this.props.propsValue.projectSearchId: " + this.props.propsValue.projectSearchId;
                    console.warn( msg );
                    throw Error( msg );
                }
     ...
     *
     */
    _singleProteinRowClickHandler( params : ProteinViewPage_DisplayData_SingleSearch__SearchSubGroup_ProteinRow_tableRowClickHandler_Callback_Parameter ) {
    ...
    _singleProteinRowShowSingleProteinOverlay( { proteinSequenceVersionId }: {proteinSequenceVersionId: number} ) : void {
        ...
        if ( ! this._proteinViewPage_Display_MultipleSearches_SingleProtein ) {
            ...
            this._instantiateObject_Class__ProteinPage_Display_SingleSearch__SearchSubGroup_SingleProtein({ currentWindowScrollY });
        }
        ...
        const loadedDataPerProjectSearchIdHolder_ForAllProjectSearchIds : Map<number, ProteinViewPage_LoadedDataPerProjectSearchIdHolder> = new Map();
        {
            const projectSearchId = this.props.propsValue.projectSearchId;
            if ( ! projectSearchId ) {
                throw Error("this.props.propsValue.projectSearchId No Value or zero: _instantiateObject_Class__ProteinPage_Display_SingleSearch__SearchSubGroup_SingleProtein(...) ")
            }
            const loadedDataPerProjectSearchIdHolder = this.state.loadedDataPerProjectSearchIdHolder;
            if ( ! loadedDataPerProjectSearchIdHolder ) {
                throw Error("this.state.loadedDataPerProjectSearchIdHolder No Value: _instantiateObject_Class__ProteinPage_Display_SingleSearch__SearchSubGroup_SingleProtein(...) ")
            }
     ...
     */
    _instantiateObject_Class__ProteinPage_Display_SingleSearch__SearchSubGroup_SingleProtein({ currentWindowScrollY }: { currentWindowScrollY: number }) {
    ...
    render() {
        ...
        if ( this.props.propsValue.dataPages_LoggedInUser_CommonObjectsFactory && this.props.propsValue.dataPageStateManager.get_userCanEditSearchSubGroups() ) {

            searchSubGroup_ManageGroupNames_Clicked_Callback = () : void => {

                const projectSearchIds = this.props.propsValue.dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay.get_projectSearchIds()
                if ( projectSearchIds.length === 1 ) {
                    //  Only display for 1 search

                    const projectSearchId = projectSearchIds[ 0 ]
                    this.props.propsValue.dataPages_LoggedInUser_CommonObjectsFactory.call_searchSubGroup_Manage_GroupNames_OpenOverlay_Pass_DataPageStateManager_ProjectSearchId({
                        dataPageStateManager_DataFrom_Server : this.props.propsValue.dataPageStateManager, projectSearchId
                    });
                }
            }
        }
