/**
 * qcViewPage_SingleSearch__Scan_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer.tsx
 *
 * QC Page Single Search : Scan (MS2) Retention Time vs/ Precursor M/Z  for MS 2 Scans - Overlay Container
 *
 */
 ...
 *
 */
export const open_PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__Scan_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__Scan_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer_Props) {
        super(props);
