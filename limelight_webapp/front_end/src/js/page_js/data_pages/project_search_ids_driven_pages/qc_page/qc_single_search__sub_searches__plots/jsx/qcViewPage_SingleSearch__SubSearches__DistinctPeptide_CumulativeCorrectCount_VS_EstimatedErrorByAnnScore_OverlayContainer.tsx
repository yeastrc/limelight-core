/**
 * qcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer.tsx
 *
 * QC Page Single Search : Distinct Peptide Cumulative Error vs Peptide Rank by Best PSM Annotation Score Statistics - Overlay Container
 *
 */
...
import {QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot";
...
const _Overlay_Title = "QC Plot: Est. # Correct vs/ Est. Error By Best PSM Score"
 ...
 *
 */
export const qcViewPage_SingleSearch__SubSearches__Open_DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer_Props) {
        super(props);
                        ...
                        { ( this.state.loadingData ) ? (
                            ...
                            <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                                ...
                                <div style={ { height: "100%" } }>
                                    <QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot
