/**
 * qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot.tsx
 *
 * QC Page SingleSearch : PSM Target VS Decoy Split Violin Plot by Annotation Score Statistics
 *
 *
...
import {
    qcViewPage_SingleSearch__Open_PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer,
    QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_Props, QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
        ...
        promisesAll.then( values => {
            try {
                ...
                if ( psmFilterableAnnotation_Score_Min < 0 ) {
                    ...
                    if ( transform_Score_Local === QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.LOG_10
                        || transform_Score_Local === QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NEGATIVE_LOG_10 ) {
                ...
                } else if ( this.props.transform_Score === QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NEGATIVE_LOG_10 ) {
                ...
                {  //  Plot Target or Independent Decoy
                    ...
                    // const chart_X__Target_or_IndependentDecoy__Array_Length = chart_X__Target_or_IndependentDecoy__Array.length;
                    //
                    // const chart_Y : Array<string> = [];
                    //
                    // for ( let counter = 1; counter <= chart_X__Target_or_IndependentDecoy__Array_Length; counter++ ) {
                    //     chart_Y.push("Search")
                    // }
                ...
                {  //  Plot Decoy
                    ...
                    // const chart_X__Decoy__Array_Length = chart_X__Decoy__Array.length;
                    //
                    // const chart_Y : Array<string> = [];
                    //
                    // for ( let counter = 1; counter <= chart_X__Decoy__Array_Length; counter++ ) {
                    //     chart_Y.push("Search")
                    // }
                ...
                const chart_Y_Axis_Label = "Density";
