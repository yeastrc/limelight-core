/**
 * qcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot.tsx
 *
...
import {open_DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props, QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
    ...
    private _populateChart() {
        ...
        promisesAll.then( values => {
            try {
                ...
                //  Compute reference line coordinates
                ...
                const referenceLine_Y_equals_X_Calculation_Class = new QcViewPage__ReferenceLine_Y_equals_X_Calculation_Class()
                {
                    for ( const entry of chart_X_ALL__ScatterPlot ) {
                        referenceLine_Y_equals_X_Calculation_Class.x_Entry(entry)
                    }

                    for ( const entry of chart_Y_ALL__ScatterPlot ) {
                        referenceLine_Y_equals_X_Calculation_Class.y_Entry(entry)
                    }
                }
    ...
    private _openChartInOverlay() {
        try {
            open_DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer({
                params: {
