/**
 * qcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer.tsx
 *
...
import {QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_StatisticsPlot";

/**
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_State>, snapshot?: any) {

        const show_NoData_Message_NewValue = this._computeNew__show_NoData_Message(this.props);

        this.setState( (state: QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_State, props: QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props ) : QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_State => {
     ...
     *
     */
    private _computeNew__show_NoData_Message(props: QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer_Props) : boolean {
            ...
            <div >
                ...
                <QcPage_ChartBorder >
                    ...
                    {( this.state.show_NoData_Message ) ? (
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_StatisticsPlot.chartTitle } />
                    ) : (
                        <QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_StatisticsPlot
