/**
 * qc_SingleSearch_PSM_Level_Statistics_Section.tsx
 *
 * QC Page Single Search - Section - PSM Level Statistics
 *
 */
...
import {QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__PSMCount_VS_RetentionTime_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSMCount_VS_RetentionTime_MainPageContainer";
import {QcViewPage_SingleSearch__PSM_ChargeState_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_ChargeState_MainPageContainer";
 ...
 *
 */
export interface Qc_SingleSearch_PSM_Level_Statistics_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch_PSM_Level_Statistics_Section_State {
 ...
 *
 */
export class Qc_SingleSearch_PSM_Level_Statistics_Section extends React.Component< Qc_SingleSearch_PSM_Level_Statistics_Section_Props, Qc_SingleSearch_PSM_Level_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch_PSM_Level_Statistics_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch_PSM_Level_Statistics_Section_Props>, nextState: Readonly<Qc_SingleSearch_PSM_Level_Statistics_Section_State>, nextContext: any): boolean {
                    ...
                    >
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" section--chart-block--single-chart-no-margin-bottom-container ">
                                ...
                                <QcViewPage_SingleSearch__PSMCount_VS_RetentionTime_MainPageContainer
                                ...
                                <QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                    annotationTypeId_Score_X={ this.state.annotationTypeId_Score_X }
                                ...
                                <QcViewPage_SingleSearch__PSM_ChargeState_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                />

                                <QcViewPage_SingleSearch__PSMCount_VS_PeptideLength_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                />

                                <QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                />
