/**
 * qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer.tsx
 *
...
import { QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot } from "./qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot";
 ...
 *
 */
export enum QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice {
    NONE = "NONE",
    LOG_10 = "LOG_10",
 ...
 *
 */
export const qcViewPage_SingleSearch__Open_PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_Props) {
        super(props);
        ...
        this.state = {
            ...
            transform_Score: QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NONE,
    ...
    private _score_Contains_NegativeValues_Callback( score_Contains_NegativeValues: boolean ) {
        ...
        if ( this.state.transform_Score !== QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NONE ) {
            this.setState({
                        ...
                        { ( this.state.loadingData ) ? (
                            ...
                            <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                                                ...
                                                <React.Fragment>
                                                    <span>
                                                        <label>
                                                            <input
                                                                type="radio"
                                                                name="QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer_State__TransformScoreChoice"
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NONE
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NEGATIVE_LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                ...
                                <div style={ { height: "100%", position: "relative" } }>
                                    <QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Histogram_ByAnnScore_StatisticsPlot
