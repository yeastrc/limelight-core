/**
 * qcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer.tsx
 *
 * QC Page Single Search : PSM Estimated Error vs PSM Annotation Score Statistics - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props) {
        super(props);
