/**
 * qcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer.tsx
 *
...
import { QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_StatisticsPlot } from "./qcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_StatisticsPlot";
 ...
 *
 */
export const open_DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer extends React.Component< QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer_Props, QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_OverlayContainer_Props) {
        super(props);
                        ...
                        { ( this.state.loadingData ) ? (
                            ...
                            <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                                ...
                                <div style={ { height: "100%" } }>
                                    <QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_StatisticsPlot
