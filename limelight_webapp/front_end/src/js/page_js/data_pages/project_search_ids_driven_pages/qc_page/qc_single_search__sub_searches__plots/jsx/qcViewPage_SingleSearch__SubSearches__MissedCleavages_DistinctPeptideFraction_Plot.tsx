/**
 * qcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot.tsx
 *
 * QC Page SingleSearch__SubSearches : Missed Cleavages - Distinct Peptide Fraction - Multiple computed values
 *
 */
...
import {qc_SingleSearch__SubSearches__Open_MissedCleavages_DistinctPeptideFraction_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer";
...
const chartTitle = "Fraction Distinct Peptides w/ Missed Cleavages";

/**
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot extends React.Component< QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props, QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props>, nextState: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_DistinctPeptideFraction_Plot_State>, snapshot?: any) {
        try {
    ...
    private _populateChart() {
        ...
        for (const searchSubGroup of searchSubGroups_DisplayOrder) {
            ...
            if ( ! missedCleavages_Data ) {
                ...
                // const msg = "qc_Digestion_Statistics_Section_Compute_MissedCleavages_DistinctPeptideFraction_Data_Result.get_result_ForProjectSearchId(projectSearchId); returned nothing. projectSearchId: " + projectSearchId;
                // console.warn(msg);
                // throw Error(msg);
            }
            ...
            const tooltip =
                ...
                distinctPeptide_Count_Containing_MissedCleavage.toLocaleString() + " Distinct Peptide Missed Cleavage Count / " +
    ...
    private _openChartInOverlay() {
        try {
            qc_SingleSearch__SubSearches__Open_MissedCleavages_DistinctPeptideFraction_OverlayContainer({
                params: {
