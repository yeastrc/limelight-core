/**
 * qcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer.tsx
 *
 * QC Page Single Search : PSM Estimated Error - PSM Annotation Score vs PSM Annotation Score Statistics - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer_Props, QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer_Props) {
        super(props);
