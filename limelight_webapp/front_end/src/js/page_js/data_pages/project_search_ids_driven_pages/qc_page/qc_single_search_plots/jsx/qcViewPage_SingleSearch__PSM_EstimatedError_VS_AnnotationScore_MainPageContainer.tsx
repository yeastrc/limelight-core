/**
 * qcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer.tsx
 *
...
import {QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_StatisticsPlot";

/**
 *
 */
export interface QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props, QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer_Props) {
        super(props);
