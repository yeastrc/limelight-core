/**
 * qcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Missed Cleavages - Missed Cleavage Count (PSMs) / Total PSM Count  - Overlay Container
 *
 */
 ...
 *
 */
export const qc_SingleSearch__SubSearches__Open_MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_OverlayContainer_Props) {
        super(props);
