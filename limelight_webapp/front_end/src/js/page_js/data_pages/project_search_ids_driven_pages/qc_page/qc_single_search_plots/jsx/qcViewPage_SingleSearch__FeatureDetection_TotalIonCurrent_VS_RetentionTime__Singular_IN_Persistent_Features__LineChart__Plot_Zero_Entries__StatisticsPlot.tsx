/**
 * qcViewPage_SingleSearch__FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot.tsx
 *
 * QC Page Single Search : Feature Detection: Total Ion Current Y Axis VS Retention Time X Axis Statistics  --  Singular Features IN Persistent Features for Green Line "Detected Features" --  Line Chart - Plot Zero entries
 *
...
//     QcViewPage_SingleSearch__FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_OverlayContainer__PlotType,
//     QcViewPage_SingleSearch__FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_OverlayContainer__TransformScoreChoice
...
//  *
//  */
// export class QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_MissingData_Callback_FunctionType_Params {
//
...
//  *
//  */
// export type QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_MissingData_Callback_FunctionType =
//     ( params: QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_MissingData_Callback_FunctionType_Params ) => void
//
// /**
//  *
//  */
// export interface QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_Props {
//
...
//  *
//  */
// interface QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_State {
//
//     //  Update 'shouldComponentUpdate' and 'componentDidUpdate' if change
//
...
//  *
//  */
// export class QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot extends React.Component< QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_Props, QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_State > {
//
...
//      *
//      */
//     constructor(props: QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_Props) {
//         super(props);
//
...
//      *
//      */
//     shouldComponentUpdate(nextProps: Readonly<QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_Props>, nextState: Readonly<QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_State>, nextContext: any): boolean {
//
//         if (
...
//      *
//      */
//     componentDidUpdate(prevProps: Readonly<QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_Props>, prevState: Readonly<QcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_State>, snapshot?: any) {
//         try {
//             if ( this._renderChart ) {
//
//                 if (
...
//
//                     this.props.qcViewPage_FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_MissingData_Callback_Function({ scans_NotContain_TotalIonCurrent: true });
//
//                     //  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
//                     return; // EARLY RETURN
...
//
//         if ( this.props.plot_Type === QcViewPage_SingleSearch__FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_OverlayContainer__PlotType.SCATTER ) {
//
//             chart_Mode = 'markers';
//         }
//
...
//
//                 if ( this.props.transform_Score === QcViewPage_SingleSearch__FeatureDetection_TotalIonCurrent_VS_RetentionTime__Singular_IN_Persistent_Features__LineChart__Plot_Zero_Entries__StatisticsPlot_OverlayContainer__TransformScoreChoice.LOG_10 ) {
//
