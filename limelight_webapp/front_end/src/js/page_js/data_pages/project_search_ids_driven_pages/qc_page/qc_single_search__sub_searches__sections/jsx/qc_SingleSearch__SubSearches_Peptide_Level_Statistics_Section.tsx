/**
 * qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section.tsx
 *
 * QC Page SingleSearch__SubSearches - Section - Peptide Level Statistics
 *
 */
...
import {QcViewPage_SingleSearch__SubSearches__PeptideCount_VS_PeptideLength_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PeptideCount_VS_PeptideLength_MainPageContainer";

/**
 *
 */
export interface Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_State {
 ...
 *
 */
export class Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section extends React.Component< Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_Props, Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_Props>, nextState: Readonly<Qc_SingleSearch__SubSearches_Peptide_Level_Statistics_Section_State>, nextContext: any): boolean {
                    ...
                    <div className=" section-content-block " style={ { display: ( ! this.state.sectionExpanded ) ? ( "none" ) : null } }>
                        ...
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" section--chart-block--single-chart-no-margin-bottom-container ">
                                ...
                                <QcViewPage_SingleSearch__SubSearches__PeptideCount_VS_PeptideLength_MainPageContainer
