/**
 * qcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer.tsx
 *
...
const _Overlay_Title = "QC Plot: Scan Statistics"
 ...
 *
 */
export const open_ScanCount_VS_RetentionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer_Props, QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__ScanCount_VS_RetentionTime_OverlayContainer_Props) {
        super(props);
