 ...
 *
 */
export class QcViewPage_SingleSearch__MissedCleavages_Plot
    extends React.Component< QcViewPage_SingleSearch__MissedCleavages_Plot_Props, QcViewPage_SingleSearch__MissedCleavages_Plot_State >
