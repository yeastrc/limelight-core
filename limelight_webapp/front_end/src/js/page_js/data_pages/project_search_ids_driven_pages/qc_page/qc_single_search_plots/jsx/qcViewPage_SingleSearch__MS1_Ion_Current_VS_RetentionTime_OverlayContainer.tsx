/**
 * qcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer.tsx
 *
 * QC Page Single Search : MS1 Ion Current vs Retention Time Statistics - Overlay Container
 *
 */
...
import {QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_StatisticsPlot";
import {QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_StatisticsPlot";

////////////////////////////////

const _Overlay_Title = "QC Plot: Retention Time Statistics"
 ...
 *
 */
export const open_MS1_Ion_Current_VS_RetentionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer_Props, QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_OverlayContainer_Props) {
        super(props);
                    ...
                    >
                        ...
                        <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                            ...
                            <div style={ { height: "100%" } }>
                                <QcViewPage_SingleSearch__MS1_Ion_Current_VS_RetentionTime_StatisticsPlot
