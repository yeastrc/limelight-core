/**
 * qcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot.tsx
 *
...
import {qcViewPage_MultipleSearches__Open_PSM_EstimatedError_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot
    extends React.Component< QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_Props, QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_MultipleSearches__PSM_EstimatedError_StatisticsPlot_State>, snapshot?: any) {
        try {
        ...
        try {
            ...
            if ( promises.length === 0 ) {
                ...
                this._populateChart_AfterLoadData({
                    psmTblData_For_ReportedPeptideId_For_MainFilters_Holder_Map_Key_ProjectSearchId, fastaFileStatistics_Holder
                });
            }
    ...
    private _populateChart_AfterLoadData(
        ...
        try {
            ...
            for ( const projectSearchId of projectSearchIds ) {
                ...
                chart_Bars_Tooltips.push( "<b>Search</b>: " + searchData.searchLabel__SearchShortName_OR_SearchId + "<br><b>PSM Estimated Error</b>: " + psm_Estimated_Error_Display );
            ...
            const chart_Layout = qcPage_StandardChartLayout({
                chartTitle, // + "<br><sup>Note: Data in plot are not filtered.</sup>",
    ...
    private _openChartInOverlay() {
        try {
            qcViewPage_MultipleSearches__Open_PSM_EstimatedError_OverlayContainer({
                params: {
