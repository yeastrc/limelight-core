/**
 * qcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Count vs/ Ion Injection Time - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: Ion Injection Time Distribution (MS2)"
 ...
 *
 */
export const open_ScanCount_VS_IonInjectionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer_Props, QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_OverlayContainer_Props) {
        super(props);
