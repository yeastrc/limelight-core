/**
 * qcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer.tsx
 *
 * QC Page Multiple Searches : Missed Cleavages - PSM Fraction - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer extends React.Component< QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props, QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props>, prevState: Readonly<QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_State>, snapshot?: any) {

        const show_NoData_Message_NewValue = this._computeNew__show_NoData_Message(this.props);

        this.setState( (state: QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_State, props: QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props ) : QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_State => {
     ...
     *
     */
    private _computeNew__show_NoData_Message(props: QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer_Props) : boolean {
            ...
            <div >
                <QcPage_ChartBorder >
                    ...
                    {( this.state.show_NoData_Message ) ? (
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_Plot.chartTitle } />
                    ) : (
