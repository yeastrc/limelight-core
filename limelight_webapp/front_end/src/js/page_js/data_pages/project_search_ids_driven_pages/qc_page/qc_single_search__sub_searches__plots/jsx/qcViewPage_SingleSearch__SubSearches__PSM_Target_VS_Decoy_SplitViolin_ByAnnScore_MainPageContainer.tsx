/**
 * qcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer.tsx
 *
...
import {QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props) {
        super(props);
