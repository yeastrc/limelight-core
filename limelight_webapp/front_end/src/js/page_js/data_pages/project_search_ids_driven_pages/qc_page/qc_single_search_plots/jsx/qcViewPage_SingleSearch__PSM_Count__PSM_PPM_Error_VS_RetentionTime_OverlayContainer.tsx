/**
 * qcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Count - PSM PPM Error vs Retention Time Statistics - Overlay Container
 *
 */
...
import {QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_StatisticsPlot";
...
const _Overlay_Title = "QC Plot: Error Vs Retention Time";
...
export enum QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_ChartTypeChoice {
 ...
 *
 */
export const open_PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_State > {

    //  bind to 'this' for passing as parameters

    private _chartTypeChoice = QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_ChartTypeChoice.SCATTER_PLOT

    /**
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_Props) {
        super(props);
                    ...
                    >
                        ...
                        <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                            ...
                            <div style={ { marginBottom: 3 } }>
                                ...
                                <span>
                                    <label>
                                        <input
                                            type="radio"
                                            name="QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_ChartTypeChoice"
                                            checked={
                                                this._chartTypeChoice ===
                                                QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_ChartTypeChoice.SCATTER_PLOT
                                            }
                                            onChange={ event => {
                                                window.setTimeout( () => {
                                                    this._chartTypeChoice =
                                ...
                                <span>
                                    <label>
                                        <input
                                            ...
                                            checked={
                                                this._chartTypeChoice ===
                                                QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_OverlayContainer_ChartTypeChoice.DENSITY_PLOT
                                            }
                                            onChange={ event => {
                                                window.setTimeout( () => {
                                                    this._chartTypeChoice =
                            ...
                            <div style={ { height: "100%" } }>
                                <QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_RetentionTime_StatisticsPlot
