/**
 * qcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer.tsx
 *
 ...
 *
 */
export const qc_SingleSearch__SubSearches__Open_PSM_ChargeState_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_OverlayContainer_Props) {
        super(props);
