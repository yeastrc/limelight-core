 ...
 *
 */
export class QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot
    extends React.Component< QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props, QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_State >
