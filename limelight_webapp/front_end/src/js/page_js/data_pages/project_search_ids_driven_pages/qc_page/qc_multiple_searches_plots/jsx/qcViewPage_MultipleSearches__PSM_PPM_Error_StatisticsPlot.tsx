/**
 * qcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot.tsx
 *
...
import {open_PSM_PPM_Error_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot extends React.Component< QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props, QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_State>, nextContext: any): boolean {

        if (
            nextProps.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId !== this.props.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot_State>, snapshot?: any) {
        try {
            //  ALWAYS remove check of state properties in 'componentDidUpdate'

            if (
                prevProps.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId !== this.props.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId
