/**
 * qcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot.tsx
 * 
 * QC Page Single Search : The count of proteins where each entry is the number of Distinct Peptides for a Single Protein Entry
 *
...
import {open_ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_Props, QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_StatisticsPlot_State>, snapshot?: any) {
        try {
    ...
    private async _populateChart() : Promise<void> {
        try {
            ...
            const peptideDistinct_Count_Map_Key_ProteinSequenceVersionId = new Map<number, number>();

            const proteinSequenceVersionId_DistinctValues = new Set<number>();  // Total protein count
            ...
            for ( const peptideDistinct_Entry of peptideDistinct_Array ) {
                ...
                for (const projectSearchId of projectSearchIds) {
                    ...
                    const proteinSequenceVersionIds_Processed_For_This_DistinctPeptide = new Set<number>();
                    ...
                    for (const dataPerReportedPeptideId_Map_Key_reportedPeptideId_MapEntry of dataPerReportedPeptideId_Map_Key_reportedPeptideId.entries()) {
                        ...
                        for (const proteinSequenceVersionId of proteinSequenceVersionIds) {
                            ...
                            if ( ! proteinSequenceVersionIds_Processed_For_This_DistinctPeptide.has( proteinSequenceVersionId ) ) {

                                proteinSequenceVersionId_DistinctValues.add(proteinSequenceVersionId); // for total protein count

                                proteinSequenceVersionIds_Processed_For_This_DistinctPeptide.add( proteinSequenceVersionId ) // So only add to this proteinSequenceVersionId once
            ...
            const proteinSequenceVersionId_DistinctValues_Count = proteinSequenceVersionId_DistinctValues.size;
            ...
            const colorEntry = "#" + qcViewPage__ComputeColorsForCategories.get_Color_AsHexString_By_Index( 0 );
            ...
            const chart_Data = [
                {
                    ...
                    marker: {
                        color: colorEntry  // If not populated, ALL the bars for this element in array 'chart_Data' are the same color
                    }
                }
            ];
    ...
    private _openChartInOverlay() {
        try {
            open_ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer({
                params: {
