/**
 * qcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Missed Cleavages - PSM Fraction - Overlay Container
 *
 */
 ...
 *
 */
export const qc_SingleSearch__SubSearches__Open_MissedCleavages_PSM_Fraction_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_OverlayContainer_Props) {
        super(props);
