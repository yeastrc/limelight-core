/**
 * qcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot.tsx
 *
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_State {
...
export class QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot extends React.Component< QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_Props, QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_State>, snapshot?: any) {
        try {
    ...
    private _populateChart_AfterLoadData(
        ...
        try {
            ...
            for (const searchSubGroup of searchSubGroups_DisplayOrder) {
                ...
                chart_Bars_Tooltips.push( "<b>Sub Search</b>: " + searchSubGroup.subgroupName_Display + "<br><b>Peptide Estimated Error</b>: " + distinctPeptide_Estimated_Error_Display );
    ...
    private _compute_Error_Single_SubSearch(
        ...
        const searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder = searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder_Map_Key_ProjectSearchId.get(projectSearchId);
        if ( ! searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder ) {
            throw Error("searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder_Map_Key_ProjectSearchId.get(projectSearchId); returned Nothing for projectSearchId: " + projectSearchId)
        }
            ...
            for ( const dataPerReportedPeptideId of dataPerReportedPeptideId_Map_Key_reportedPeptideId.values() ) {
                ...
                if ( dataPerReportedPeptideId.no_SubFiltering_On_PsmIds_For_ReportedPeptideId_within_ProjectSearchId ) {
                    ...
                    for ( const psmTblData of psmTblData_For_ReportedPeptideId.get_PsmTblData_Entries_IterableIterator() ) {
                        ...
                        const searchSubGroupId_For_PSM = searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder.get_subGroupId_For_PsmId(psmTblData.psmId);
                        if ( searchSubGroupId_For_PSM === undefined || searchSubGroupId_For_PSM === null ) {
                            throw Error("searchSubGroupId_ForPSM_ID__For_ReportedPeptideId_For_MainFilters_Holder.get_PsmTblData_For_PsmId(psmId); returned undefined or null for psmId: " + psmTblData.psmId)
                        }
    ...
    private _openChartInOverlay() {
        try {
            qcViewPage_SingleSearch__SubSearches__Open_Peptide_EstimatedError_StatisticsPlot_OverlayContainer({
                params: {
