/**
 * qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section.tsx
 *
 * QC Page SingleSearch__SubSearches - Section - PSM Level Statistics
 *
 */
...
import {QcViewPage_SingleSearch__SubSearches__PSMCount_VS_M_Z_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSMCount_VS_M_Z_MainPageContainer";
import {QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer";
import {QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSM_ChargeState_MainPageContainer";
import {QcViewPage_SingleSearch__SubSearches__PSMCount_VS_PeptideLength_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSMCount_VS_PeptideLength_MainPageContainer";

/**
 *
 */
export interface Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_State {
 ...
 *
 */
export class Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section extends React.Component< Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_Props, Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_Props>, nextState: Readonly<Qc_SingleSearch__SubSearches_PSM_Level_Statistics_Section_State>, nextContext: any): boolean {
                    ...
                    >
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" section--chart-block--single-chart-no-margin-bottom-container ">
                                ...
                                <QcViewPage_SingleSearch__SubSearches__PSMCount_VS_RetentionTime_MainPageContainer
                                ...
                                <QcViewPage_SingleSearch__SubSearches__PSMCount_VS_M_Z_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent }
                                />

                                <QcViewPage_SingleSearch__SubSearches__PSM_ChargeState_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent }
                                />

                                <QcViewPage_SingleSearch__SubSearches__PSMCount_VS_PeptideLength_MainPageContainer
                                    qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                    qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent }
                                />
