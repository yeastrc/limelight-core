/**
 * qcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_DistinctPeptide_Counts_Plot.tsx
 *
 * QC Page Multiple Searches : Summary Counts - Distinct Peptide
 *
 */
...
import {open_SummaryCounts_DistinctPeptide_Counts_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot
    extends React.Component< QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_Props, QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_Props>, nextState: Readonly<QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_Props>, prevState: Readonly<QcViewPage_MultipleSearches__SummaryCounts_DistinctPeptide_Counts_Plot_State>, snapshot?: any) {
        try {
    ...
    private _populateChart() {
        ...
        const distinctPeptideCount_Map_Key_ProjectSearchId : Map<number,number> = new Map();
        ...
        for ( const peptideDistinct_Entry of peptideDistinct_Array ) {
            ...
            for (const projectSearchId of projectSearchIds) {
                ...
                const distinctPeptideCount_For_ProjectSearchId = distinctPeptideCount_Map_Key_ProjectSearchId.get(projectSearchId);
                if ( distinctPeptideCount_For_ProjectSearchId ) {
                    distinctPeptideCount_Map_Key_ProjectSearchId.set(projectSearchId, distinctPeptideCount_For_ProjectSearchId + 1);
                } else {
                    distinctPeptideCount_Map_Key_ProjectSearchId.set(projectSearchId, 1);
                }
            }
        }
...

        {
            ...
            for (const projectSearchId of projectSearchIds) {
                ...
                let distinctPeptideCountForSearch = distinctPeptideCount_Map_Key_ProjectSearchId.get( projectSearchId );
                if ( ! distinctPeptideCountForSearch ) {
                    distinctPeptideCountForSearch = 0;
                }

                chart_X.push(x_Label);
                chart_Y.push(distinctPeptideCountForSearch);

                chart_Bars_labels.push(distinctPeptideCountForSearch.toLocaleString());
                chart_Bars_Tooltips.push( "<b>Search</b>: " + searchData.searchLabel__SearchShortName_OR_SearchId + "<br><b>Distinct Peptide Count</b>: " + distinctPeptideCountForSearch.toLocaleString());
