/**
 * qcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer.tsx
 *
 * QC Page Multiple Searches : PSM Count vs M/Z Statistics - Main Page Container
 *
 */

import React from "react";
import {QcViewPage_CommonData_To_AllComponents_From_MainComponent} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_page_main/jsx/qcViewPage_DisplayData__Main_Component";
import {QcViewPage_MultipleSearches__PSMCount_VS_M_Z_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__PSMCount_VS_M_Z_StatisticsPlot";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer extends React.Component< QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props, QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props>, prevState: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_State>, snapshot?: any) {

        const show_NoData_Message_NewValue = this._computeNew__show_NoData_Message(this.props);

        this.setState( (state: QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_State, props: QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props ) : QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_State => {
     ...
     *
     */
    private _computeNew__show_NoData_Message(props: QcViewPage_MultipleSearches__PSMCount_VS_M_Z_MainPageContainer_Props) : boolean {
            ...
            <div >
                ...
                <QcPage_ChartBorder >
                    ...
                    {( this.state.show_NoData_Message ) ? (
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_MultipleSearches__PSMCount_VS_M_Z_StatisticsPlot.chartTitle } />
                    ) : (
                        <QcViewPage_MultipleSearches__PSMCount_VS_M_Z_StatisticsPlot
