/**
 * qcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Count - PSM PPM Error vs M/Z Statistics - Overlay Container
 *
 */
 ...
 *
 */
export const open_PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_Count__PSM_PPM_Error_VS_M_Z_OverlayContainer_Props) {
        super(props);
