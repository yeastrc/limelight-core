/**
 * qcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Count - Peptide Length vs Retention Time Statistics - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: PSM Count vs/ Peptide Length"
 ...
 *
 */
export const open_PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer_Props, QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSMCount__PeptideLength_VS_RetentionTime_OverlayContainer_Props) {
        super(props);
