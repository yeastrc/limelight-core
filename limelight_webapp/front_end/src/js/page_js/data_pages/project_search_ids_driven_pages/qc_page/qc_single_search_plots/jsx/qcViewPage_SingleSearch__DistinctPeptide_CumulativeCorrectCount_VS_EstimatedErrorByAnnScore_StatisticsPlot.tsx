 ...
 *
 * QC Page Single Search : Distinct Peptide Cumulative Error vs Peptide Rank by Best PSM Annotation Score Statistics
 *
 */
...
import {open_DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props, QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
            ...
            try {
                ...
                for ( let annotationTypeId_Array_Index = 0; annotationTypeId_Array_Index < this.props.annotationTypeId_Array.length; annotationTypeId_Array_Index++ ) {
                    ...
                    for (const peptideData_Entry of peptideData_Entries_ForProcessing) {
                        ...
                        for (const psmTblData_Entry of peptideData_Entry.psmTblData_Entries ) {
    ...
    private _openChartInOverlay() {
        try {
            open_DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer({
                params: {
