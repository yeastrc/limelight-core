/**
 * qcPage_DataFromServer_MultipleSearches_SpectralStorage_NO_Peaks_Data_LoadIfNeeded.ts
 *
 * QC Page - Data From Server - Multiple Searches - Spectral Storage Data - NO Scan Peaks - Load if Needed
 *
 */
 ...
 *
 */
export class QcPage_DataFromServer_MultipleSearches_SpectralStorage_NO_Peaks_Data_LoadIfNeeded {

    private _promiseInProgress : Promise<void>
    
    private _singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId : Map<number,QcPage_DataFromServer_SingleSearch_SpectralStorage_NO_Peaks_Data_LoadIfNeeded> = new Map();

    /**
     * @returns null if no promise needed
     */
    multipleSearches_SpectralStorage_NO_Peaks_Data_LoadIfNeeded(
        {
        ...
        for ( const projectSearchId of projectSearchIds ) {
            ...
            if ( ! singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId ) {
                singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId = new QcPage_DataFromServer_SingleSearch_SpectralStorage_NO_Peaks_Data_LoadIfNeeded();
            ...
            const promise = singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId.singleSearch_SpectralStorage_NO_Peaks_Data_LoadIfNeeded({
