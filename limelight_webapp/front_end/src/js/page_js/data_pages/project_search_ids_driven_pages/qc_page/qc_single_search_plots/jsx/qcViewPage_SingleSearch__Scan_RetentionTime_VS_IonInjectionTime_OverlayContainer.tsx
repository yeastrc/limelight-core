/**
 * qcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_OverlayContainer.tsx
 *
 * QC Page Single Search : Scan (MS2) Retention Time vs/ Ion Injection Time - Overlay Container
 *
 */
...
import {QcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_StatisticsPlot";
...
const _Overlay_Title = "QC Plot: Retention Time vs/ MS2 Ion Injection Time"
 ...
 *
 */
export const open_PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_RetentionTime_VS_IonInjectionTime_OverlayContainer_Props) {
        super(props);
                    ...
                    >
                        ...
                        <div style={ { height: "100%" } }>
                            <QcViewPage_SingleSearch__Scan_RetentionTime_VS_IonInjectionTime_StatisticsPlot
                                ...
                                searchScanFileId_Selection={ this.props.params.searchScanFileId_Selection }
