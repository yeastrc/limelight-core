/**
 * qcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer.tsx
 *
 * QC Page Single Search : Charge State Statistics - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: Charge State Statistics"
...
export const open_PSM_ChargeState_OverlayContainer = function (
    {
        ...
        params: QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_ChargeState_OverlayContainer_Props) {
        super(props);
