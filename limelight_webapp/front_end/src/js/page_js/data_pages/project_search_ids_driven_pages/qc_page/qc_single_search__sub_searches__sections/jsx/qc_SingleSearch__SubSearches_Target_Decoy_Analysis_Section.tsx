/**
 * qc_SingleSearch__SubSearches__SubSearches_Target_Decoy_Analysis_Section.tsx
 *
 * QC Page SingleSearch__SubSearches__SubSearches - Section - Error Estimation
 *
 */
...
import {QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_MainPageContainer";

/**
 *
 */
export interface Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_State {
 ...
 *
 */
export class Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section extends React.Component< Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_Props, Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_Props>, nextState: Readonly<Qc_SingleSearch__SubSearches_Target_Decoy_Analysis_Section_State>, nextContext: any): boolean {
                        ...
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" chart-container-multiple-on-same-row-block ">
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer
