/**
 * qcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer.tsx
 *
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer_Props {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot_MainPageContainer_Props) {
        super(props);
        ...
        return (
            <div>
                ...
                { this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent.propsValue.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject.get_psm_Exclude_IndependentDecoy_PSMs() ? (
                    ...
                    <QcPage_ChartBorder>
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_SingleSearch__SubSearches__Peptide_EstimatedError_StatisticsPlot.chartTitle } />
                    </QcPage_ChartBorder>
