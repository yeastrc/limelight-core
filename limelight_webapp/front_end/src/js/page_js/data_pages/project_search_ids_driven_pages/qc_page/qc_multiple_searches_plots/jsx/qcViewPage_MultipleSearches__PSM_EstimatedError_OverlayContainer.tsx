/**
 * qcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : PSM Estimated Error - Overlay Container
 *
 */
 ...
 *
 */
export const qcViewPage_MultipleSearches__Open_PSM_EstimatedError_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer_Props, QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_EstimatedError_OverlayContainer_Props) {
        super(props);
