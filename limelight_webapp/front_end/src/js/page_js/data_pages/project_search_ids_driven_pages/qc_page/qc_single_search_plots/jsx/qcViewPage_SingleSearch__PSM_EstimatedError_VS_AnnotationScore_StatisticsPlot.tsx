 ...
 *
 * QC Page Single Search : PSM Estimated Error vs PSM Annotation Score Statistics
 *
 */
...
import {open_PSM_EstimatedError_VS_AnnotationScore_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_StatisticsPlot extends React.Component< QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_Props, QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__PSM_EstimatedError__VS_AnnotationScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
        ...
        promisesAll.then( noValue => {
            try {
                ...
                for (const psmTblData_Entry of psmTblData_Entries_ForProcessing) {
                    ...
                    const psmFilterableAnnotationData_For_annotationTypeId_Score_X = psmFilterableAnnotationData_Entry.get_PsmFilterableAnnotationData_For_AnnotationTypeId( this.props.annotationTypeId_Score_X );
                    if ( ! psmFilterableAnnotationData_For_annotationTypeId_Score_X ) {
                        const msg = "psmFilterableAnnotationData_Entry.get_PsmFilterableAnnotationData_For_AnnotationTypeId( this.props.annotationTypeId_Score_X ); returned nothing. this.props.annotationTypeId_Score_X: " + this.props.annotationTypeId_Score_X;
                        console.warn(msg);
                        throw Error(msg);
                ...
                for ( const internal_AnnotationScore_Psm_Entries of internal_AnnotationScore_Psm_Entries_Array ) {
                    ...
                    for ( let counter = 0; counter < psmTblData_Entry_Array_Length; counter++ ) {
                        chart_X.push( internal_AnnotationScore_Psm_Entries.annotationScore );
                ...
                const chartTitle = "PSM Estimated Error vs PSM Annotation Score" + "<br><sup>Note: Data in plot are not filtered.</sup>";
    ...
    private _openChartInOverlay() {
        try {
            open_PSM_EstimatedError_VS_AnnotationScore_OverlayContainer({
                params: {
