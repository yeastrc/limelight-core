/**
 * qc_SingleSearch_ErrorEstimation_Section.tsx
 *
...
import {QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__PSM_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer";
import {QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_MainPageContainer";
import {QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer";

/**
 *
 */
export interface Qc_SingleSearch_ErrorEstimation_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch_ErrorEstimation_Section_State {
 ...
 *
 */
export class Qc_SingleSearch_ErrorEstimation_Section extends React.Component< Qc_SingleSearch_ErrorEstimation_Section_Props, Qc_SingleSearch_ErrorEstimation_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch_ErrorEstimation_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch_ErrorEstimation_Section_Props>, nextState: Readonly<Qc_SingleSearch_ErrorEstimation_Section_State>, nextContext: any): boolean {
                        ...
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" chart-container-multiple-on-same-row-block ">
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__PSM_EstimatedError_VS_AnnotationScore_MainPageContainer
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                        annotationTypeId_Score_X={ this.state.annotationTypeId_Score_X }
                                ...
                                {/* NOT Currently Shown
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__PSM_CumulativeErrorCount_VS_PSM_RankByAnnScore_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                ...
                                */}
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__PSM_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                        annotationTypeId_Score_1={ this.state.annotationTypeId_Score_X }
                                        annotationTypeId_Score_2={ this.state.annotationTypeId_Score_Y }
                            ...
                            <div className=" chart-container-multiple-on-same-row-block ">
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__DistinctPeptide_EstimatedError_VS_AnnotationScore_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                        annotationTypeId_Score_X={ this.state.annotationTypeId_Score_X }
                                    />
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                        annotationTypeId_Score_X={ this.state.annotationTypeId_Score_X }
                                        annotationTypeId_Score_Y={ this.state.annotationTypeId_Score_Y }
                                ...
                                <div className=" chart-container-multiple-on-same-row ">
                                    <QcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer
                                        qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent={ this.props.qcViewPage_CommonData_To_All_SingleSearch_Components_From_MainSingleSearchComponent }
                                        annotationTypeId_Score_1={ this.state.annotationTypeId_Score_X }
                                        annotationTypeId_Score_2={ this.state.annotationTypeId_Score_Y }
