/**
 * qcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer.tsx
 *
 * QC Page Single Search : PSM PPM Error Statistics - Main Page Container
 *
 */
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer_Props, QcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_PPM_Error_MainPageContainer_Props) {
        super(props);
