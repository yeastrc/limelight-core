 ...
 *
 */
export class QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot extends React.Component< QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props, QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_State > {
    ...
    private _populateChart() {
        ...
        for ( const projectSearchId of projectSearchIds ) {
            ...
            const tooltip = distinctPeptide_Count_Containing_MissedCleavage.toLocaleString() + " Distinct Peptide Missed Cleavage Count / " +
