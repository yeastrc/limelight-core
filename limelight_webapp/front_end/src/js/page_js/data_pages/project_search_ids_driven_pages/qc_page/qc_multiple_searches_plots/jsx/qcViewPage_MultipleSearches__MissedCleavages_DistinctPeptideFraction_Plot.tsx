/**
 * qcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot.tsx
 *
 * QC Page Multiple Searches : Missed Cleavages - Distinct Peptide Fraction - Multiple computed values
 *
 */
...
import {open_MissedCleavages_DistinctPeptideFraction_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot
    extends React.Component< QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props, QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_Props>, nextState: Readonly<QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_Plot_State>, nextContext: any): boolean {
    ...
    private _populateChart() {
        ...
        for ( const projectSearchId of projectSearchIds ) {
            ...
            const tooltip =
                "<b>Search</b>: " + searchData.searchLabel__SearchShortName_OR_SearchId + "<br>" +
    ...
    private _openChartInOverlay() {
        try {
            open_MissedCleavages_DistinctPeptideFraction_OverlayContainer({
                params: {
