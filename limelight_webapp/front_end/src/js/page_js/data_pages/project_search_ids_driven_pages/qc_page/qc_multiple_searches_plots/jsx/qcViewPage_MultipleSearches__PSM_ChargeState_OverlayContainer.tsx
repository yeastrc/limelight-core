/**
 * qcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : Charge State Statistics - Overlay Container
 *
 */
 ...
 *
 */
export const open_PSM_ChargeState_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer_Props, QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_ChargeState_OverlayContainer_Props) {
        super(props);
