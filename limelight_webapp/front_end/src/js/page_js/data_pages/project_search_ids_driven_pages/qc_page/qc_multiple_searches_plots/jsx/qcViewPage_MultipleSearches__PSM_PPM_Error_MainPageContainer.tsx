/**
 * qcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer.tsx
 *
...
import {QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer extends React.Component< QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props, QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props>, prevState: Readonly<QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_State>, snapshot?: any) {

        const show_NoData_Message_NewValue = this._computeNew__show_NoData_Message(this.props);

        this.setState( (state: QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_State, props: QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props ) : QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_State => {
     ...
     *
     */
    private _computeNew__show_NoData_Message(props: QcViewPage_MultipleSearches__PSM_PPM_Error_MainPageContainer_Props) : boolean {
            ...
            <div >
                ...
                <QcPage_ChartBorder >
                    ...
                    {( this.state.show_NoData_Message ) ? (
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot.chartTitle } />
                    ) : (
                        <QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot
                            psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId={ this.props.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId }
