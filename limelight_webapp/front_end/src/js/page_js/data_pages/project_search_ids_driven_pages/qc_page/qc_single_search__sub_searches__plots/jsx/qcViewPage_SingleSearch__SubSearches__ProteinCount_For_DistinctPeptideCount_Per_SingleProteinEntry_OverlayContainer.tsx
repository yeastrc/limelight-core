/**
 * qcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Charge State Statistics - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: PSM Charge State Statistics"
 ...
 *
 */
export const qc_SingleSearch__SubSearches__Open_ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props) {
        super(props);
