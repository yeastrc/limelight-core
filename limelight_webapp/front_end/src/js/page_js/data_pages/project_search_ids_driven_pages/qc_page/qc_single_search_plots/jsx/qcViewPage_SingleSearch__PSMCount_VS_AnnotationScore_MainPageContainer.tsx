/**
 * qcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer.tsx
 *
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer_Props, QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSMCount_VS_AnnotationScore_MainPageContainer_Props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div >
                <div >
                    <h2>
                        PSM Count vs PSM Annotation Score
                    </h2>
                </div>
                <QcPage_ChartBorder>
                    <QcViewPage_SingleSearch__PSMCount__VS_AnnotationScore_StatisticsPlot
