/**
 * qcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : Missed Cleavages - Distinct Peptide Fraction - Overlay Container
 *
 */
 ...
 *
 */
export const open_MissedCleavages_DistinctPeptideFraction_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer_Props, QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_OverlayContainer_Props) {
        super(props);
