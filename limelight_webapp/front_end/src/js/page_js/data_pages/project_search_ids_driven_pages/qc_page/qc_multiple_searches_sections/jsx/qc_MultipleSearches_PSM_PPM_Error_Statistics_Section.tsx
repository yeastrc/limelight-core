...
export class Qc_MultipleSearches_PSM_PPM_Error_Statistics_Section extends React.Component< Qc_MultipleSearches_PSM_PPM_Error_Statistics_Section_Props, Qc_MultipleSearches_PSM_PPM_Error_Statistics_Section_State > {
    ...
    constructor(props: Qc_MultipleSearches_PSM_PPM_Error_Statistics_Section_Props) {
        ...
        for ( const projectSearchId of props.qcViewPage_CommonData_To_AllComponents_From_MainComponent.projectSearchIds) {
            ...
            const qcPage_Flags_SingleSearch = props.qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent.qcPage_Flags_MultipleSearches.get_QcPage_Flags_SingleSearch_ForProjectSearchId(projectSearchId);
            ...
            const qcPage_Searches_Info_SingleSearch = props.qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent.qcPage_Searches_Info_MultipleSearches.get_QcPage_Searches_Info_SingleSearch_ForProjectSearchId(projectSearchId);
