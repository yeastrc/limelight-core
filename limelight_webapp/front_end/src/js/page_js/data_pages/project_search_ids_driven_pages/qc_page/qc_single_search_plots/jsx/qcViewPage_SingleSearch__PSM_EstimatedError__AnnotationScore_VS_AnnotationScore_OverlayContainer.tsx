/**
 * qcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Estimated Error - PSM Annotation Score vs PSM Annotation Score Statistics - Overlay Container
 *
 */
...
import {QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot";
 ...
 *
 */
export const open_PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer_Props) {
        super(props);
                        ...
                        { ( this.state.loadingData ) ? (
                            ...
                            <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                                ...
                                <div style={ { height: "100%" } }>
                                    <QcViewPage_SingleSearch__PSM_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot
