/**
 * qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer.tsx
 *
 * QC Page Single Search : PSM Target VS Decoy Histogram Rank by Annotation Score Statistics - Main Page Container
 *
 */
...
import {QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot";
import {QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_OverlayContainer";

/**
 *
 */
export interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props, QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_Target_VS_Decoy_Single_SplitViolin_ByAnnScore_StatisticsPlot_MainPageContainer_Props) {
        super(props);
