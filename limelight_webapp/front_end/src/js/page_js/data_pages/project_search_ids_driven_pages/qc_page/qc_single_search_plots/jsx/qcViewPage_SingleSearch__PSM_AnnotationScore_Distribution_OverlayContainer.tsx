/**
 * qcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer.tsx
 *
 * QC Page Single Search : PSM Annotation Score Distribution Statistics - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: PSM Score Distribution"
 ...
 *
 */
export enum QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__TransformScoreChoice {
    NONE = "NONE",
    LOG_10 = "LOG_10",
 ...
 *
 */
export const open_PSM_AnnotationScore_Distribution_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer extends React.Component< QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_Props, QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_Props) {
        super(props);
    ...
    private _score_Contains_NegativeValues_Callback( score_Contains_NegativeValues: boolean ) {
        ...
        if ( this.state.transform_Score !== QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__TransformScoreChoice.NONE ) {
            this.setState({
                                                ...
                                                <React.Fragment>
                                                    <span>
                                                        <label>
                                                            <input
                                                                type="radio"
                                                                name="QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer_State__TransformScoreChoice"
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__TransformScoreChoice.NONE
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__TransformScoreChoice.LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__PSM_AnnotationScore_Distribution_OverlayContainer__TransformScoreChoice.NEGATIVE_LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
