 ...
 *
 */
export class QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_Plot
    extends React.Component< QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_Plot_Props, QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_Plot_State >
    ...
    private async _populateChart() {
...

        {
            ...
            for (const projectSearchId of projectSearchIds) {
                ...
                chart_Bars_Tooltips.push( "<b>Search</b>: " + searchData.searchLabel__SearchShortName_OR_SearchId + "<br><b>Distinct Scan Count</b>: " + distinct_ScanCount_TotalForSearch.toLocaleString());
