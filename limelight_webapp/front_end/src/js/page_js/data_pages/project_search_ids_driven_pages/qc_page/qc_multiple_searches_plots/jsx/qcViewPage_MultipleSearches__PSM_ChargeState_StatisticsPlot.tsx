 ...
 *
 */
export class QcViewPage_MultipleSearches__PSM_ChargeState_StatisticsPlot
    extends React.Component< QcViewPage_MultipleSearches__PSM_ChargeState_StatisticsPlot_Props, QcViewPage_MultipleSearches__PSM_ChargeState_StatisticsPlot_State >
            ...
            try {
                ...
                for (const projectSearchId of projectSearchIds) {
                    ...
                    for (let charge = charge_Min_AcrossAllSearches; charge <= charge_Max_AcrossAllSearches; charge++) {
                        ...
                        const tooltip =
                            searchLabelTitle_InTooltip + ": " + searchData.searchLabel__SearchShortName_OR_SearchId +
                            "<br>Charge: +" + charge +
