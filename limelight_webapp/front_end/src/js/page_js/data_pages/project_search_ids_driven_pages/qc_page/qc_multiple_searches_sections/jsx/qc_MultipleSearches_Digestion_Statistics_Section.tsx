/**
 * qc_MultipleSearches_Digestion_Statistics_Section.tsx
 *
 * QC Page Multiple Searches - Section - Digestion Statistics
 *
 */
...
import {QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_MainPageContainer";
import {
...
import {QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer";
import {QcViewPage_MultipleSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer";
 ...
 *
 */
export interface Qc_MultipleSearches_Digestion_Statistics_Section_Props {
 ...
 *
 */
interface Qc_MultipleSearches_Digestion_Statistics_Section_State {
 ...
 *
 */
export class Qc_MultipleSearches_Digestion_Statistics_Section extends React.Component< Qc_MultipleSearches_Digestion_Statistics_Section_Props, Qc_MultipleSearches_Digestion_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_MultipleSearches_Digestion_Statistics_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_MultipleSearches_Digestion_Statistics_Section_Props>, nextState: Readonly<Qc_MultipleSearches_Digestion_Statistics_Section_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<Qc_MultipleSearches_Digestion_Statistics_Section_Props>, prevState: Readonly<Qc_MultipleSearches_Digestion_Statistics_Section_State>, snapshot?: any) {
    ...
    private _sectionExpanded_Toggle() {
        ...
        if ( this._sectionExpanded && ( ! this._sectionEverExpanded ) ) {
            ...
            window.setTimeout( async () =>{ try {
                    ...
                    await this._call__compute_MissedCleavages_InitialData_OR__compute_MissedCleavages_MainData__Handle_Empty_peptideDistinct_Array();  // Ignore returned Promise<void>
                ...
                if ( peptideDistinct_Array.length === 0 ) {
                    ...
                    this.setState( (prevState, props) => {
                        if ( prevState.compute_MissedCleavages_Data_Result_Root !== null ) {
                            ...
                            const newState: Qc_MultipleSearches_Digestion_Statistics_Section_State = { compute_MissedCleavages_Data_Result_Root: null }
                            return newState
                        }
                        return null;
                    });
                                ...
                                { ( this.state.show_LoadingData_Message || ( ! this.state.compute_MissedCleavages_Data_Result_Root ) ) ? (
                                    ...
                                    <React.Fragment>
                                        <div className=" chart-container-multiple-on-same-row ">
                                            <QcViewPage_MultipleSearches__MissedCleavages_DistinctPeptideFraction_MainPageContainer
                                                qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                        ...
                                        <div className=" chart-container-multiple-on-same-row ">
                                            <QcViewPage_MultipleSearches__MissedCleavages_PSM_Fraction_MainPageContainer
                                                qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                                qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent={ this.props.qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent }
                                                compute_MissedCleavages_Data_Result_Root={ this.state.compute_MissedCleavages_Data_Result_Root }
                                            />
                                        ...
                                        <div className=" chart-container-multiple-on-same-row ">
                                            <QcViewPage_MultipleSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer
                                                qcViewPage_CommonData_To_AllComponents_From_MainComponent={ this.props.qcViewPage_CommonData_To_AllComponents_From_MainComponent }
                                                qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent={ this.props.qcViewPage_CommonData_To_All_MultipleSearches_Components_From_MainMultipleSearchesComponent }
                                                compute_MissedCleavages_Data_Result_Root={ this.state.compute_MissedCleavages_Data_Result_Root }
                                            />
