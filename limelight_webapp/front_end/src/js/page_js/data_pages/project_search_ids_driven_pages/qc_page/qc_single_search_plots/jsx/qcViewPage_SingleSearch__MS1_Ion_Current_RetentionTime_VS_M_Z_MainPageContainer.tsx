/**
 * qcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer.tsx
 *
 * QC Page Single Search : MS1 Ion Current - Retention Time vs M/Z Statistics - Main Page Container
 *
 */
...
} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_StatisticsPlot";
 ...
 *
 */
export interface QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer extends React.Component< QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props, QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props>, nextState: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props>, prevState: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
                ...
                this.setState((prevState: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State>, props: Readonly<QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_Props>) : QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_MainPageContainer_State =>  {
                ...
                { ( this.state.no_MS1_Data ) ? (
                    ...
                    <React.Fragment>
                        ...
                        <div >
                            ...
                            <QcPage_ChartBorder
                                width_OverrideStandard={ QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_StatisticsPlot._MainPage_Chart_Width }
                                height_OverrideStandard={ QcViewPage_SingleSearch__MS1_Ion_Current_RetentionTime_VS_M_Z_StatisticsPlot._MainPage_Chart_Height }
                            >
