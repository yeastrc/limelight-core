 ...
 *
 */
export class QcViewPage_SingleSearch__PSM_Target_Yaxis_VS_Decoy_Xaxis_ByAnnScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__PSM_Target_Yaxis_VS_Decoy_Xaxis_ByAnnScore_StatisticsPlot_Props, QcViewPage_SingleSearch__PSM_Target_Yaxis_VS_Decoy_Xaxis_ByAnnScore_StatisticsPlot_State >
    ...
    private _populateChart() {
        ...
        promisesAll.then( values => {
            try {
                ...
                let axisLabel__AnnotationTypeName = annotationType_Name_Score;
