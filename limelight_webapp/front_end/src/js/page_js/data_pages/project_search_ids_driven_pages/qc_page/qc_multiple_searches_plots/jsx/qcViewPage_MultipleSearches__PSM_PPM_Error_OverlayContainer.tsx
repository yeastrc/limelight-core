/**
 * qcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer.tsx
 *
...
export const open_PSM_PPM_Error_OverlayContainer = function (
    {
        ...
        params: QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer_Props, QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSM_PPM_Error_OverlayContainer_Props) {
        super(props);
                    ...
                    <div style={ { height: "100%", display: "grid", gridTemplateRows: "min-content auto" } } >
                            ...
                            <div style={ { height: "100%" } }>
                                <QcViewPage_MultipleSearches__PSM_PPM_Error_StatisticsPlot
                                    psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId={ this.props.params.psm_PPM_Error_List_Filtered_Map_Key_ProjectSearchId }
