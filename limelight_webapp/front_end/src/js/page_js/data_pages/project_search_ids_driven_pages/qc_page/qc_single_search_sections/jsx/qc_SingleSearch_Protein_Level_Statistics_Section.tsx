/**
 * qc_SingleSearch_Protein_Level_Statistics_Section.tsx
 *
 * QC Page Single Search - Section - Protein Level Statistics
 *
 */
...
import {QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_MainPageContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_MainPageContainer";


/**
 *
 */
export interface Qc_SingleSearch_Protein_Level_Statistics_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch_Protein_Level_Statistics_Section_State {
 ...
 *
 */
export class Qc_SingleSearch_Protein_Level_Statistics_Section extends React.Component< Qc_SingleSearch_Protein_Level_Statistics_Section_Props, Qc_SingleSearch_Protein_Level_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch_Protein_Level_Statistics_Section_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch_Protein_Level_Statistics_Section_Props>, nextState: Readonly<Qc_SingleSearch_Protein_Level_Statistics_Section_State>, nextContext: any): boolean {
                    ...
                    <div className=" section-content-block " style={ { display: ( ! this.state.sectionExpanded ) ? ( "none" ) : null } }>
                        ...
                        <div className=" section--chart-container-block ">
                            ...
                            <div className=" section--chart-block--single-chart-no-margin-bottom-container ">
                                ...
                                <QcViewPage_SingleSearch__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_MainPageContainer
