/**
 * qcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : Summary Counts - Distinct Scan - Overlay Container
 *
 */
...
export const open_SummaryCounts_Distinct_Scan_Counts_OverlayContainer = function (
    {
        ...
        params: QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props, QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props) {
        super(props);
