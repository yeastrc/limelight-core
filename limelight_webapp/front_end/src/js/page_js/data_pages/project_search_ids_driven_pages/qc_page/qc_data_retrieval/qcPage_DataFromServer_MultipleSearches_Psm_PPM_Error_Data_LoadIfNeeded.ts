/**
 * qcPage_DataFromServer_MultipleSearches_Psm_PPM_Error_Data_LoadIfNeeded.ts
 *
 * QC Page - Data From Server - Multiple Searches - Psm PPM Error Data - Load if Needed
 *
 */
 ...
 *
 */
export class QcPage_DataFromServer_MultipleSearches_Psm_PPM_Error_Data_LoadIfNeeded {

    private _promiseInProgress : Promise<void>

    private _singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId : Map<number,QcPage_DataFromServer_SingleSearch_Psm_PPM_Error_Data_LoadIfNeeded> = new Map();

    /**
     * @returns null if no promise needed
     */
    multipleSearches_Psm_PPM_Error_Data_LoadIfNeeded(
        {
            retrievalParams,
        ...
        for ( const projectSearchId of retrievalParams.projectSearchIds ) {
            ...
            if ( ! singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId ) {
                singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId = new QcPage_DataFromServer_SingleSearch_Psm_PPM_Error_Data_LoadIfNeeded();
            ...
            const promise = singleSearch_LoadIfNeeded_Map_Key_ProjectSearchId.singleSearch_Psm_PPM_Error_Data_LoadIfNeeded({
