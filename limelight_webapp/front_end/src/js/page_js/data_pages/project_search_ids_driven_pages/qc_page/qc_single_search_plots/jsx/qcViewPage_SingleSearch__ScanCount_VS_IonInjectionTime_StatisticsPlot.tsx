/**
 * qcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot.tsx
 *
 * QC Page Single Search : PSM Count vs Ion Injection Time Statistics
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_Props, QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__ScanCount_VS_IonInjectionTime_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
    ...
    private _populateChart() {
        ...
        const get_ScanData_ALL_For_Single_SearchScanFileId_NO_Peaks_Data_ForSearchScanFileId_Result =
            ...
            get_ScanData_ALL_For_Single_SearchScanFileId_NO_Peaks_Data_ForSearchScanFileId({ searchScanFileId: this.props.searchScanFileId_Selected })
            ...
            try {
                ...
                for ( const dataForSingleScanNumberEntry of scanData_Single_SearchScanFileId_NO_Peaks_Data_Holder.scanData_NO_Peaks_Data_Holder.scanData.scansArray ) {
                    ...
                    if ( dataForSingleScanNumberEntry.level === 2 ) {
                        ...
                        chart_X.push( ionInjectionTime_InMilliseconds );
                    }
                }
                ...
                const chart_Data: Plotly.Data[] = [
                    {
                        ...
                        hovertemplate:  //  Added '<extra></extra>' to remove secondary box with trace name
                            '<b>Frequency</b>: %{y}' +
                            '<br><b>Ion injection time (ms)</b>: %{x}<extra></extra>',
                        marker: {
