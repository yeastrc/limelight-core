/**
 * qcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Summary Counts - Distinct Scan - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: Summary Counts - Distinct Scan"
 ...
 *
 */
export const open_SummaryCounts_Distinct_Scan_Counts_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__SummaryCounts_Distinct_Scan_Counts_OverlayContainer_Props) {
        super(props);
