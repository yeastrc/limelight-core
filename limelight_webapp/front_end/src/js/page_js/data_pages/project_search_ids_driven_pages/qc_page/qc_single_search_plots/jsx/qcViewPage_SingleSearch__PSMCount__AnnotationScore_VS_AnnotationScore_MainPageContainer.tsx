/**
 * qcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer.tsx
 *
 * QC Page Single Search : PSM Count - PSM Annotation Score vs PSM Annotation Score Statistics - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer extends React.Component< QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer_Props, QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSMCount__AnnotationScore_VS_AnnotationScore_MainPageContainer_Props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div >
                <div >
                    <h2>
                        PSM Annotation Score vs PSM Annotation Score
                    </h2>
                </div>
                <QcPage_ChartBorder>
