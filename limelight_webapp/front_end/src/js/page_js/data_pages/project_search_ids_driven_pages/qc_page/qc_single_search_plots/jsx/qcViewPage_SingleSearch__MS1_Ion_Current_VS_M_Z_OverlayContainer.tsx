/**
 * qcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer.tsx
 *
 * QC Page Single Search : MS1 Ion Current vs M/Z Statistics - Overlay Container
 *
 */
 ...
 *
 */
export const open_MS1_Ion_Current_VS_M_Z_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer extends React.Component< QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer_Props, QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__MS1_Ion_Current_VS_M_Z_OverlayContainer_Props) {
        super(props);
