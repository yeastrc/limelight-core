/**
 * qcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer.tsx
 *
 ...
 *
 */
export const qcViewPage_SingleSearch__SubSearches__Open_PSM_EstimatedError_StatisticsPlot_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSM_EstimatedError_StatisticsPlot_OverlayContainer_Props) {
        super(props);
