/**
 * qcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Summary Counts - Overlay Container
 *
 */
...
export const open_SummaryCounts_PSM_Counts_OverlayContainer = function (
    {
        ...
        params: QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__SummaryCounts_PSM_Counts_OverlayContainer_Props) {
        super(props);
