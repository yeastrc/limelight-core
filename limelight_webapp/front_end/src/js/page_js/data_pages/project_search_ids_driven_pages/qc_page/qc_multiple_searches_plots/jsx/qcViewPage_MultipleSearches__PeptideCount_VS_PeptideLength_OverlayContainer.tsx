/**
 * qcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : Peptide Count vs Peptide Length Statistics - Overlay Container
 *
 */
 ...
 *
 */
export const open_PeptideCount_VS_PeptideLength_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer_Props, QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PeptideCount_VS_PeptideLength_OverlayContainer_Props) {
        super(props);
