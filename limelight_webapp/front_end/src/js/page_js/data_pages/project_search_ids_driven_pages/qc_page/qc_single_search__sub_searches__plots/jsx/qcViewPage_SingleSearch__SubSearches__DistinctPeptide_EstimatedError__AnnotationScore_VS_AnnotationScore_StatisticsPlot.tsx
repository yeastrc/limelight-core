/**
 * qcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot.tsx
 *
 * QC Page Single Search: Sub Groups : Distinct Peptide Estimated Error vs Best PSM Annotation Score Statistics
 *
 */
...
import {qcViewPage_SingleSearch__SubSearches__Open_DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props, QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
    ...
    private _populateChart() {
        ...
        promisesAll.then( values => {
            try {
                ...
                for ( const searchSubGroup of searchSubGroups_DisplayOrder ) {
                    ...
                    const chart_X_ALL__ScatterPlot : Array<number> =
                        this._process_PSM_Entries_For_X_Or_Y_Axis({
                            ...
                            peptideData_Entries_ForProcessing,
                            psmFilterableAnnotationData__NO_PSM_Peptide_Protein_Filtering__Holder,
                            psmTblData_For_ReportedPeptideId_For_MainFilters_Holder__NO_FILTERING,
                            proteinSequenceVersionIds_And_ProteinCoverage_For_MainFilters_Holder__NO_FILTERING
                        })
                    ...
                    const chart_Trace_Entry: Plotly.Data = {
                    ...
                    chartData_MainTraces_Array.push( chart_Trace_Entry );

                }

                {
                    const chart_Data_ReferenceLine: Plotly.Data =
                        {
                    ...
                    chartData_MainTraces_Array.unshift( chart_Data_ReferenceLine )
                }
                ...
                const chartTitle = "Best PSM Annotation Score Error Quantile Plot" + "<br><sup>Note: Data in plot are not filtered.</sup>";
    ...
    private _process_PSM_Entries_For_X_Or_Y_Axis(
        {
            searchSubGroupId, projectSearchId, annotationTypeId_ForAxis, fastaFileStatistics_SingleSearch_Entry,
            peptideData_Entries_ForProcessing, psmFilterableAnnotationData__NO_PSM_Peptide_Protein_Filtering__Holder,
            proteinSequenceVersionIds_And_ProteinCoverage_For_MainFilters_Holder__NO_FILTERING,
            psmTblData_For_ReportedPeptideId_For_MainFilters_Holder__NO_FILTERING
        } : {
            searchSubGroupId: number
            ...
            peptideData_Entries_ForProcessing: Array<Internal_PeptideEntry>
            ...
            proteinSequenceVersionIds_And_ProteinCoverage_For_MainFilters_Holder__NO_FILTERING: CommonData_LoadedFromServer_SingleSearch__ProteinSequenceVersionIds_And_ProteinCoverage_From_ReportedPeptidePeptideIds_For_MainFilters_Holder
            psmTblData_For_ReportedPeptideId_For_MainFilters_Holder__NO_FILTERING: CommonData_LoadedFromServer_SingleSearch__PSM_TblData_For_ReportedPeptideId_For_MainFilters_Holder
        }
    ) : Array<number> {
        ...
        for (const peptideData_Entry of peptideData_Entries_ForProcessing) {
            ...
            for (const psmTblData_Entry of psmTblData_Entries_Array ) {
                ...
                const psmFilterableAnnotationData_For_annotationTypeId_Score_X =
                    psmFilterableAnnotationData_Entry.get_PsmFilterableAnnotationData_For_AnnotationTypeId( annotationTypeId_ForAxis );
                ...
                if ( psmFilterableAnnotation_Best_Score__This_Peptide === undefined ) {
                    ...
                    if ( annotationTypeItem_ForDisplayScore.filterDirectionAbove ) {
                        ...
                        const msg = "annotationTypeItem_ForDisplayScore filterDirectionBelow and filterDirectionAbove BOTH NOT true. annotationTypeId_ForAxis: " + annotationTypeId_ForAxis;
                        console.warn(msg);
                        throw Error(msg);
                    }
                }
            ...
            let internal_AnnotationScore_Psm_Entries_MapEntry = internal_AnnotationScore_Peptide_Entries_Map_Key_AnnotationScore.get( psmFilterableAnnotation_Best_Score__This_Peptide );
            if ( ! internal_AnnotationScore_Psm_Entries_MapEntry ) {
                internal_AnnotationScore_Psm_Entries_MapEntry = { best_PsmAnnotationScore: psmFilterableAnnotation_Best_Score__This_Peptide, peptide_Entry_Array: [] }
                internal_AnnotationScore_Peptide_Entries_Map_Key_AnnotationScore.set( psmFilterableAnnotation_Best_Score__This_Peptide, internal_AnnotationScore_Psm_Entries_MapEntry );
            }
    ...
    private _openChartInOverlay() {
        try {
            qcViewPage_SingleSearch__SubSearches__Open_DistinctPeptide_EstimatedError__AnnotationScore_VS_AnnotationScore_StatisticsPlot_OverlayContainer({
                params: {
