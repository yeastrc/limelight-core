/**
 * qcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer.tsx
 *
 * QC Page Multiple Searches : The count of proteins where each entry is the number of Distinct Peptides for a Single Protein Entry - Overlay Container
 *
 */
...
const _Overlay_Title = "QC Plot: Peptides Per Protein Statistics"
 ...
 *
 */
export const qcViewPage_MultipleSearches__Open_ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer
            params={ params }
 ...
 *
 */
export interface QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer__Component_Params {
 ...
 *
 */
interface QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer extends React.Component< QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props, QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__ProteinCount_For_DistinctPeptideCount_Per_SingleProteinEntry_OverlayContainer_Props) {
        super(props);
