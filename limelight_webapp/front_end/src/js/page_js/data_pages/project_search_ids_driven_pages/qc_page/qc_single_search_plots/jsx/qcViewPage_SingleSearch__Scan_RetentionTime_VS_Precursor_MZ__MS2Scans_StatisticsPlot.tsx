/**
 * qcViewPage_SingleSearch__Scan_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot.tsx
 *
 * QC Page Single Search : Scan (MS2) Retention Time vs Precursor M/Z  for MS 2 Scans Statistics
 *
 */
...
import {
    open_PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_OverlayContainer
 ...
 *
 */
export interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__Scan_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_Props, QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__PSM_RetentionTime_VS_Precursor_MZ__MS2Scans_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
            ...
            try {
                ...
                for ( const dataForSingleScanNumberEntry of scanData_Single_SearchScanFileId_NO_Peaks_Data_Holder.scanData_NO_Peaks_Data_Holder.scanData.scansArray ) {
                    ...
                    if ( dataForSingleScanNumberEntry.level === 2 ) {
                        ...
                        const precursor_M_Over_Z = dataForSingleScanNumberEntry.precursor_M_Over_Z;
                ...
                const chart_Y_Axis_Label = "Precursor m/z"
