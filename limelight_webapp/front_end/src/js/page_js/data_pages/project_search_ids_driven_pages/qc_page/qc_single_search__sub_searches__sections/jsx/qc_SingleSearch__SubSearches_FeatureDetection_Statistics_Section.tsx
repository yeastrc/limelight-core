/**
 * qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section.tsx
 *
 * QC Page Single Search Sub Searches - Section - Feature Detection Statistics
 *
 */
 ...
 *
 */
export interface Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_Props {
 ...
 *
 */
interface Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_State {
 ...
 *
 */
export class Qc_SingleSearch__SubSearches_FeatureDetection_Statistics_Section extends React.Component< Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_Props, Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_State > {
     ...
     *
     */
    constructor(props: Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_Props) {
        super(props);
        ...
        const noData = !  this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent.qcPage_Flags_SingleSearch_ForProjectSearchId.hasScanData;
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_Props>, nextState: Readonly<Qc_SingleSearch_SubSearches_FeatureDetection_Statistics_Section_State>, nextContext: any): boolean {
            ...
            ( params: QcViewPage_Common__FeatureDetection_Statistics_Section__SelectFeatureDetectionOverlay_Component__SelectFeatureDetectionOverlay_Component_SelectionChosen_CallbackParams ) : void => {
                ...
                for ( const featureDetection_Root_Entry of this._featureDetectionEntry_ALL ) {
                    if ( featureDetection_Root_Entry.feature_detection_root__project_scnfl_mapping_tbl__id ===
                        ...
                        && this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent.projectSearchId ===
                                    ...
                                    <div className=" section--single-chart-not-in-multiple-in-row-container ">
                                            ...
                                            { this._selected_FeatureDetectionEntry__For_DisplayAndSelectComponentOnly ? (
                                                ...
                                                <QcViewPage_Common__FeatureDetection_Statistics_Section__ShownItem_DisplaySelect_Component
                                                    ...
                                                    projectSearchId__For__selected_FeatureDetection_Root_Entry={ this.props.qcViewPage_CommonData_To_All_SingleSearch__SubSearches_Components_From_MainSingleSearch__SubSearchesComponent.projectSearchId }
