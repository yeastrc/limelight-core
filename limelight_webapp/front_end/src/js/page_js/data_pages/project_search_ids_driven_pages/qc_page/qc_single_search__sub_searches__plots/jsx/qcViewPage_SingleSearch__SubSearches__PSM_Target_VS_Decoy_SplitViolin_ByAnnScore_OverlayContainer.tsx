/**
 * qcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer.tsx
 *
 ...
 *
 */
export enum QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice {
    NONE = "NONE",
    LOG_10 = "LOG_10",
 ...
 *
 */
export const qcViewPage_SingleSearch__SubSearches__Open_PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer = function (
    {
        params
    } : {
        params: QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__Component_Params
    ...
    const overlayComponent = (
        <QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer
            params={ params }
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_State {
 ...
 *
 */
class QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_Props, QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_Props) {
        super(props);
    ...
    private _score_Contains_NegativeValues_Callback( score_Contains_NegativeValues: boolean ) {
        ...
        if ( this.state.transform_Score !== QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NONE ) {
            this.setState({
                                                ...
                                                <React.Fragment>
                                                    <span>
                                                        <label>
                                                            <input
                                                                type="radio"
                                                                name="QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer_State__TransformScoreChoice"
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NONE
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
                                                    ...
                                                    <span>
                                                        <label>
                                                            <input
                                                                ...
                                                                checked={
                                                                    this.state.transform_Score ===
                                                                    QcViewPage_SingleSearch__SubSearches__PSM_Target_VS_Decoy_SplitViolin_ByAnnScore_StatisticsPlot_OverlayContainer__TransformScoreChoice.NEGATIVE_LOG_10
                                                                }
                                                                onChange={ event => {
                                                                    window.setTimeout( () => {
                                                                        this.setState({
