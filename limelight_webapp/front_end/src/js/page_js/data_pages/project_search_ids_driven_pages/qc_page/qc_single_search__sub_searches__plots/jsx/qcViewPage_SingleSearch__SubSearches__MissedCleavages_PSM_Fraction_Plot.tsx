 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_Plot
    extends React.Component< QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_Plot_Props, QcViewPage_SingleSearch__SubSearches__MissedCleavages_PSM_Fraction_Plot_State >
