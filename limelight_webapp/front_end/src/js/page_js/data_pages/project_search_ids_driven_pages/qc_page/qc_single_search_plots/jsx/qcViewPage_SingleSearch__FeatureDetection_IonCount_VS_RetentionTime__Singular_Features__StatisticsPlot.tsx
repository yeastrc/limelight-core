/**
 * qcViewPage_SingleSearch__FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot.tsx
 *
 * QC Page Single Search : Feature Detection: Ion Count Y Axis VS Retention Time X Axis Statistics  --  Singular Features for Green Line "Detected Features"
 *
 */
...
//     QcViewPage_SingleSearch__FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_OverlayContainer__TransformScoreChoice
// } from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search_plots/jsx/qcViewPage_SingleSearch__FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_OverlayContainer";
// import {
...
//
//
// const chartTitle = "Ions vs/ Retention Time";
//
// /**
//  *
//  */
// export class QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_FunctionType_Params {
//
...
//  *
//  */
// export type QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_FunctionType =
//     ( params: QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_FunctionType_Params ) => void
//
// /**
//  *
//  */
// export interface QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_Props {
//
...
//
//     transform_Score: QcViewPage_SingleSearch__FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_OverlayContainer__TransformScoreChoice
//
//     qcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_Function: QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_FunctionType
//
...
//  *
//  */
// interface QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_State {
//
//     //  Update 'shouldComponentUpdate' and 'componentDidUpdate' if change
//
...
//  *
//  */
// export class QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot extends React.Component< QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_Props, QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_State > {
//
...
//      *
//      */
//     constructor(props: QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_Props) {
//         super(props);
//
...
//      *
//      */
//     shouldComponentUpdate(nextProps: Readonly<QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_Props>, nextState: Readonly<QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_State>, nextContext: any): boolean {
//
//         if (
...
//      *
//      */
//     componentDidUpdate(prevProps: Readonly<QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_Props>, prevState: Readonly<QcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_State>, snapshot?: any) {
//         try {
//             if ( this._renderChart ) {
//
//                 if (
...
//
//
//         const featureDetectionRootId = this.props.featureDetection_Root_Entry_Selection.feature_detection_root_tbl_id;
//
//
...
//                 get_FeatureDetection_SingularFeature_EntriesHolder({ featureDetectionRootId });
//
...
//                 get_FeatureDetection_PersistentFeature_EntriesHolder({ featureDetectionRootId });
//
...
//                 get_FeatureDetection_MappingOf_PersistentToSingularFeature_EntriesHolder({ featureDetectionRootId });
//
...
//             }
//
//             if ( featureDetectionRootId !== this.props.featureDetection_Root_Entry_Selection.feature_detection_root_tbl_id ) {
//
//                 //  Data retrieved featureDetectionRootId is NO Longer the featureDetectionRootId requested to be displayed
//
//                 return;  // EARLY RETURN
//             }
//
...
//                 spectralStorage_NO_Peaks_Data.get_SpectralStorage_NO_Peaks_DataFor_SearchScanFileId( this.props.featureDetection_Root_Entry_Selection.search_scan_file_tbl_id )
//
//             if ( ! spectralStorage_NO_Peaks_DataFor_SearchScanFileId ) {
//                 const msg = "spectralStorage_NO_Peaks_Data.get_SpectralStorage_NO_Peaks_DataFor_SearchScanFileId(...) returned NOTHING for this.props.featureDetection_Root_Entry_Selection.search_scan_file_tbl_id: " + this.props.featureDetection_Root_Entry_Selection.search_scan_file_tbl_id;
//                 console.warn(msg);
//                 throw Error(msg);
//             }
//
//             for (const dataForSingleScanNumberEntry of spectralStorage_NO_Peaks_DataFor_SearchScanFileId.get_SpectralStorage_NO_Peaks_DataForSingleScanNumberEntries_IterableIterator()) {
//
...
//                         ", search_scan_file_tbl_id: " + this.props.featureDetection_Root_Entry_Selection.search_scan_file_tbl_id );
//
...
//
//                     this.props.qcViewPage_FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_MissingData_Callback_Function({ scans_NotContain_TotalIonCurrent, scans_NotContain_IonInjectionTime });
//
//                     //  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
//                     return; // EARLY RETURN
...
//
//                 if (spectralStorage_NO_Peaks_DataEntry.searchScanFileId !== this.props.featureDetection_Root_Entry_Selection.search_scan_file_tbl_id) {
...
//
//                     if ( scans_For_Selected_searchScanFileId_Map_Key_ScanNumber.has( dataForSingleScanNumberEntry.scanNumber ) ) {
//                         const msg = "scans_For_Selected_searchScanFileId_Map_Key_ScanNumber already has data for  dataForSingleScanNumberEntry.scanNumber: " + dataForSingleScanNumberEntry.scanNumber;
//                         console.warn(msg);
//                         throw Error(msg);
//                     }
//
...
//
//                 if ( this.props.transform_Score === QcViewPage_SingleSearch__FeatureDetection_IonCount_VS_RetentionTime__Singular_Features__StatisticsPlot_OverlayContainer__TransformScoreChoice.LOG_10 ) {
//
//                     if ( ionsPerSecond < 1 ) {
//                         ionsPerSecond = 0;
//                     } else {
...
//                 }
//
//                 if ( ms_2_scanData_For_PSMs_Map_Key_ScanNumber.has( ms_2_scanData.scanNumber ) ) {
//                     const msg = "ms_2_scanData_For_PSMs_Map_Key_ScanNumber already has data for  ms_2_scanData.scanNumber: " + ms_2_scanData.scanNumber;
//                     console.warn(msg);
//                     throw Error(msg);
//                 }
//
...
//                     // const featureDetection_SingleFeature_Entry__intensity = 0; // Default to zero
//                     // chart_X.push( retentionTime_Minutes );
//                     // chart_Y.push( featureDetection_SingleFeature_Entry__intensity );
//
//                 } else {
//                     //  Yes Feature Detection entries for MS 1 Scan Number
//
