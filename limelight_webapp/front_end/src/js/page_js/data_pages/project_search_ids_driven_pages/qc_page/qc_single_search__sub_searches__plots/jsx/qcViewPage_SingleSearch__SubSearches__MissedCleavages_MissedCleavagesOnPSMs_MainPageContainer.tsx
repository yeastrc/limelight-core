/**
 * qcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer.tsx
 *
 * QC Page SingleSearch__SubSearches : Missed Cleavages - Missed Cleavages - Missed Cleavage Count (PSMs) / Total PSM Count - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props) {
        super(props);
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_State>, snapshot?: any) {

        const show_NoData_Message_NewValue = this._computeNew__show_NoData_Message(this.props);

        this.setState( (state: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_State, props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props ) : QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_State => {
     ...
     *
     */
    private _computeNew__show_NoData_Message(props: QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_MainPageContainer_Props) : boolean {
            ...
            <div >
                <QcPage_ChartBorder >
                    ...
                    {( this.state.show_NoData_Message ) ? (
                        <QcPage_ChartFiller_NoData chartTitle={ QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_Plot.chartTitle } />
                    ) : (

                        <QcViewPage_SingleSearch__SubSearches__MissedCleavages_MissedCleavagesOnPSMs_Plot
