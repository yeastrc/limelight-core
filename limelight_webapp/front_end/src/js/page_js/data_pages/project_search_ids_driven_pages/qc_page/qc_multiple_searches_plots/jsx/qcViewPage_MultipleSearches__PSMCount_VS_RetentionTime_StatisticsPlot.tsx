/**
 * qcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot.tsx
 *
 * QC Page Multiple Searches : PSM Count vs Retention Time Statistics
 *
 */
...
import { open_PSMCount_VS_RetentionTime_OverlayContainer } from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_multiple_searches_plots/jsx/qcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot
    extends React.Component< QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_Props, QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_MultipleSearches__PSMCount_VS_RetentionTime_StatisticsPlot_State>, snapshot?: any) {
        try {
    ...
    private _loadData_IfNeeded_ThenCall_populateChart() {
        ...
        const scanData_Single_SearchScanFileId_NO_Peaks_Data_Holder_Map_Key_SearchScanFileId: Map<number, CommonData_LoadedFromServer_SingleSearch__ScanData_Single_SearchScanFileId_NO_Peaks_Data_Holder> = new Map()
            ...
            for (const psmTblData_Filtered_Entry of psmTblData_Filtered) {
                ...
                if ( search__PSMS_precursor_retention_time__NotNull ) {
                    ...
                    if ( ! scanData_Single_SearchScanFileId_NO_Peaks_Data_Holder_Map_Key_SearchScanFileId ) {
                        const msg = " else of ( search__PSMS_precursor_retention_time__NotNull ) AND (! scanData_Single_SearchScanFileId_NO_Peaks_Data_Holder_Map_Key_SearchScanFileId ) for projectSearchId: " + projectSearchId;
                        console.warn(msg);
                        throw Error(msg);
                    }
                ...
                chart_Y.push( retentionTimeSeconds / 60 );
            }
        }
