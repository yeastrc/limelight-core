/**
 * qcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer.tsx
 *
 * QC Page Single Search : Distinct Peptide Cumulative Error vs Peptide Rank by Best PSM Annotation Score Statistics - Main Page Container
 *
 */
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer extends React.Component< QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer_Props, QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer_State > {
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_MainPageContainer_Props) {
        super(props);
