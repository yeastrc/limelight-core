/**
 * qcViewPage_SingleSearch__DistinctPeptide_CumulativeCorrectCount__VS_AnnotationScore_StatisticsPlot.tsx
 *
 * QC Page Single Search: Sub Searches : Distinct Peptide Cumulative Error vs Peptide Rank by Best PSM Annotation Score Statistics
 *
 */
...
import {qcViewPage_SingleSearch__SubSearches__Open_DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer} from "page_js/data_pages/project_search_ids_driven_pages/qc_page/qc_single_search__sub_searches__plots/jsx/qcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer";
 ...
 *
 */
export interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props {
 ...
 *
 */
interface QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State {
 ...
 *
 */
export class QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot
    extends React.Component< QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props, QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State >
    implements QcViewPage__Track_LatestUpdates_For_UserInput_CentralRegistration_And_Callback_Interface
{
     ...
     *
     */
    constructor(props: QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props) {
        super(props);
     ...
     *
     */
    shouldComponentUpdate(nextProps: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props>, nextState: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State>, nextContext: any): boolean {
     ...
     *
     */
    componentDidUpdate(prevProps: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_Props>, prevState: Readonly<QcViewPage_SingleSearch__SubSearches__DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_StatisticsPlot_State>, snapshot?: any) {
        try {
            if ( this._renderChart ) {
            ...
            try {
                ...
                for ( const searchSubGroup of searchSubGroups_DisplayOrder ) {
                    ...
                    for ( let annotationTypeId_Array_Index = 0; annotationTypeId_Array_Index < this.props.annotationTypeId_Array.length; annotationTypeId_Array_Index++ ) {
                        ...
                        const internal_PsmAnnotationScore_Peptide_Entries_Map_Key_BestPsmAnnotationScore: Map<number, Internal_PsmAnnotationScore_Peptide_Entries> = new Map();

                        for (const peptideData_Entry of peptideData_Entries_ForProcessing) {

                            const psmTblData_Entries_Array = peptideData_Entry.psmTblData_Entries_Array_Map_Key_SearchSubGroupId.get(searchSubGroupId);
                            ...
                            for (const psmTblData_Entry of psmTblData_Entries_Array ) {
                                ...
                                if ( psmFilterableAnnotation_Best_Score__This_Peptide === undefined ) {
                                    ...
                                    if ( annotationTypeItem_ForDisplayScore.filterDirectionAbove ) {
                                        ...
                                        const msg = "annotationTypeItem_ForDisplayScore filterDirectionBelow and filterDirectionAbove BOTH NOT true. annotationTypeId: " + annotationTypeId;
                                        console.warn(msg);
                                        throw Error(msg);
                                    }
                                }
                            ...
                            let internal_PsmAnnotationScore_Peptide_Entries_MapEntry = internal_PsmAnnotationScore_Peptide_Entries_Map_Key_BestPsmAnnotationScore.get( psmFilterableAnnotation_Best_Score__This_Peptide );
                            if ( ! internal_PsmAnnotationScore_Peptide_Entries_MapEntry ) {
                                internal_PsmAnnotationScore_Peptide_Entries_MapEntry = { best_PsmAnnotationScore: psmFilterableAnnotation_Best_Score__This_Peptide, peptide_Entry_Array: [] }
                                internal_PsmAnnotationScore_Peptide_Entries_Map_Key_BestPsmAnnotationScore.set( psmFilterableAnnotation_Best_Score__This_Peptide, internal_PsmAnnotationScore_Peptide_Entries_MapEntry );
                            }
                            internal_PsmAnnotationScore_Peptide_Entries_MapEntry.peptide_Entry_Array.push( peptideData_Entry );
                        }

                        //  Copy Map into Array

                        const internal_PsmAnnotationScore_Peptide_Entries_Array: Array<Internal_PsmAnnotationScore_Peptide_Entries> = []

                        for ( const internal_AnnotationScore_Psm_Entries_MapEntry of internal_PsmAnnotationScore_Peptide_Entries_Map_Key_BestPsmAnnotationScore.values() ) {
                            internal_PsmAnnotationScore_Peptide_Entries_Array.push( internal_AnnotationScore_Psm_Entries_MapEntry )
                        }

                        //  Sort Best to Worst Best PSM Score for axis

                        if ( annotationTypeItem_ForDisplayScore.filterDirectionBelow ) {

                            //  Best Score is Smallest:  Sort Ascending

                            internal_PsmAnnotationScore_Peptide_Entries_Array.sort(( a,b ) => {
...

                        {
                            ...
                            for ( const internal_AnnotationScore_Peptide_Entries of internal_PsmAnnotationScore_Peptide_Entries_Array ) {
                                ...
                                const estimated_Number_Correct = total_ToCurrent_Peptide_target_Peptide_Count - total_ToCurrent_Peptide_independentDecoy_Peptide_Count / p;
                        ...
                        if ( annotationTypeId_Array_Index === 0 ) {
                            ...
                            chart_LineType_dash_property = "solid";

                        } else if ( annotationTypeId_Array_Index === 1 ) {

                            chart_LineType_dash_property = "dash";

                        } else if ( annotationTypeId_Array_Index === 2 ) {

                            chart_LineType_dash_property = "dot";

                        } else {
                            const msg = "annotationTypeId_Array_Index is not 0, 1, 2"
                            console.warn(msg)
                            throw Error(msg)
                        }
                        ...
                        const chart_Entry =    {
                            ...
                            line: {
                                ...
                                width: 2,
                                dash: chart_LineType_dash_property
                            }
                            // marker: {
                            //     size: 2,  //  https://plotly.com/javascript/reference/scattergl/#scattergl-marker-size
                            //     color: chart_Trace_Color  // If not populated, ALL the bars for this element in array 'chart_Data' are the same color
                            // }
                            // marker: {
                        ...
                        chartData_MainTraces_Array.push( chart_Entry )

                    }
                }

                const chartTitle = "Est. # Correct vs/ Est. Error By Best PSM Score" + "<br><sup>Note: Data in plot are not filtered.</sup>";
    ...
    private _openChartInOverlay() {
        try {
            qcViewPage_SingleSearch__SubSearches__Open_DistinctPeptide_CumulativeCorrectCount_VS_EstimatedErrorByAnnScore_OverlayContainer({
                params: {
