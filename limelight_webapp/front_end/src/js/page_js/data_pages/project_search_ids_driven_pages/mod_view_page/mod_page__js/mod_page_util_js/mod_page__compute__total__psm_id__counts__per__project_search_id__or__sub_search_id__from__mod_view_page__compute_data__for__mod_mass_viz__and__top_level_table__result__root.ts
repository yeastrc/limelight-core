...
export const modPage_Compute_Total_PsmId_Counts_Per_ProjectSearchId_Or_SubSearchId_From_ModViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result_Root = function (
    ...
    if ( computeData_For_ModMassViz_And_TopLevelTable_Result_Root.projectSearchId_Or_SubSearchId_Enum === ModViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result___ProjectSearchId_Or_SubSearchId_Enum.SubSearchId ) {
        ...
        const msg = "SubSearchId NOT Supported: psmId_Set_Map_Key_ProjectSearchId_Or_SubSearchId.get( projectSearchId ): modPage_Compute_Total_PsmId_Counts_Per_ProjectSearchId_Or_SubSearchId_From_ModViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result_Root(...) if ( computeData_For_ModMassViz_And_TopLevelTable_Result_Root.projectSearchId_Or_SubSearchId_Enum === ModViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result___ProjectSearchId_Or_SubSearchId_Enum.SubSearchId ) { "
        console.warn( msg )
        throw Error( msg )
    }
    ...
    if ( ! (
        ...
        for ( const psmTblData_With_NO_Modifications_Map_Key_PsmId_Map_Key_ProjectSearchId__MapEntry of computeData_For_ModMassViz_And_TopLevelTable_Result_Root.get_psmTblData_With_NO_Modifications_Map_Key_PsmId_Map_Key_ProjectSearchId() ) {
            ...
            let psmId_Set = psmId_Set_Map_Key_ProjectSearchId_Or_SubSearchId.get( projectSearchId )
            if ( ! psmId_Set ) {
                psmId_Set = new Set()
                psmId_Set_Map_Key_ProjectSearchId_Or_SubSearchId.set( projectSearchId, psmId_Set )
            }
