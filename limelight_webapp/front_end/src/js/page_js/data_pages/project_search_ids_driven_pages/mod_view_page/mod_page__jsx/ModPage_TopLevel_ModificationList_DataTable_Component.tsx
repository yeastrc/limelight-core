...
const _generateDataTable = function (
    ...
    const dataTableRows : Array<DataTable_DataRowEntry> = _getDataTableRows({
        dataPageStateManager_DataFrom_Server,
        modViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result_Root,
        projectSearchIds,
        modView_DataViz_Compute_ColorScale_WidthHeight_Etc_Result,
...
const _getDataTableRows = function (
    {
        modViewPage_ComputeData_For_ModMassViz_And_TopLevelTable_Result_Root,
        modView_DataViz_Compute_ColorScale_WidthHeight_Etc_Result,
        searchDataLookupParameters_Root,
...
const _getDisplayNameForModMassColumn = function (
    ...
    if ( modViewPage_DataVizOptions_VizSelections_PageStateManager.get_dataTransformation() !== undefined
        ...
        displayString = modPage_Get_DataTransformationType_DisplayLabel({ modViewPage_DataVizOptions_VizSelections_PageStateManager });
    } else {
