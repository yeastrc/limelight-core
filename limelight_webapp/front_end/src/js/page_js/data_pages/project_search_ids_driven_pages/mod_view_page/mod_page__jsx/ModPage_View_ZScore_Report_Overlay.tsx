/**
 * ModPage_View_ZScore_Report_Overlay.tsx
 */
 ...
 *
 */
export type ModPage_View_ZScore_Report_Overlay_Params = {

    quantTypeString: string
    tableRows: Array<ModPage_View_ZScore_Report_Overlay_Params_TableRow>
}
 ...
 * @param tableRows
 */
export const open_ModPage_View_ZScore_Report_Overlay = function( params: ModPage_View_ZScore_Report_Overlay_Params ) : void {
    ...
    const overlayComponent = (
        <ModPage_View_ZScore_Report_Overlay
            props_value={ params }
 ...
 *
 */
interface ModPage_View_ZScore_Report_Overlay_Props {

    props_value: ModPage_View_ZScore_Report_Overlay_Params
 ...
 *
 */
interface ModPage_View_ZScore_Report_Overlay_State {
 ...
 *
 */
class ModPage_View_ZScore_Report_Overlay extends React.Component< ModPage_View_ZScore_Report_Overlay_Props, ModPage_View_ZScore_Report_Overlay_State > {

    /**
     *
     */
    constructor( props: ModPage_View_ZScore_Report_Overlay_Props ) {
        super( props );
                ...
                >
                    <table>
                        ...
                        { this.props.props_value.tableRows.map( ( tableRow_Entry, index) => {
                            return (
                                <tr key={ index }>
                                    <td>{ tableRow_Entry.search1 }</td>
                                    <td>{ tableRow_Entry.search2 }</td>
