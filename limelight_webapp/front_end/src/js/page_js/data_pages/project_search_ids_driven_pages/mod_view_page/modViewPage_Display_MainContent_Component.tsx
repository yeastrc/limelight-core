...
} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/peptide_sequence_selected/js/peptideSequence_UserSelections_ComponentData';
...
} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on__modification__reporter_ion/modification_mass_user_selections/jsx/modificationMass_UserSelections_Root';

import {
    ReporterIonMass_UserSelections
} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on__modification__reporter_ion/reporter_ions_user_selections/jsx/reporterIonMass_UserSelections';

import {
    PeptideSequence_UserSelections
} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/peptide_sequence_selected/jsx/peptideSequence_UserSelections';
...
import {
    ModificationMass_UserSelections_DisplayMassSelectionOverlay
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on__modification__reporter_ion/modification_mass_user_selections/js/modificationMass_UserSelections_DisplayMassSelectionOverlay";
import {
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/peptide_unique_user_filter_selection/jsx/peptideUnique_UserSelection";
import {
    PeptideUnique_UserSelection_ComponentData
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/peptide_unique_user_filter_selection/js/peptideUnique_UserSelection_ComponentData";
import {
...
import {
    peptideUnique_UserSelection_BuildData_ForReactComponent
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/peptide_unique_user_filter_selection/js/peptideUnique_UserSelection_BuildData_ForReactComponent";
import {
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on_counts_psm/jsx/peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_Component";
import {
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/scan_retention_time_precursor_m_z_selection/jsx/scan_RetentionTime_MZ_UserSelections_Component";
import {
    ScanFilenameId_On_PSM_Filter_UserSelection_Component
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/scan_file_name_on_psms_selection/jsx/scanFilenameId_On_PSM_Filter_UserSelection_Component";
import {
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__search_programs_group__conditional_render__component/filterOn_SearchProgramsGroup_ConditionalRender_Component";
import {
    CommonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root
} from "page_js/data_pages/common_data_loaded_from_server__per_search_plus_some_assoc_common_data__with_loading_code__except_mod_main_page/commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root";
import {
    Psm_Charge_Filter_UserSelection_Container_Component
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/psm_charge/psm_Charge_Filter_UserSelection_Container_Component";
import {
...
import {
    purge_FilterSelections_NotIn_CurrentData
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/purge_filter_selections_not_in_current_data/purge_FilterSelections_NotIn_CurrentData";
import {
    ProteinPositionFilter_UserSelections__GetsProteinData
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__peptide_page__components/protein_position_filter_component/jsx/proteinPositionFilter_UserSelections_Component__Container__GetsProteinData";
import {
...
} from 'page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/psm_exclude_independent_decoy_psms/psm_Exclude_IndependentDecoy_PSMs_UserSelection';
import {
    PeptideSequence_MissedCleavageCount_UserSelections_Component
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on__peptide_sequence_missed_cleavage_count/jsx/peptideSequence_MissedCleavageCount_UserSelections_Component";
import {
...
} from "page_js/data_pages/common_filtering_code_filtering_components__except_mod_main_page/filter_on__components/filter_on__core__components__peptide__single_protein/filter_on__peptide_meets_digestion__aka_tryptic_peptide_etc/peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_Component";
import {
...
export class ModViewPage_Display_MainContent_Component extends React.Component< ModViewPage_Display_MainContent_Component_Props, ModViewPage_Display_MainContent_Component_State > {
     ...
     *
     */
    constructor(props : ModViewPage_Display_MainContent_Component_Props) { try {
        super(props);

        const projectSearchIds = props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage;

        this._allSearches_HaveProteins = true

        {
            for ( const projectSearchId of this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage ) {

                const common_Flags_SingleSearch = props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_DataPage_common_Searches_Flags().get_DataPage_common_Flags_SingleSearch_ForProjectSearchId(projectSearchId)

                if ( common_Flags_SingleSearch.searchNotContainProteins ) {

                    this._allSearches_HaveProteins = false
                    break
                }
            }
        }
        ...
        this._modificationMass_ReporterIon__UserSelections__Coordinator_Class__For_ModificationSelects =
            new ModificationMass_ReporterIon__UserSelections__Coordinator_Class({
                ...
                modificationMass_UserSelections_StateObject: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject,
        ...
        this._modificationMass_ReporterIon__UserSelections__Coordinator_Class__For_ReporterIonSelections =
            new ModificationMass_ReporterIon__UserSelections__Coordinator_Class({
                ...
                reporterIonMass_UserSelections_StateObject: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.reporterIonMass_UserSelections_StateObject
            })
        ...
        const commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root = CommonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root.getNewInstance({
            projectSearchIds,
            searchDataLookupParameters_Root: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchDataLookupParameters_Root,
            dataPageStateManager: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server,
        ...
        const getReportedPeptideIdsForDisplay_AllProjectSearchIds_Object = GetReportedPeptideIdsForDisplay_AllProjectSearchIds_Class.getNewInstance({
            projectSearchIds, dataPage_common_Searches_Flags: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_DataPage_common_Searches_Flags(),
            commonData_LoadedFromServer_PerSearch_Plus_SomeAssocCommonData__Except_ModMainPage__Root
        });
...

        {
            ...
            for ( const projectSearchId of props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage ) {

                const dataPage_common_Flags_SingleSearch_ForProjectSearchId = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_DataPage_common_Searches_Flags().get_DataPage_common_Flags_SingleSearch_ForProjectSearchId(projectSearchId);
                if (!dataPage_common_Flags_SingleSearch_ForProjectSearchId) {
                    const msg = "this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager.get_DataPage_common_Searches_Flags().get_DataPage_common_Flags_SingleSearch_ForProjectSearchId(projectSearchId); returned NOTHING for projectSearchId: " + projectSearchId;
                    console.warn(msg);
                    throw Error(msg);
                }
            ...
            for ( const projectSearchId of props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage ) {
                ...
                const dataPage_common_Info_SingleSearch_ForProjectSearchId = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_DataPage_common_Searches_Info().get_DataPage_common_Searches_Info_SingleSearch_ForProjectSearchId(projectSearchId);
        ...
        if ( ! this._allSearches_Have_ScanFilenames ) {
            props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanFilenameId_On_PSM_Filter_UserSelection_StateObject.clearAll();
        }
        if ( ! this._allSearches_Have_PSM_RetentionTime_Precursor_MZ_OR_ScanData ) {
            props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scan_RetentionTime_MZ_UserSelection_StateObject.clearAll();
        }
    ...
    private _runOnPageLoad() {
        ...
        if (this.props.propsValue.singleProtein_CentralStateManagerObject) {
            ...
            if (proteinSequenceVersionId_FromURL !== undefined && proteinSequenceVersionId_FromURL !== null) {
                ...
                _copy_searchSubGroup_CentralStateManagerObjectClass__to__singleProtein_CentralStateManagerObject_searchSubGroup_CentralStateManagerObjectClass_SingleProtein__IfNOTPopulated({
                    searchSubGroup_CentralStateManagerObjectClass : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchSubGroup_CentralStateManagerObjectClass,
                    projectSearchIds : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage,
                ...
                _copy_modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass__to__modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass_SingleProtein__IfNOTPopulated({
                    modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass,
                    singleProtein_CentralStateManagerObject : this.props.propsValue.singleProtein_CentralStateManagerObject
                });
        ...
        {  //  remove from selection state objects values that are not in the loaded data. (Values that have been for: searches removed, or for values that don't meet new filter cutoffs)
            ...
            const promise = purge_FilterSelections_NotIn_CurrentData({
                projectSearchIds : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage,
                dataPageStateManager: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server,
                ...
                modificationMass_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject,
                reporterIonMass_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.reporterIonMass_UserSelections_StateObject,
                proteinPosition_Of_Modification_Filter_UserSelections_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPosition_Of_Modification_Filter_UserSelections_StateObject,
                proteinPositionFilter_UserSelections_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPositionFilter_UserSelections_StateObject,
                psm_Charge_Filter_UserSelection_StateObject:  this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Charge_Filter_UserSelection_StateObject,
                scanFilenameId_On_PSM_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanFilenameId_On_PSM_Filter_UserSelection_StateObject,
                scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject,
                scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject,
                peptideUnique_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideUnique_UserSelection_StateObject
            });
    ...
    private _recompute_FullPage_Except_SearchDetails__SubPart_RunBeforeMain(
        ...
        if (proteinSequenceVersionId_FromURL !== undefined && proteinSequenceVersionId_FromURL !== null) {
            ...
            const modMass_Rounded_From_ModPage_ForInitialSelection =
                this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.get_modMass_Rounded_From_ModPage_MainPage_For_SingleProtein_InitialSelection()
    ...
    private async _recompute_FullPage_Except_SearchDetails__SubPart_Main(
        ...
        try {
            const {
                ...
                scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject,
                scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject,
                scan_RetentionTime_MZ_UserSelection_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scan_RetentionTime_MZ_UserSelection_StateObject,
                peptideUnique_UserSelection_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideUnique_UserSelection_StateObject,
                peptideSequence_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_UserSelections_StateObject,
                peptideSequence_MissedCleavageCount_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_MissedCleavageCount_UserSelections_StateObject,
                peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject,
                proteinPositionFilter_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPositionFilter_UserSelections_StateObject,
                proteinPosition_Of_Modification_Filter_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPosition_Of_Modification_Filter_UserSelections_StateObject,
                psm_Charge_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Charge_Filter_UserSelection_StateObject,
                psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject
            });
            ...
            const mod_Page_FiltersDisplay_ComponentData : Mod_Page_FiltersDisplay_ComponentData = {
                ...
                proteinPositionFilter_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPositionFilter_UserSelections_StateObject,
                proteinPosition_Of_Modification_Filter_UserSelections_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPosition_Of_Modification_Filter_UserSelections_StateObject,
                peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject,
                scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject,
                scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject,
                scanFilenameId_On_PSM_Filter_UserSelection_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanFilenameId_On_PSM_Filter_UserSelection_StateObject,
                commonData_LoadedFromServer_MultipleSearches__ScanFile_SearchScanFileId_ScanFilename_ScanFileId_Holder,
                scan_RetentionTime_MZ_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scan_RetentionTime_MZ_UserSelection_StateObject,
                psm_Charge_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Charge_Filter_UserSelection_StateObject,
                psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject,
                searchSubGroup_Are_All_SearchSubGroupIds_Selected,
                searchSubGroup_PropValue
            ...
            const reportedPeptideIds_AndTheir_PSM_IDs__AllProjectSearchIds__FINAL =
                await create_GeneratedReportedPeptideListData__SingleProtein___ONLY_for_FILTERING__Returns__ReportedPeptideIds_AndTheir_PSM_IDs__AllProjectSearchIds( {
                    ...
                    psmMinimumCount_Filter_UserEntry: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject.get_PSM_CountFilter(),

                    searchSubGroup_Ids_Selected,
                    reportedPeptideIds_AndTheir_PSM_IDs__AllProjectSearchIds,
                    generatedPeptideContents_UserSelections_StateObject: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.generatedPeptideContents_UserSelections_StateObject,
                    modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass,
                    dataPageStateManager: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server,
    ...
    private _singleProteinRowShowSingleProteinNewWindow(
        ...
        this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.set_modMass_Rounded_From_ModPage_MainPage_For_SingleProtein_InitialSelection({ modMass_Rounded_From_ModPage_MainPage_For_SingleProtein_InitialSelection: modMass_Rounded_From_ModPage_ForInitialSelection })
    ...
    private _instantiateObject_Class__ProteinPage_Display__SingleProtein({currentWindowScrollY}: {currentWindowScrollY: number}) {
        ...
        this._proteinPage_Display__SingleProtein_Root = new ProteinPage_Display__SingleProtein_Root({
            ...
            dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay,
            dataPageStateManager_DataFrom_Server: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server,
            searchDetailsBlockDataMgmtProcessing: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchDetailsBlockDataMgmtProcessing,
            projectSearchIds: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage,
            searchDataLookupParamsRoot: this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay.get_searchDetailsCriteriaData(),
            singleProtein_CentralStateManagerObject: this.props.propsValue.singleProtein_CentralStateManagerObject,
    ...
    _clearAllSelections() {
        try {
            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchSubGroup_CentralStateManagerObjectClass.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject.clear_selectedModifications();

            //  NOT Reset this for "Clear All"
            // this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass.clearTreatOpenModMassZeroAsUnmodified_Selection();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.reporterIonMass_UserSelections_StateObject.clear_selectedReporterIons();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideUnique_UserSelection_StateObject.clearPeptideUnique();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_UserSelections_StateObject.clearPeptideSearchStrings();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_MissedCleavageCount_UserSelections_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideMeetsDigestion_AKA_TrypticPeptide_Etc_UserSelections_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPositionFilter_UserSelections_StateObject.clearSelections();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.proteinPosition_Of_Modification_Filter_UserSelections_StateObject.clearSelections();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanFilenameId_On_PSM_Filter_UserSelection_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scan_RetentionTime_MZ_UserSelection_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Charge_Filter_UserSelection_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanNumber_ScanFilenameId_ProjectSearchId_On_PSM_Filter_UserSelection_StateObject.clearAll();

            this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.scanPeak_M_Over_Z__Intensity_Filter_UserSelection_StateObject.clearAll();
    ...
    _openModificationMass_OpenUserSelections_Overlay_ActualOpenOverlay() : void {
        ...
        const modificationMass_UserSelections_DisplayMassSelectionOverlay = new ModificationMass_UserSelections_DisplayMassSelectionOverlay({
            ...
            modificationMass_Subpart_Variable_Open_Modifications_UserSelections_StateObject : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject.get_OpenModificationSelections(),
            proteinNames: null,
    ...
    /**
     * Change was made to modification selection.  this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject has been updated
     *
    ...
    /**
     * Change to peptide unique selection, this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideUnique_UserSelection_StateObject
     */
    ...
    /**
     * Change to peptide string selection, this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_UserSelections_StateObject
     */
    ...
    /**
     * Change to Protein Position Filter Selections, this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.updateMadeTo_proteinPositionFilter_UserSelections_StateObject_Callback
     */
    ...
    _selectedModificationsChange_UpdateURL() {
        ...
        const modsSelectedEncodedStateData = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject.getEncodedStateData();
        this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.setModsSelectedEncodedStateData( { modsSelectedEncodedStateData : modsSelectedEncodedStateData } );
    }
    ...
    _reporterIonMassesChange_UpdateURL() {
        ...
        const reporterIonMassesSelectedEncodedStateData = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.reporterIonMass_UserSelections_StateObject.getEncodedStateData();
        this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.setReporterIonMassesSelectedEncodedStateData( { reporterIonMassesSelectedEncodedStateData } );
    }
    ...
    _selectedPeptideUniqueChange_UpdateURL() {
        ...
        const encodedStateData = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideUnique_UserSelection_StateObject.getEncodedStateData();
        this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.setPeptideUniqueFilterSelectedEncodedStateData({ peptideUniqueFilterSelectedEncodedStateData : encodedStateData });
    }
    ...
    _selectedPeptideSequenceChange_UpdateURL() {
        ...
        const peptideSequenceSelectedEncodedStateData = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideSequence_UserSelections_StateObject.getEncodedStateData();
        this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modPageRoot_CentralStateManagerObjectClass.setPeptideSequenceFilterSelectedEncodedStateData({ peptideSequenceFilterSelectedEncodedStateData : peptideSequenceSelectedEncodedStateData });
    }
    ...
    render() {
        ...
        if ( this.props.propsValue.dataPages_LoggedInUser_CommonObjectsFactory &&  this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage.length === 1 ) {
            ...
            const param = new SetDefaultView_Component_React_Params({ projectSearchId : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage[ 0 ] });
        ...
        //
        // if ( this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage.length === 1 && this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager.get_SearchSubGroups_Root() ) {
        //
        //     //  Only display for 1 search
        //
        //     const projectSearchId = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage[ 0 ];
        //
        //     const searchSubGroups_ForProjectSearchId = this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager.get_SearchSubGroups_Root().get_searchSubGroups_ForProjectSearchId( projectSearchId );
        //     if ( ! searchSubGroups_ForProjectSearchId ) {
        //         const msg = "returned nothing: props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager.get_SearchSubGroups_Root().get_searchSubGroups_ForProjectSearchId( projectSearchId ), projectSearchId: " + projectSearchId;
        //         console.warn( msg )
        //         throw Error( msg )
        //     }
        //
        //     searchSubGroup_Ids_Selected = searchSubGroup_Get_Selected_SearchSubGroupIds({
        //         searchSubGroup_CentralStateManagerObjectClass : this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchSubGroup_CentralStateManagerObjectClass, searchSubGroups_ForProjectSearchId
        //     })
        // }
                    ...
                    <React.Fragment>
                        ...
                        <div style={ { position: "relative"} }>
                            ...
                            <ModPage_ModPageBlock_UserEntryArea_BelowTheCollapsableFiltersAndOptionsSection_AndBelow_Incl_DataTable_Component
                                ...
                                all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root }
                    ...
                    <div className=" filter-common-block-selection-container-block yes-section-labels ">
                        ...
                        <FilterSection_DataPage_ShowHide_ExpandCollapse_Container_Component>   {/*  Show/Hide the filters */ }
                            ...
                            >
                                ...
                                <SearchSubGroup_In_SingleProtein_FilterOn_Block_Root_Component
                                    projectSearchId={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage[ 0 ] }
                                    dataPageStateManager={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server }
                            ...
                            <ModificationMass_UserSelections_Root
                                ...
                                modificationMass_UserSelections_StateObject={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject } // Updated in the component
                                ...
                                modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_OpenModMassZeroNotOpenMod_UserSelection__CentralStateManagerObjectClass } // Updated in the component
                                ...
                                updateMadeTo_modificationMass_UserSelections_StateObject_Callback={ this._modificationMass_UserSelections_UpdateMadeTo_StateObject_Callback_BindThis } // this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.modificationMass_UserSelections_StateObject has been updated.
                            ...
                            { ( this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_DataPage_common_Searches_Flags().is__anyPsmHas_IsIndependentDecoy_True__TrueForAnySearch() ) ? (

                                <Psm_Exclude_IndependentDecoy_PSMs_UserSelection
                                    psm_Exclude_IndependentDecoy_PSMs_UserSelection_StateObject={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.psm_Exclude_IndependentDecoy_PSMs_Filter_UserSelection_StateObject }
                            ...
                            <PeptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_Component
                                peptideList_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject={ this.props.propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.peptideList_PeptidePage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject }
    ...
    }) :  Set<number>
{
    ...
    if ( propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage.length === 1 && propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_SearchSubGroups_Root() ) {

        //  Only display for 1 search

        const projectSearchId = propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage[ 0 ];

        const searchSubGroups_ForProjectSearchId = propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_SearchSubGroups_Root().get_searchSubGroups_ForProjectSearchId( projectSearchId );
        if ( ! searchSubGroups_ForProjectSearchId ) {
            const msg = "returned nothing: propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager.get_SearchSubGroups_Root().get_searchSubGroups_ForProjectSearchId( projectSearchId ), projectSearchId: " + projectSearchId;
            console.warn( msg )
            throw Error( msg )
        }

        searchSubGroup_Ids_Selected = searchSubGroup_Get_Selected_SearchSubGroupIds({
            searchSubGroup_CentralStateManagerObjectClass : propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchSubGroup_CentralStateManagerObjectClass, searchSubGroups_ForProjectSearchId
        })
    }
...
const _compute_searchSubGroup_PropValue = function (
    ...
    if ( propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.projectSearchIds_AllForPage.length === 1 && propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server.get_SearchSubGroups_Root() ) {
        ...
        searchSubGroup_PropValue = searchSubGroup_Create__SearchSubGroup_In_SearchDetailsAndFilter_Component_DisplayData({
            ...
            searchSubGroup_CentralStateManagerObjectClass: propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchSubGroup_CentralStateManagerObjectClass
        });
    }
    ...
    }) : SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue
{
    ...
    const searchDetailsAndFilterBlock_MainPage_Root_Props_PropValue : SearchDetailsAndFilterBlock_MainPage_Root_Props_PropValue =  {
        ...
        dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay : propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_ProjectSearchIdsTheirFiltersAnnTypeDisplay,
        dataPageStateManager_DataFrom_Server : propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.dataPageStateManager_DataFrom_Server,
        searchDetailsBlockDataMgmtProcessing : propsValue.all_Common_ProjectSearchIdsAll_PageStateObjects_Etc_From_Root.searchDetailsBlockDataMgmtProcessing,
