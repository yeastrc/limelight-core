/**
 * scanFileToSearchesPageRoot_CentralStateManagerObjectClass.ts
 * 
...
import {
	SCAN_FILE_TO_SEARCHES_PAGE__CENTRAL_STATE_MANAGER_OBJECT_CLASS__CENTRAL_STATE_MANAGER_KEY
} from 'page_js/data_pages/central_page_state_manager/centralPageStateManager_Keys';
import {CentralPageStateManager} from "page_js/data_pages/central_page_state_manager/centralPageStateManager";

const _COMPONENT_UNIQUE_ID = SCAN_FILE_TO_SEARCHES_PAGE__CENTRAL_STATE_MANAGER_OBJECT_CLASS__CENTRAL_STATE_MANAGER_KEY; // Key for use in Central State Manager
...
const _PROJECT_SCAN_FILE_ID_SELECTION_STATE_OBJECT_ENCODED_STATE_DATA_PROPERTY_NAME = "r"

class ScanFileToSearchesPageRoot_CentralStateManagerObjectClass__InitializeMethod_OptionalParam {
 ...
 * 
 */
export class ScanFileToSearchesPageRoot_CentralStateManagerObjectClass {
	...
	private _value : {
		...
		peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData?: any // PeptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_UserSelections_StateObject
		...
		projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData?: any // ProjectScanFileId_ScanFileToSearchesPage_UserSelections_StateObject
	}
	 ...
	 */
	initialize( param? : ScanFileToSearchesPageRoot_CentralStateManagerObjectClass__InitializeMethod_OptionalParam ) {
		...
		if ( encodedStateData ) {
            this._value = {
				...
				peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData : encodedStateData[ _FILTER_ON_COUNTS_ENCODED_STATE_DATA_ENCODING_PROPERTY_NAME ],
				...
				projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData: encodedStateData[ _PROJECT_SCAN_FILE_ID_SELECTION_STATE_OBJECT_ENCODED_STATE_DATA_PROPERTY_NAME ]
			};
		}
	}
	...
	/**
	 * @param peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData
	 */
	set_peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData(
		{
			peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData
		} :{
			peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData: any
		} ) {
		this._value.peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData = peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData;
	 ...
	 * peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData
	 */
	get_peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData() {
		return this._value.peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData;
	}
	 ...
	 *
	 */
	set_projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData(
		{
			projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData
		} :{
			projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData: any
		} ) {
		this._value.projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData = projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData;
	 ...
	 * projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData
	 */
	get_projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData() {
		return this._value.projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData;
	}
	...
	getDataForEncoding() {
		...
		if ( this._value.peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData !== undefined ) {
			dataForEncoding[ _FILTER_ON_COUNTS_ENCODED_STATE_DATA_ENCODING_PROPERTY_NAME ] = this._value.peptideList_ScanFileToSearchesPage_SingleProtein_FilterOnCounts_psm_Selection_EncodedStateData;
		}
		...
		if ( this._value.projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData !== undefined ) {
			dataForEncoding[ _PROJECT_SCAN_FILE_ID_SELECTION_STATE_OBJECT_ENCODED_STATE_DATA_PROPERTY_NAME ] = this._value.projectScanFileId_ScanFileToSearchesPage_UserSelection_StateObject_EncodedStateData;
		}
