/**
 * dataTable_HeaderRowEntry_SortIcon_InContainer_TRY_1_DO_NOT_USE.jsx
 * 
 * Sort Icon for Table Entry in Header Row
 */
import React from 'react'
import { SORT_DIRECTION_ASCENDING, SORT_DIRECTION_DECENDING } from './dataTable_constants_TRY_1_DO_NOT_USE';
 ...
 * 
 */
export class DataTable_Table_HeaderRowEntry_SortIcon_InContainer extends React.Component {
    ...
    render () {
      ...
      const sortIconStyle = { display: "flex", alignItems: "flex-end", paddingLeft: "1px" };
