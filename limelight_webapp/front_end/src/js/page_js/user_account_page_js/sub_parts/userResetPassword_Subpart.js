...
var _user_account_login_forgot_password_template_bundle = 
...
export class UserResetPassword_Subpart {
	...
	constructor() {
		...
		if ( ! _user_account_login_forgot_password_template_bundle.user_reset_password_form_main_display_template ) {
			throw Error("Nothing in _user_account_login_forgot_password_template_bundle.user_reset_password_form_main_display_template");
		}

		this._user_reset_password_form_main_display_template = _user_account_login_forgot_password_template_bundle.user_reset_password_form_main_display_template;
