...
import { UserResetPassword_Subpart } from 'page_js/user_account_page_js/sub_parts/userResetPassword_Subpart.js';
...
class UserLoginPage {
	...
	constructor() {
		...
		this._userResetPassword_Subpart = new UserResetPassword_Subpart();
	}
	...
	_showLoginForm( { main_container_below_logo } ) {
		...
		this._userLogin_Subpart.showOnPage( { containerHTMLElement : main_container_below_logo } );
	}
