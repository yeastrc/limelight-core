 ...
 *
 */
public class PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DTO   {
	...
	public String toString() {
		return "PsmModificationPosition_Worst_FilterableAnnotation_Lookup_DTO [psmId=" + psmId + ", annotationTypeId="
				+ annotationTypeId + ", worstValueDouble=" + worstValueDouble + "]";
	}
