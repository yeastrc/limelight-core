 ...
 */
public enum FilterDirectionTypeJavaCodeEnum {
     ...
     */
    private FilterDirectionTypeJavaCodeEnum(String v) {
        value = v;
    }
     ...
     * @return
     */
    public static FilterDirectionTypeJavaCodeEnum fromValue( String value_ ) {
        for (FilterDirectionTypeJavaCodeEnum c: FilterDirectionTypeJavaCodeEnum.values()) {
