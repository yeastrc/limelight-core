...
/**
 * table file_import_tracking_run
 *
 */
public class FileImportTrackingRun_PopulateDTO {


	//  private constructor
	private FileImportTrackingRun_PopulateDTO() { }
	
	/**
	 * @return newly created instance
	 */
	public static FileImportTrackingRun_PopulateDTO getInstance() { 
		return new FileImportTrackingRun_PopulateDTO(); 
	}
