 ...
 *
 */
public class SrchRepPept_IsotopeLabel_DTO {
	...
	public String toString() {
		return "SrchRepPept_IsotopeLabel_DTO [searchId=" + searchId + ", reportedPeptideId=" + reportedPeptideId
				+ ", isotopeLabelId=" + isotopeLabelId + "]";
	}
