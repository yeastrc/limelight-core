...
*/
package org.yeastrc.limelight.limelight_shared.file_import_pipeline_run.searchers;
 ...
 *
 */
public class FileImportAndPipelineRunTracking_Searcher_Shared {

	private static final Logger log = LoggerFactory.getLogger( FileImportAndPipelineRunTracking_Searcher_Shared.class );

	//  private constructor
	private FileImportAndPipelineRunTracking_Searcher_Shared() { }
	/**
	 * @return newly created instance
	 */
	public static FileImportAndPipelineRunTracking_Searcher_Shared getInstance() { 
		return new FileImportAndPipelineRunTracking_Searcher_Shared(); 
	}
