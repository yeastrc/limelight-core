 ...
 *
 */
public class SearchRepPeptSubGroupDTO {
	...
	public String toString() {
		return "SearchRepPeptSubGroupDTO [searchId=" + searchId + ", reportedPeptideId=" + reportedPeptideId
				+ ", searchSubGroupId=" + searchSubGroupId + "]";
	}
