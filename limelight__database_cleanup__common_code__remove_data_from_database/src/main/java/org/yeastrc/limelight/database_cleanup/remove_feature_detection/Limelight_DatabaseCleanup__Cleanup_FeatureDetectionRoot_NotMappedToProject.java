 ...
 * 
 * 		There are NO records in table feature_detection_root__project_scnfl_mapping_tbl
 *
 */
public class Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject {

	private static final Logger log = LoggerFactory.getLogger(Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject.class);

	/**
	 * private constructor
	 */
	private Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject() { }
	/**
	 * Static singleton instance
	 */
	private static final Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject _instance = new Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject();
	/**
	 * Static get singleton instance
	 * @return
	 */
	public static Limelight_DatabaseCleanup__Cleanup_FeatureDetectionRoot_NotMappedToProject getInstance() {
		return _instance; 
	}
	...
	public void cleanup_NoLongerMappedToProject(
		...
		if ( callFrom == Limelight_DatabaseCleanup__CallFrom__RunImporter_VS_StandaloneProgram_Enum.STANDALONE_PROGRAM ) {
			...
			System.out.println( "*************************************");
			System.out.println( "***  About to start deleting records in feature_detection_root_tbl for NO LONGER mapped to any project" );
			System.out.println( "************");
		} else {
			log.info( "Database Cleanup: Starting: Removing Database records in feature_detection_root_tbl for NO LONGER mapped to any project" );
		}
		...
		List<Integer> idsToDelete = Limelight_DatabaseCleanup__FeatureDetectionRoot_NotMappedToAnyProject_Searcher.getInstance().getIdsToDelete();
