...
*/
package org.yeastrc.limelight.limelight_run_importer.exceptions;

/**
 * Error calling Limelight Import Finish Webservice
 *
 */
public class LimelightCallWebserviceOnImportFinishException extends Exception {
	...
	public String toString() {
		return "LimelightCallWebserviceOnImportFinishException [callInterfaceInternalError="
	...
	public LimelightCallWebserviceOnImportFinishException() {
		super();
		// TODO Auto-generated constructor stub
	}

	public LimelightCallWebserviceOnImportFinishException(String message, Throwable cause, boolean enableSuppression,
			boolean writableStackTrace) {
		super(message, cause, enableSuppression, writableStackTrace);
		// TODO Auto-generated constructor stub
	}

	public LimelightCallWebserviceOnImportFinishException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}

	public LimelightCallWebserviceOnImportFinishException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}

	public LimelightCallWebserviceOnImportFinishException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
