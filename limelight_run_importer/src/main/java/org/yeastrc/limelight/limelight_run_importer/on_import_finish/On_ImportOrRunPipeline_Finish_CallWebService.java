...
/**
 * Call a web service on the Limelight Web app when finish running a single Import or Run Pipeline ( Other than Import Limelight XML file and/or Scan File ) 
 *
 */
public class On_ImportOrRunPipeline_Finish_CallWebService {

	private static final Logger log = LoggerFactory.getLogger( On_ImportOrRunPipeline_Finish_CallWebService.class );
...
//	private static final Charset XML_ENCODING_CHARACTER_SET = StandardCharsets.UTF_8;
	...
	private static final String WEBSERVICE_SUB_URL = "o/rws/run-importer-import-or-run-pipeline-finish";

	//  private constructor
	private On_ImportOrRunPipeline_Finish_CallWebService() { }
	/**
	 * @return newly created instance
	 */
	public static On_ImportOrRunPipeline_Finish_CallWebService getInstance() { 
		return new On_ImportOrRunPipeline_Finish_CallWebService(); 
	}
	 ...
	 * @throws Exception
	 */
	public void callLimelightWebServiceOnSingle_ImportOrRunPipeline_Finish( int trackingId, int runId ) throws Exception {

		if ( log.isInfoEnabled() ) {
			log.info( "OnImportFinishCallWebService::callLimelightWebServiceOnSingle_ImportOrRunPipeline_Finish: trackingId: " + trackingId + ", runId: " + runId );
		}
		...
		if ( log.isInfoEnabled() ) {
			log.info( "OnImportFinishCallWebService::callLimelightWebServiceOnSingle_ImportOrRunPipeline_Finish: webappServerBaseURL: " 
		...
		try {
			...
			String msg = "callLimelightWebServiceOnSingle_ImportOrRunPipeline_Finish: trackingId: " + trackingId + ", runId: " + runId;
			log.error( msg, e );
		...
		if ( ! ( webserviceResponseAsObject instanceof RunImporterToWebAppOnComplete_Response ) ) {
			String msg = "callLimelightWebServiceOnSingle_ImportOrRunPipeline_Finish: Response unmarshaled to class other than RunImporterToWebAppOnComplete_Response.  "
