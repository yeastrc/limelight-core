...
/**
 * Call a web service on the lIMELIGHT Web app when finish running a single Import
 *
 */
public class OnImportFinishCallWebService {

	private static final Logger log = LoggerFactory.getLogger( OnImportFinishCallWebService.class );
...
//	private static final Charset XML_ENCODING_CHARACTER_SET = StandardCharsets.UTF_8;
	...
	//  private constructor
	private OnImportFinishCallWebService() { }
	/**
	 * @return newly created instance
	 */
	public static OnImportFinishCallWebService getInstance() { 
		return new OnImportFinishCallWebService(); 
	}
