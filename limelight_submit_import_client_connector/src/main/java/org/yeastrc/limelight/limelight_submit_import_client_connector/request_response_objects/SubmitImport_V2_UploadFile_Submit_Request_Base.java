...
/**
 * Request object for POST to Webservice Project_UploadData_UploadFile_Submit_RestWebserviceController
 * 
 * Passed in HTTP Header
 *
 */
@XmlRootElement(name="submitImport_V2_UploadFile_Submit_Request_Base")
@XmlAccessorType(XmlAccessType.FIELD)
public class SubmitImport_V2_UploadFile_Submit_Request_Base {
