...
/**
 * Request object for POST to Webservice Project_UploadData_UploadInitialize_RestWebserviceController
 *
 */
@XmlRootElement(name="submitImport_AuthTest_Request_PgmXML")
@XmlAccessorType(XmlAccessType.FIELD)
public class SubmitImport_AuthTest_Request_PgmXML extends SubmitImport_AuthTest_Request_Base {
