...
/**
 * Request object for POST to Webservice Project_UploadData_V2_UploadFile_Chunking_Upload_File_RestWebserviceController
 * 
 * Passed in HTTP Header
 *
 */
@XmlRootElement(name="submitImport_V2_UploadFile_Chunking_Request_Common")
@XmlAccessorType(XmlAccessType.FIELD)
public class SubmitImport_V2_UploadFile_Chunking_Request_Common {
	...
	@XmlAttribute
	private String uniqueRequestIdentifier_ForThisFile; // Random String Unique Identifier: Same as passed to 'Single File Initialize' for this file
	@XmlAttribute
	...
	public Long getFileChunk_SequenceNumber() {
		return fileChunk_SequenceNumber;
	}
