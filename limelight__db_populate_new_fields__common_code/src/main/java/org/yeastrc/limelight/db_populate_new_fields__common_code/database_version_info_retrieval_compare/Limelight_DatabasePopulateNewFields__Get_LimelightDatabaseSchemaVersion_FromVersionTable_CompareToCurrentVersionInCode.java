...
*/
package org.yeastrc.limelight.db_populate_new_fields__common_code.database_version_info_retrieval_compare;
 ...
 */
public class Limelight_DatabasePopulateNewFields__Get_LimelightDatabaseSchemaVersion_FromVersionTable_CompareToCurrentVersionInCode {
	
	private static final Logger log = LoggerFactory.getLogger( Limelight_DatabasePopulateNewFields__Get_LimelightDatabaseSchemaVersion_FromVersionTable_CompareToCurrentVersionInCode.class );
	...
	//  private constructor
	private Limelight_DatabasePopulateNewFields__Get_LimelightDatabaseSchemaVersion_FromVersionTable_CompareToCurrentVersionInCode() { }
	
	/**
	 * @return newly created instance
	 */
	public static Limelight_DatabasePopulateNewFields__Get_LimelightDatabaseSchemaVersion_FromVersionTable_CompareToCurrentVersionInCode getInstance() { 
		return new Limelight_DatabasePopulateNewFields__Get_LimelightDatabaseSchemaVersion_FromVersionTable_CompareToCurrentVersionInCode(); 
	}
